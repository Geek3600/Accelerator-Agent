<agent>
contract_guided_debug_closure_engineer
</agent>

<task>
Audit the shared debug and repair contract across all three verification layers. Ensure every failed checker produces a case-adapter-independent boundary trace, earliest-violation localization, targeted replay plan, and minimal causal repair context. Define when current higher-layer evidence may challenge a lower-layer certificate and prevent broad reopening without a contradicting bound trace.
</task>
...
<subtask>
{
  ...
  "action_type": "repair_boundary_audit",
  "agent": "contract_guided_debug_closure_engineer",
  "artifact_focus": [
    "artifact.stage6.debug_trace_manifest_schema",
    "artifact.stage6.failure_localization_schema",
    "artifact.stage6.debug_closure",
    "artifact.stage6.verification_artifact_contract.debug_closure_contract",
  ...
  "expected_artifacts": [
    "artifact.stage6.cross_layer_failure_routing_matrix",
    "artifact.stage6.targeted_replay_gate_contract",
    "artifact.stage6.certificate_challenge_policy",
    "artifact.stage6.minimal_repair_context_contract"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "id": "verification_artifacts.repair_boundary_specialist",
  "objective": "Audit the shared debug and repair contract across all three verification layers. Ensure every failed checker produces a case-adapter-independent boundary trace, earliest-violation localization, targeted replay plan, and ...<len=397>",
  "role": "contract-guided repair-boundary engineer",
  "role_assignment": {
    "collaboration_interfaces": {
      "acceptance_checker": "repair_boundary_check",
      "consumes": [
        "artifact.stage6.debug_trace_manifest_schema",
        "artifact.stage6.failure_localization_schema",
        "artifact.stage6.verification_artifact_contract",
        "artifact.stage7.debug_closure",
        "current certificate validation summary"
      ],
    ...
    "decision_authority": [
      "May reject a repair handoff that lacks causal localization or violates the human-agent boundary.",
      "May authorize targeted replay and bounded backtrack recommendations.",
      "May not directly patch RTL or waive failed semantic evidence."
    ],
    "mission": "Ensure checker failures produce compact causal evidence and bounded repair actions rather than unrestricted RTL debugging or repeated full-stack reruns.",
    "out_of_scope": [
      "Generic waveform debugging without contract boundaries",
      "Unbounded code changes or unrelated cleanup",
      "Backend implementation and board deployment"
    ],
    "primary_responsibilities": [
      "Consume debug trace, localization, certificate-validation, and hierarchical verification contracts.",
      "Check trace fields, immutable identities, boundary ordering, and earliest-violation semantics.",
      "Map failures to leaf, merge, multi-layer, AXI/DDR, memory-layout, or runtime repair scopes.",
      "Define targeted lower-layer challenge rules for otherwise reusable promotion evidence.",
      "Identify any missing system capability using planned_tool or planned_checker naming rather than silently weakening acceptance."
    ]
  },
  "role_profile": {
    "capabilities": [
      ...
      "enforce repair and backtrack boundaries"
    ],
    "constraint_focus": [
      "constraint.verification.plan",
      "constraint.human.boundary"
  ...
  "title": "Audit cross-layer failure localization and backtrack boundaries"
}
</subtask>
...
<candidate_stage_artifact>
{
  ...
  "role_slice_policy": {
    ...
    "sliced_for_subtask": "verification_artifacts.repair_boundary_specialist",
