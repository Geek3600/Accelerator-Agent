<agent>
verification_evidence_gate_lead
</agent>

<task>
Merge and audit the specialist refinements into one acyclic, checker-grounded, tool-materializable gate DAG. Verify strict ordering from operator leaves to one connected layer to the board AXI/DDR wrapped system; verify that all third-layer classifiers depend on the canonical functional simulation; validate stale-certificate blocking and repair routes; and place Vivado synthesis, implementation, runtime bitstream, ABI, and board runtime strictly downstream of case_board_semantic_evidence without claiming those gates in this stage.
</task>
...
<subtask>
{
  ...
  "action_type": "checker_bound_dag_audit_and_merge",
  "agent": "verification_evidence_gate_lead",
  "artifact_focus": [
    ...
    "all specialist refinement artifacts",
    "verification_gate_dag critical_nodes and phase_order"
  ],
  "constraints": [
  ...
  "expected_artifacts": [
    "artifact.stage6.canonical_gate_dag_refinement_merged",
    "artifact.stage6.verification_gate_dependency_audit",
    "artifact.stage6.action_materialization_coverage_refined",
    "artifact.stage6.stage7_execution_scope_handoff",
    "artifact.stage6.backend_downstream_boundary_certificate"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "handoff_to": [
    "stage7.verification",
    "downstream.backend_board",
    "downstream.repair_loop"
  ],
  "id": "verification_artifacts.canonical_gate_dag_auditor",
  "objective": "Merge and audit the specialist refinements into one acyclic, checker-grounded, tool-materializable gate DAG. Verify strict ordering from operator leaves to one connected layer to the board AXI/DDR wrapped system; verify ...<len=536>",
  ...
  "role_assignment": {
    "collaboration_interfaces": {
      ...
      "consumes": [
        "artifact.stage6.operator_leaf_gate_dag_refinement",
        "artifact.stage6.single_layer_gate_dag_refinement",
        "artifact.stage6.board_axi_ddr_gate_dag_refinement",
        "artifact.stage6.current_certificate_validation_dag",
        "artifact.stage6.canonical_gate_dag_refinement",
        "artifact.stage6.action_materialization_coverage"
      ],
    ...
    "decision_authority": [
      "May accept or reject the merged Stage 6 verification DAG.",
      "May return a bounded inconsistency to a named specialist or declare a planned tool/checker implementation requirement when registry coverage is missing.",
      "May not claim that pending real-tool, Vivado, bitstream, or board-runtime gates have passed."
    ],
    "mission": "Act as the final evidence gate for the Stage 6 plan, accepting only a coherent SACG-guided, template-constrained, checker-verifiable real-tool DAG.",
    "out_of_scope": [
      "Executing the real simulations planned for Stage7",
      "Executing Vivado synthesis, implementation, or bitstream generation",
      "Claiming final design closure before board_runtime and output validity evidence"
    ],
    "primary_responsibilities": [
      "Consume all parallel specialist outputs and the existing canonical DAG, semantic promotion matrix, tool protocols, and action-materialization coverage.",
      "Check acyclicity, prerequisite completeness, exact canonical checker/tool names, evidence paths, and immutable identity propagation.",
      "Ensure stale certificate handling and bounded repair routes are consistent at every promotion boundary.",
      "Ensure board functional closure precedes all Vivado, bitstream, ABI, and board-runtime nodes.",
      "Produce the executable Stage7 handoff while preserving downstream implementation and deployment obligations."
    ]
  },
  "role_profile": {
    "capabilities": [
      "classify evidence",
      "audit cross-layer gate dependencies",
      "map failures to violated constraints",
      "enforce repair and human boundaries",
  ...
  "title": "Audit and merge the canonical three-layer verification DAG"
}
</subtask>
...
<candidate_stage_artifact>
{
  ...
  "presence_summary": {
    ...
    "evidence_gate_count": 27,
    "evidence_path_requirement_count": 36,
    "merge_agent_count": 6,
    ...
    "verification_gate_dag_node_count": 36
  },
  "role_slice_policy": {
    "do_not_infer_missing_from_omitted_details": true,
    "sliced_for_subtask": "verification_artifacts.canonical_gate_dag_auditor",
      ...
      "scopes": [
        {
          ...
          "producer_transition": "transition.0006",
          "reuse_allowed": false,
        ...
        },
        {
          ...
          "artifact_present": true,
          "current_contract_valid": false,
          "producer_transition": "transition.0007",
          "reuse_allowed": false,
    ...
    "verification_gate_dag": {
      "nodes": [
        ...
        },
        {
          ...
          "evidence_status": "required_pending_execution",
          "name": "case_operator_leaf_semantic_evidence",
          "role": "assemble checker-bound evidence for all operator leaves, complete real-weight consumption, independent target-model golden values, and immut...<len=164>"
        },
        {
          "depends_on": [
            "case_operator_leaf_semantic_evidence",
        ...
        },
        {
          ...
          "role": "assemble checker-bound connected single-layer semantic, golden, real-weight-consumption, and immutable identity evidence"
        },
        {
          "depends_on": [
            "case_single_layer_semantic_evidence",
        ...
        },
        {
          ...
          "role": "assemble the canonical board-run identity, exact wrapper, all third-layer classifier, complete real-weight-consumption, and target-model out...<len=152>"
        },
        {
          "depends_on": [
            "case_multilayer_pipeline",
          ...
          "role": "run Vivado synthesis and collect utilization/timing evidence only after every third-layer functional subgate passes"
        },
        {
          "depends_on": [
