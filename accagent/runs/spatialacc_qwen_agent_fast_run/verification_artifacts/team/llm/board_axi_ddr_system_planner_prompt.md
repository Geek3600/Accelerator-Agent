<agent>
board_axi_ddr_system_planner
</agent>

<task>
Refine the board AXI/DDR wrapped-system verification sub-DAG, including multilayer pipeline, AXI/DDR, DDR image, and real functional simulation checks as third-layer subgates before backend/bitstream promotion.
</task>
...
<subtask>
{
  ...
  "action_type": "system_verification_gate_planning",
  "agent": "board_axi_ddr_system_planner",
  "artifact_focus": [
    "artifact.stage5.memory_layout",
    "artifact.stage5.runtime_config",
    "generated.fpga_axi_ddr_top_wrapper",
    "gates:case_multilayer_pipeline,case_multilayer_functional,case_pipeline_deadlock_check",
    "gates:case_board_interface_discovery,case_axi_ddr_interface,case_axi_protocol_check,case_ddr_image_roundtrip,functional_sim",
    "downstream_only:case_vivado_synthesis,case_vivado_implementation,case_runtime_bitstream,board_runtime"
  ],
  "constraints": [
  ...
  "expected_artifacts": [
    "board_axi_ddr_gate_subdag.json",
    "multilayer_pipeline_order_contract.json",
    "axi_ddr_runtime_evidence_plan.json",
    "ddr_image_roundtrip_contract.json",
    "functional_sim_gate_requirements.json"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "handoff_to": [
    "verification_artifacts.repair_boundary_evidence_auditor",
    "downstream.backend_board.stage"
  ],
  "id": "verification_artifacts.board_axi_ddr_system_planner",
  "objective": "Refine the board AXI/DDR wrapped-system verification sub-DAG, including multilayer pipeline, AXI/DDR, DDR image, and real functional simulation checks as third-layer subgates before backend/bitstream promotion.",
  "role": "board AXI/DDR functional-system verification engineer",
  "role_assignment": {
    "collaboration_interfaces": {
      "acceptance_checker_consumers": [
        "case_multilayer_pipeline",
        "case_multilayer_functional",
        "case_pipeline_deadlock_check",
        "case_axi_ddr_interface",
      ...
      "consumes": [
        "single_layer_gate_subdag",
        "single_layer_merge_contract",
        "artifact.stage5.memory_layout",
        "artifact.stage5.runtime_config",
      ...
      "produces": [
        "board_axi_ddr_gate_subdag",
        "multilayer_pipeline_order_contract",
        "axi_ddr_runtime_evidence_plan",
        "ddr_image_roundtrip_contract",
        "functional_sim_gate_requirements"
      ]
    },
    "decision_authority": [
      "May block backend/Vivado handoff until board AXI/DDR functional gates pass.",
      "May require transfer_count_check, addr_map_check, data_order_trace_check, or deadlock_watchdog evidence for DDR/runtime claims.",
      "May classify AXI/DDR failures to memory_runtime_repair boundaries but may not approve board runtime as current-stage pass."
    ],
    "mission": "Plan the third repair-loop layer for the board AXI/DDR wrapped system, including multilayer pipeline, functional simulation, deadlock/liveness, AXI protocol/order, DDR image roundtrip, and runtime ABI evidence while leaving Vivado bitstream and board runtime downstream.",
    "out_of_scope": [
      "Do not run Vivado implementation, timing closure, bitstream generation, or board runtime in this stage.",
      "Do not accept final design closure without board_runtime downstream evidence.",
      "Do not alter memory layout or runtime ABI except through bounded memory_runtime_repair requests."
    ],
    "primary_responsibilities": [
      "Consume the single-layer merge contract, memory_layout, runtime_config, target board profile, tool protocols, and generated AXI/DDR top wrapper evidence.",
      "Refine the third-layer internal subgates: case_multilayer_pipeline, case_multilayer_functional, case_pipeline_deadlock_check, case_board_interface_discovery, case_axi_ddr_interface, case_axi_protocol_check, case_ddr_image_roundtrip, and functional_sim.",
      "Bind DDR address ranges, packed real input/weight/output image paths, transfer counts, runtime ABI fields, and stream-order traces to Stage 5 memory/runtime artifacts.",
      "Ensure functional_sim is a real simulator gate using real input/weight artifacts and not the case_vcs_liveness candidate alone.",
      "Mark case_vivado_synthesis, case_vivado_implementation, case_runtime_bitstream, case_runtime_abi_check, and board_runtime as downstream after verification closure, except where ABI/discovery evidence is prerequisite metadata."
    ],
  ...
  "title": "Plan board AXI/DDR wrapped-system verification gates"
}
</subtask>
...
<candidate_stage_artifact>
{
  ...
  "role_slice_policy": {
    ...
    "sliced_for_subtask": "verification_artifacts.board_axi_ddr_system_planner",
