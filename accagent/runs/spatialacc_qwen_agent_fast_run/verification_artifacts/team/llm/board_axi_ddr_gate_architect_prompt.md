<agent>
board_axi_ddr_gate_architect
</agent>

<task>
Refine the third repair-loop layer so board-interface discovery, model-adaptive multi-layer scheduling, AXI/DDR wrapping, and one canonical real functional simulation produce the multi-layer, deadlock, AXI protocol, DDR image, and board semantic evidence required before any backend handoff.
</task>
...
<subtask>
{
  ...
  "action_type": "board_functional_gate_dag_refinement",
  "agent": "board_axi_ddr_gate_architect",
  "artifact_focus": [
    "case_board_interface_discovery",
    "case_multilayer_pipeline",
    "case_axi_ddr_interface",
  ...
  "expected_artifacts": [
    "board AXI/DDR functional DAG fragment",
    "sample-project-bound interface discovery contract",
    "canonical simulator run and derived classifier evidence contract",
    "DDR address, transfer-count, data-order, and liveness trace requirements",
    "backend handoff boundary excluding bitstream and board-runtime execution"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "id": "verification_artifacts.board_axi_ddr_gate_architect",
  "objective": "Refine the third repair-loop layer so board-interface discovery, model-adaptive multi-layer scheduling, AXI/DDR wrapping, and one canonical real functional simulation produce the multi-layer, deadlock, AXI protocol, DDR ...<len=291>",
  "role": "board AXI/DDR functional verification architect",
  "role_assignment": {
    "collaboration_interfaces": {
      ...
      "downstream_consumers": [
        ...
        "case_board_semantic_evidence",
        "later backend-board stage"
      ],
      "produces": [
        "board functional DAG fragment",
        "canonical simulation contract",
        "third-layer classifier bindings"
      ]
    },
    "decision_authority": [
      "May reject guessed board interfaces or unbound memory layouts.",
      "May block backend handoff for any pending third-layer classifier.",
      "May not claim synthesis, bitstream, or physical-board success."
    ],
    "mission": "Own cross-layer functional closure of the multi-layer board AXI/DDR wrapped system before backend execution.",
    "out_of_scope": [
    ...
    "primary_responsibilities": [
      "Bind discovered clocks, reset, calibration, AXI ports, address map, and DDR layout to the generated wrapper.",
      "Ensure multi-layer scheduling preserves block order, transfer counts, and liveness.",
      "Define a canonical real simulation whose traces drive all third-layer classifiers.",
      "Prevent functional-smoke evidence from being treated as semantic acceptance."
    ]
  },
  "role_profile": {
    "capabilities": [
  ...
  "title": "Refine third-layer board-wrapped functional subgates"
}
</subtask>
...
<candidate_stage_artifact>
{
  ...
  "role_slice_policy": {
    ...
    "sliced_for_subtask": "verification_artifacts.board_axi_ddr_gate_architect",
