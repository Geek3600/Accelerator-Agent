<agent>
single_multilayer_pipeline_verification_architect
</agent>

<task>
Refine and audit merge gates from leaf closure through self-attention/MLP merges, single transformer layer, multilayer pipeline, functional simulation, and deadlock/liveness gates while preserving SACG stream order and numeric comparison requirements.
</task>
...
<subtask>
{
  ...
  "agent": "single_multilayer_pipeline_verification_architect",
  "artifact_focus": [
    ...
    "verification_gate_dag nodes: single_transformer_layer, case_single_layer_functional, case_single_layer_golden_compare, case_multilayer_pipeline, case_multilayer_functional, case_pipeline_deadlock_check, functional_sim",
  ...
  "expected_artifacts": [
    "merge_gate_dependency_review",
    "single_layer_functional_acceptance_contract",
    "multilayer_pipeline_liveness_contract",
    "functional_sim_prebackend_blocking_rules"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "handoff_to": [
    "axi_ddr_runtime_verification_architect",
    "verification_evidence_gate_auditor"
  ],
  "id": "verification_artifacts.single_multilayer_pipeline_verification_architect",
  "objective": "Refine and audit merge gates from leaf closure through self-attention/MLP merges, single transformer layer, multilayer pipeline, functional simulation, and deadlock/liveness gates while preserving SACG stream order and n...<len=251>",
  "role": "single-layer and multilayer pipeline verification architect",
  "role_assignment": {
    "collaboration_interfaces": {
      ...
      "consumes": [
        "operator_leaf_gate_coverage_matrix",
        ...
        "candidate_stage_artifact.verification_artifact_contract.verification_gate_dag"
      ],
      ...
      "produces": [
        "merge_gate_dependency_review",
        "single_layer_functional_acceptance_contract",
        "multilayer_liveness_gate_contract"
      ]
    },
    "decision_authority": [
      "May approve the single/multilayer DAG segment if bottom-up prerequisites and canonical checkers are complete.",
      "May block AXI/DDR handoff if functional_sim, deadlock, or golden-compare rules are underspecified.",
      "May classify simulator obligations as downstream pending evidence but not as current-stage failures when the contract is satisfiable."
    ],
    "mission": "Ensure the verification DAG promotes strictly from leaf evidence to single-layer and multilayer functional evidence before any AXI/DDR or backend stage.",
    "out_of_scope": [
      "Generating new model graph stages or changing operator order.",
      "Executing real simulators or producing real functional pass evidence.",
      "Vivado synthesis, implementation, bitstream, or board runtime closure."
    ],
    "primary_responsibilities": [
      "Consume leaf verification outputs, Stage 3 stream plan, Stage 4 numeric policy, and candidate merge_agents.",
      "Check merge dependencies for self-attention, MLP, single decoder block, and multilayer pipeline.",
      "Verify numeric_compare and golden comparison gates are declared where required by the maturity contract.",
      "Ensure case_pipeline_deadlock_check and deadlock_watchdog obligations are explicit before runtime wrapping.",
      "Produce a promotion contract that downstream AXI/DDR and evidence-audit agents can enforce."
    ]
  },
  "role_profile": {
    "capabilities": [
  ...
  "title": "Validate single-block and multilayer functional promotion DAG"
}
</subtask>
...
<candidate_stage_artifact>
{
  ...
  "checker_results": [
    {
      ...
      "status": "pass",
      "summary": "bottom-up leaf, merge, and evidence-gate hierarchy is declared"
    },
    {
      "checker": "data_order_trace_check",
      "errors": [],
  ...
  "role_slice_policy": {
    ...
    "sliced_for_subtask": "verification_artifacts.single_multilayer_pipeline_verification_architect",
