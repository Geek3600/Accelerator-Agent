<agent>
repair_boundary_architect
</agent>

<task>
Refine the shared repair-control plane across all three verification layers, ensuring simulator or checker failures produce case-adapter-independent boundary traces, earliest-violation localization, targeted replay, minimal causal repair context, and bounded template, pipeline, or memory/runtime repair authority.
</task>
...
<subtask>
{
  ...
  "action_type": "repair_boundary_refinement",
  "agent": "repair_boundary_architect",
  "artifact_focus": [
    "verification_artifact_contract.debug_closure_contract",
    "boundary_trace.json schema",
    "failure_localization.json schema",
    "targeted replay outputs",
    "repair handoff required fields",
    "promotion-certificate invalidation rules"
  ],
  "constraints": [
  ...
  "expected_artifacts": [
    "cross-layer failure-classification matrix",
    "boundary-bisection and earliest-violation replay policy",
    "minimal causal repair-context schema",
    "certificate reuse, challenge, and invalidation rules",
    "anti-spin and no-downstream-symptom-patching policy"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "id": "verification_artifacts.repair_boundary_architect",
  "objective": "Refine the shared repair-control plane across all three verification layers, ensuring simulator or checker failures produce case-adapter-independent boundary traces, earliest-violation localization, targeted replay, mini...<len=314>",
  "role": "contract-guided debug and repair-boundary architect",
  "role_assignment": {
    "collaboration_interfaces": {
      ...
      "consumes": [
        "three layer-specific DAG fragments",
        "debug closure contract",
        "checker and tool evidence"
      ],
      ...
      "produces": [
        "repair-control DAG fragment",
        "causal repair packet schema",
        "certificate invalidation policy"
      ]
    },
    "decision_authority": [
      "May reject non-causal or incomplete repair packets.",
      "May authorize bounded template, pipeline, or memory/runtime repair routing.",
      "May not authorize free-form RTL rewriting or unsupported evidence promotion."
    ],
    "mission": "Own the bounded causal-debug protocol shared by the three-layer verification DAG.",
    "out_of_scope": [
      "Generic RTL debugging",
      "Speculative architecture redesign",
      "Backend or board deployment execution"
    ],
    "primary_responsibilities": [
      "Normalize boundary trace and failure-slice schemas across tools and case adapters.",
      "Map checker failures to SACG constraints and the narrowest authorized repair family.",
      "Enforce reusable-but-challengeable lower-layer certificates.",
      "Specify targeted checker reruns and anti-spin escalation conditions."
    ]
  },
  "role_profile": {
    "capabilities": [
  ...
  "title": "Refine causal failure slicing and anti-spin repair rules"
}
</subtask>
...
<candidate_stage_artifact>
{
  ...
  "role_slice_policy": {
    ...
    "sliced_for_subtask": "verification_artifacts.repair_boundary_architect",
