...
<task>
Integrate and audit the specialist DAG fragments for acyclicity, canonical tool/checker grounding, current-certificate validation, strict bottom-up promotion, complete third-layer functional subgates, bounded repair routing, and a hard downstream boundary before Vivado bitstream and board runtime.
</task>
...
<subtask>
{
  ...
  "action_type": "verification_action_audit",
  "agent": "verification_evidence_gate_auditor",
  "artifact_focus": [
    "integrated verification_gate_dag",
    "hierarchical_verification.maturity_contract",
    "stage_gate_policy.current_certificate_validation",
    "required tool protocols",
    "verification evidence path manifest",
  ...
  "expected_artifacts": [
    "audited integrated three-layer verification gate DAG",
    "gate-to-tool-to-evidence-to-checker traceability matrix",
    "promotion certificate validation matrix",
    "DAG acyclicity and forbidden-bypass report",
    "verification-closure handoff contract to downstream backend-board stages"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "handoff_to": [
    "stage7.real_tool_verification_execution",
    "downstream.backend_board_after_verification_closure"
  ],
  "id": "verification_artifacts.verification_evidence_gate_auditor",
  "objective": "Integrate and audit the specialist DAG fragments for acyclicity, canonical tool/checker grounding, current-certificate validation, strict bottom-up promotion, complete third-layer functional subgates, bounded repair rout...<len=298>",
  "role": "verification evidence and promotion auditor",
  "role_assignment": {
    "collaboration_interfaces": {
      ...
      "consumes": [
        "all parallel-group-0 specialist artifacts",
        "SACG memory truth",
        "verification artifact contract",
        "tool registry"
      ],
      "downstream_consumers": [
        "Stage 7 real-tool verification agents",
        "later implementation/deployment agents",
        "SACG state transition"
      ],
      "produces": [
        "audited integrated DAG",
        "traceability matrix",
        "promotion decision and downstream handoff contract"
      ]
    },
    "decision_authority": [
      "May accept or reject the integrated verification DAG.",
      "May block real-tool execution or backend handoff for missing contracts or unsupported evidence.",
      "May not waive real weights, real functional simulation, third-layer classifiers, bitstream, or final board-runtime obligations."
    ],
    "mission": "Act as the independent evidence gate for the complete SACG-guided, template-constrained verification plan.",
    "out_of_scope": [
      "Executing Vivado synthesis, implementation, or bitstream",
      "Executing physical board runtime",
      "Waiving failed or pending required evidence"
    ],
    "primary_responsibilities": [
      "Merge specialist outputs and check DAG acyclicity and strict maturity ordering.",
      "Audit exact canonical checker/tool bindings and concrete evidence paths.",
      "Validate certificate freshness rules and forbidden bypasses.",
      "Separate verification closure from downstream Vivado bitstream and board-runtime closure.",
      "Block unsupported pass claims and route deficiencies to the bounded owning specialist."
    ]
  },
  "role_profile": {
    "capabilities": [
  ...
  "title": "Audit the integrated three-layer verification gate DAG"
}
</subtask>
...
<candidate_stage_artifact>
{
  ...
  "role_slice_policy": {
    ...
    "sliced_for_subtask": "verification_artifacts.verification_evidence_gate_auditor",
