<agent>
numeric_template_specialist__template_parameter_engineer
</agent>

<task>
Verify that every selected pipeline stage has complete legal template parameters derived from Stage 2 template selection, Stage 3 pipeline contracts, model shapes, and the design space, without changing model structure or numeric semantics.
</task>
...
<subtask>
{
  ...
  "agent": "numeric_template_specialist__template_parameter_engineer",
  "artifact_focus": [
    "bindings",
    "global_params",
    "global_param_scope",
  ...
  "expected_artifacts": [
    "parameter_binding.template_parameter_audit",
    "per_stage_binding_legality_notes",
    "template_parameter_handoff_summary"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "objective": "Verify that every selected pipeline stage has complete legal template parameters derived from Stage 2 template selection, Stage 3 pipeline contracts, model shapes, and the design space, without changing model structure o...<len=240>",
