...
<task>
Confirm that all specialist audits cite SACG constraints, use canonical checker evidence, preserve the template-constrained method boundary, and either approve the parameter_binding artifact for the next stage or emit bounded repair/backtrack requests.
</task>
...
<subtask>
{
  ...
  "expected_artifacts": [
    "parameter_binding.stage_gate_decision",
    "parameter_binding.checker_evidence_matrix",
    "parameter_binding.repair_or_backtrack_requests_if_any"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "handoff_to": [
    "next_stage.memory_runtime_or_code_generation_planning"
  ],
  "id": "parameter_binding.evidence_gate_auditor",
  "objective": "Confirm that all specialist audits cite SACG constraints, use canonical checker evidence, preserve the template-constrained method boundary, and either approve the parameter_binding artifact for the next stage or emit bo...<len=252>",
  "role": "checker evidence gate auditor",
  "title": "Aggregate specialist audits and enforce repair boundaries"
}
</subtask>
