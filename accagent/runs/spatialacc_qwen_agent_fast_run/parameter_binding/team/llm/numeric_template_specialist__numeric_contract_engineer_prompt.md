<agent>
numeric_template_specialist__numeric_contract_engineer
</agent>

<task>
Check that bound input/output/internal bit widths, cast points, residual precision, rounding, saturation, and numeric_policy_id remain consistent with the numeric policy and Stage 3 stream contracts across all edges.
</task>
...
<subtask>
{
  ...
  "agent": "numeric_template_specialist__numeric_contract_engineer",
  "artifact_focus": [
    "numeric_binding_plan",
    "stream_contract_trace",
    "bindings.params.input_bits",
    "bindings.params.output_bits",
    "checker_results"
  ],
  "constraints": [
  ...
  "expected_artifacts": [
    "parameter_binding.numeric_contract_audit",
    "cast_point_consistency_table",
    "edge_dtype_consistency_notes"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "id": "parameter_binding.numeric_contract_engineer",
  "objective": "Check that bound input/output/internal bit widths, cast points, residual precision, rounding, saturation, and numeric_policy_id remain consistent with the numeric policy and Stage 3 stream contracts across all edges.",
  "role": "numeric contract engineer",
  "title": "Audit numeric policy and dtype stream contracts"
}
</subtask>
