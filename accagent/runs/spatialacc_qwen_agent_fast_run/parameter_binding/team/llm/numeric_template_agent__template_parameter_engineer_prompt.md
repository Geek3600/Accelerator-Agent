<agent>
numeric_template_agent__template_parameter_engineer
</agent>

<task>
Verify that every selected trusted template has complete and legal bound parameters for shape, attention heads, lanes, tiles, FIFO defaults, and clock defaults without changing model semantics or overriding Stage 3 authoritative contracts.
</task>
...
<subtask>
{
  ...
  "agent": "numeric_template_agent__template_parameter_engineer",
  "artifact_focus": [
  ...
  "expected_artifacts": [
    "parameter_template_binding_audit",
    "per_stage_legality_findings",
    "template_parameter_handoff_notes"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "objective": "Verify that every selected trusted template has complete and legal bound parameters for shape, attention heads, lanes, tiles, FIFO defaults, and clock defaults without changing model semantics or overriding Stage 3 autho...<len=239>",
  "role": "template parameter engineer",
  "title": "Audit per-stage template parameter binding"
}
</subtask>
