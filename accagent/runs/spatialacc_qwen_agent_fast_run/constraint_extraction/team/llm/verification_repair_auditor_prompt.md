<agent>
verification_repair_auditor
</agent>

<task>
Aggregate specialist findings and decide whether the candidate design graph can become shared state for later chip-design-team stages by checking reference integrity, cross-layer consistency, human-agent boundaries, checker evidence contracts, and bounded repair routing.
</task>
...
<subtask>
{
  ...
  "action_type": "sacg_evidence_gate",
  "agent": "verification_repair_auditor",
  "artifact_focus": [
    "candidate_design_graph_summary",
    "prepared_inputs_manifest.design_team",
    "validation_errors",
    "artifact.review.constraint_extraction.model_shape_findings",
    "artifact.review.constraint_extraction.numeric_template_findings",
    "artifact.review.constraint_extraction.data_memory_runtime_findings",
    "artifact.review.constraint_extraction.input_evidence_findings"
  ],
  "constraints": [
  ...
  "expected_artifacts": [
    "artifact.stage.constraint_extraction.audited_design_graph_decision",
    "artifact.stage.constraint_extraction.cross_layer_consistency_report",
    "artifact.stage.constraint_extraction.repair_or_backtrack_requests",
    "artifact.stage.constraint_extraction.human_boundary_gate_report"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "handoff_to": [
    "next_stage.design_space_or_template_planning",
    "stage_retry.constraint_extraction",
    "stage_backtrack.input_preparation"
  ],
  "id": "constraint_extraction.constraint_graph_auditor",
  "objective": "Aggregate specialist findings and decide whether the candidate design graph can become shared state for later chip-design-team stages by checking reference integrity, cross-layer consistency, human-agent boundaries, chec...<len=271>",
  "role": "constraint graph auditor and repair-boundary gate",
  "title": "Gate the initial SACG for reference integrity and repair boundaries"
}
</subtask>
