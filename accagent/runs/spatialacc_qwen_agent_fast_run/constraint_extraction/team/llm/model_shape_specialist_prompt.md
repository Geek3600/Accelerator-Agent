...
<task>
Verify that the initial SACG captures decoder topology, operator order, residual paths, attention/head facts, hidden sizes, sequence dimensions, and shape dependencies from the model configuration without introducing unsupported model-specific assumptions.
</task>
...
<subtask>
{
  ...
  "artifact_focus": [
    ...
    "candidate_design_graph_summary.node_ids",
    "candidate_design_graph_summary.constraint_ids",
  ...
  "expected_artifacts": [
    ...
    "artifact.review.constraint_extraction.model_shape_constraint_patch_requests"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "id": "constraint_extraction.model_shape_engineer",
  "objective": "Verify that the initial SACG captures decoder topology, operator order, residual paths, attention/head facts, hidden sizes, sequence dimensions, and shape dependencies from the model configuration without introducing uns...<len=256>",
  "role": "model graph and shape engineer",
  "title": "Audit model decoder and shape constraints"
}
</subtask>
