...
<task>
Integrate specialist reviews and decide whether the initial design graph is a checker-supported, cross-layer-consistent SACG state suitable for downstream chip-design-team stages, or whether bounded graph repairs are required.
</task>
...
<subtask>
{
  ...
  "agent": "constraint_extraction.constraint_graph_auditor",
  "artifact_focus": [
  ...
  "objective": "Integrate specialist reviews and decide whether the initial design graph is a checker-supported, cross-layer-consistent SACG state suitable for downstream chip-design-team stages, or whether bounded graph repairs are req...<len=226>",
  "role": "constraint graph integrity auditor",
  "title": "Gate audited design graph promotion"
}
</subtask>
