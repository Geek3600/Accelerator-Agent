<agent>
input_evidence_specialist
</agent>

<task>
Check that all supplied materials, sample project indices, field evidence candidates, task card facts, tool availability, and run-dir provenance are traceably represented in the candidate graph and that no fallback or diagnostic artifact is treated as successful LLM/team evidence.
</task>
...
<subtask>
{
  ...
  "agent": "input_evidence_specialist",
  "artifact_focus": [
  ...
  "expected_artifacts": [
    ...
    "artifact.review.constraint_extraction.source_traceability_matrix",
    "artifact.review.constraint_extraction.tool_availability_gap_list"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "objective": "Check that all supplied materials, sample project indices, field evidence candidates, task card facts, tool availability, and run-dir provenance are traceably represented in the candidate graph and that no fallback or di...<len=281>",
  "role": "source evidence and tool availability engineer",
  "title": "Audit source materials, field evidence, and current-run tool evidence"
}
</subtask>
