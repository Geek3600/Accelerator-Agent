<agent>
constraint_extraction.data_memory_runtime_specialist
</agent>

<task>
Audit that stream order, transfer/liveness assumptions, DDR and AXI address mapping, board runtime ABI, deployment target, tool profile, tool availability, and tool protocols are represented in the initial design graph with cited evidence.
</task>
...
<subtask>
{
  ...
  "agent": "constraint_extraction.data_memory_runtime_specialist",
  "artifact_focus": [
  ...
  "id": "constraint_extraction.data_memory_runtime_specialist",
  "objective": "Audit that stream order, transfer/liveness assumptions, DDR and AXI address mapping, board runtime ABI, deployment target, tool profile, tool availability, and tool protocols are represented in the initial design graph w...<len=239>",
  "role": "dataflow memory/runtime and tool-evidence engineer",
  "title": "Review data, memory, runtime, and tool constraints"
}
</subtask>
