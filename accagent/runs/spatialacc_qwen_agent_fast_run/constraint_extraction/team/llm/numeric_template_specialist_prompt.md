<agent>
numeric_template_specialist
</agent>

<task>
Check that numeric precision policy, quantization assumptions, template library coverage, design-space parameters, and resource-risk assumptions are represented as template-constrained SACG facts with explicit binding boundaries.
</task>
...
<subtask>
{
  ...
  "agent": "numeric_template_specialist",
  "artifact_focus": [
  ...
  "expected_artifacts": [
    ...
    "artifact.review.constraint_extraction.template_binding_gap_list",
    "artifact.review.constraint_extraction.parameter_binding_patch_requests"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "id": "constraint_extraction.numeric_template_engineer",
  "objective": "Check that numeric precision policy, quantization assumptions, template library coverage, design-space parameters, and resource-risk assumptions are represented as template-constrained SACG facts with explicit binding bo...<len=229>",
  "role": "numeric policy and template binding engineer",
  "title": "Audit numeric policy, template library, and parameter binding constraints"
}
</subtask>
