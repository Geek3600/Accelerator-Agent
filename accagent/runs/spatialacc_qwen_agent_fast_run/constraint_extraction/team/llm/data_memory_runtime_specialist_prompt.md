...
<task>
Ensure that the SACG initial graph preserves data ordering, transfer-count/liveness risks, board DDR/AXI facts, address-map assumptions, runtime ABI information, target board profile, and tool protocol dependencies needed for later implementation and deployment evidence.
</task>
...
<subtask>
{
  ...
  "artifact_focus": [
    ...
    "candidate_design_graph_summary.input_groups",
    "candidate_design_graph_summary.evidence_fields"
  ],
  "constraints": [
  ...
  "expected_artifacts": [
    ...
    "artifact.review.constraint_extraction.board_runtime_gap_list",
    "artifact.review.constraint_extraction.tool_protocol_evidence_map"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "id": "constraint_extraction.data_memory_runtime_engineer",
  "objective": "Ensure that the SACG initial graph preserves data ordering, transfer-count/liveness risks, board DDR/AXI facts, address-map assumptions, runtime ABI information, target board profile, and tool protocol dependencies neede...<len=271>",
  "role": "dataflow, memory, and runtime platform engineer",
  "title": "Audit stream order, board memory, AXI/DDR, and runtime constraints"
}
</subtask>
