<agent>
constraint_extraction.model_shape_specialist
</agent>

<task>
Audit that decoder semantics, operator order, residual paths, attention/head facts, hidden dimensions, sequence assumptions, and shape relationships from the model configuration are explicitly represented in the initial design graph and linked to cross-layer constraints.
</task>
...
<subtask>
{
  ...
  "agent": "constraint_extraction.model_shape_specialist",
  "artifact_focus": [
  ...
  "id": "constraint_extraction.model_shape_specialist",
  "objective": "Audit that decoder semantics, operator order, residual paths, attention/head facts, hidden dimensions, sequence assumptions, and shape relationships from the model configuration are explicitly represented in the initial ...<len=271>",
  "role": "model graph and shape engineer",
  "title": "Review model semantics and shape constraints"
}
</subtask>
