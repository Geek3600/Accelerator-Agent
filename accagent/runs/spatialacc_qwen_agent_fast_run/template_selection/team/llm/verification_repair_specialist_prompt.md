...
<task>
Aggregate specialist evidence, rerun static checker expectations, classify the remaining FFN tile issue as resolved or a current-stage blocker, and enforce repair boundaries so the stage cannot pass on unsupported bindings or later-stage implementation claims.
</task>
...
<subtask>
{
  ...
  "action_type": "verification_gate_and_repair_boundary",
  ...
  "expected_artifacts": [
    "artifact.template_selection.stage_gate_decision",
    "updated checker disposition for operator_coverage_check, template_parameter_binding_check, template_source_and_interface_check, attention_semantic_expansion_check, and cross_layer_trace_check",
    "bounded repair or backtrack request if any current-stage block remains"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "handoff_to": [
    "next_stage_or_stage_retry_controller"
  ],
  "id": "template_selection.verification_repair_gate",
  "objective": "Aggregate specialist evidence, rerun static checker expectations, classify the remaining FFN tile issue as resolved or a current-stage blocker, and enforce repair boundaries so the stage cannot pass on unsupported bindin...<len=260>",
  "role": "template selection verification and repair gate engineer",
  "title": "Gate template-selection closure and repair boundaries"
}
</subtask>
