...
<task>
Check that every selected template required parameter is explicitly bound to model, numeric, board, or design-space constraints; verify source file existence, hashes, case-class constructor/interface agreement, unsupported bindings, and forbidden-edit boundaries.
</task>
...
<subtask>
{
  ...
  "expected_artifacts": [
    ...
    "template_source_interface_review",
    "forbidden_edit_boundary_decision"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "objective": "Check that every selected template required parameter is explicitly bound to model, numeric, board, or design-space constraints; verify source file existence, hashes, case-class constructor/interface agreement, unsupport...<len=263>",
  "role": "template binding engineer",
  "title": "Review strict template parameter and source bindings"
}
</subtask>
