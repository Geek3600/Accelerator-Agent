<agent>
architecture_template_specialist
</agent>

<task>
Bind tile_m, tile_n, and tile_k for mlp_gate_proj, mlp_up_proj, and mlp_down_proj from constraint.arch.design_space with consistency against model dimensions, board memory assumptions, lanes, and numeric policy; keep the binding template-constrained and flag any design-space ambiguity rather than guessing.
</task>
...
<subtask>
{
  ...
  "expected_artifacts": [
    "ffn_tile_binding_patch",
    "tile_legality_matrix_for_mlp_gate_up_down",
    "resource_risk_notes_for_selected_tiles",
    "unsupported_bindings_delta_for_tile_params"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "id": "template_selection.ffn_tile_binding_engineer",
  "objective": "Bind tile_m, tile_n, and tile_k for mlp_gate_proj, mlp_up_proj, and mlp_down_proj from constraint.arch.design_space with consistency against model dimensions, board memory assumptions, lanes, and numeric policy; keep the...<len=307>",
  "role": "FFN tile and resource-risk binding engineer",
  "title": "Resolve FFN tile parameter bindings"
}
</subtask>
...
<candidate_stage_artifact>
{
  ...
  "checker_results": [
    ...
    },
    {
      ...
      "errors": [
        "rms_norm_1: parameter input_bits is not bound from SACG/input artifacts",
        "rms_norm_1: parameter output_bits is not bound from SACG/input artifacts",
        "self_attention: parameter elem_bits is not bound from SACG/input artifacts",
        "residual_add_1: parameter elem_bits is not bound from SACG/input artifacts",
        "rms_norm_2: parameter input_bits is not bound from SACG/input artifacts",
        "rms_norm_2: parameter output_bits is not bound from SACG/input artifacts",
        "mlp_gate_proj: parameter tile_m is not bound from SACG/input artifacts",
        "mlp_gate_proj: parameter tile_n is not bound from SACG/input artifacts",
        "mlp_gate_proj: parameter tile_k is not bound from SACG/input artifacts",
        "mlp_gate_proj: parameter elem_bits is not bound from SACG/input artifacts",
        "mlp_up_proj: parameter tile_m is not bound from SACG/input artifacts",
        "mlp_up_proj: parameter tile_n is not bound from SACG/input artifacts",
        "mlp_up_proj: parameter tile_k is not bound from SACG/input artifacts",
        "mlp_up_proj: parameter elem_bits is not bound from SACG/input artifacts",
        "activation_mul: parameter elem_bits is not bound from SACG/input artifacts",
        "mlp_down_proj: parameter tile_m is not bound from SACG/input artifacts",
        "mlp_down_proj: parameter tile_n is not bound from SACG/input artifacts",
        "mlp_down_proj: parameter tile_k is not bound from SACG/input artifacts",
        "mlp_down_proj: parameter elem_bits is not bound from SACG/input artifacts",
        "residual_add_2: parameter elem_bits is not bound from SACG/input artifacts",
        "softmax: parameter elem_bits is not bound from SACG/input artifacts"
      ],
      "status": "fail",
      "warnings": []
    },
  ...
  "parameter_bindings": [
    ...
    },
    {
      "bound_params": {
        ...
        "tile_k": {
          "source": "constraint.arch.design_space.search_params.tiles.safe_common_ffn_tile_candidates.tile_k",
          "status": "missing",
          "value": null
        },
        "tile_m": {
        ...
        "tile_n": {
          "source": "constraint.arch.design_space.search_params.tiles.safe_common_ffn_tile_candidates.tile_n",
          "status": "missing",
          "value": null
        }
      },
