...
<task>
Verify that every decoder operator in the model sequence is covered by a trusted selected template or explicit required adapter, including the block wrapper, and that no missing coverage is hidden by free-form RTL assumptions.
</task>
...
<subtask>
{
  ...
  "objective": "Verify that every decoder operator in the model sequence is covered by a trusted selected template or explicit required adapter, including the block wrapper, and that no missing coverage is hidden by free-form RTL assump...<len=226>",
