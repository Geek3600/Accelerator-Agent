<agent>
verification_contract_agent
</agent>

<task>
Define the minimal Stage6 verification-plan and artifact-contract repair/backtrack action needed to resolve the earliest active blocker before Stage7 rerun.
</task>
...
<subtask>
{
  ...
  "agent": "verification_contract_agent",
  "artifact_focus": [
  ...
  "expected_artifacts": [
    "stage6_contract_repair_scope",
    "verification_gate_dag_repair_requirements",
    "tool_protocol_contract_gap_report",
    "backtrack_or_retry_decision"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "handoff_to": [
    "repair.targeted_replay_planner",
    "repair.boundary_authority_gate",
    "repair.repair_closure_auditor"
  ],
  "id": "repair.stage6_contract_repair_architect",
  "objective": "Define the minimal Stage6 verification-plan and artifact-contract repair/backtrack action needed to resolve the earliest active blocker before Stage7 rerun.",
  "role": "verification contract repair architect",
  "role_assignment": {
    "collaboration_interfaces": {
      ...
      "consumes": [
        "repair_evidence_classification_report",
        "artifact.stage5.design_artifact_manifest",
        "artifact.input.tool_protocols",
        "artifact.input.case_adapter",
        "artifact.stage6.verification_plan",
    ...
    "decision_authority": [
      "May recommend Stage6 retry/backtrack as the necessary repair boundary.",
      "May define required checker gates for Stage6 contract promotion.",
      "May not claim Stage7 verification promotion or backend readiness."
    ],
    "mission": "Convert the earliest Stage6 provenance blocker into a bounded, checker-verifiable repair or retry action.",
    "out_of_scope": [
      "Editing model semantics, numeric policy, or RTL templates unless a cited verification contract mismatch requires upstream backtrack.",
      "Executing simulator, synthesis, or board tools.",
      "Approving human-boundary exceptions."
    ],
    "primary_responsibilities": [
      "Consume the evidence classifier report and the Stage5/Stage6/tool/case-adapter artifacts.",
      "Identify which Stage6 verification artifacts require regeneration, revalidation, or retry under clean provenance.",
      "Check that the repaired gate DAG binds available real-tool/checker protocols without inventing unsupported case-specific cores.",
      "Declare planned_tool or planned_checker only if a required capability is absent from the action grounding registry."
    ]
  },
  "role_profile": {
    "capabilities": [
  ...
  "title": "Bound the Stage6 verification contract repair"
}
</subtask>
...
<state_summary>
{
  ...
  "sacg_memory": {
    ...
    "open_retry_requests": [
      ...
      },
      {
        ...
        "status": "open",
        "target_stage": "stage7.verification",
        "timestamp": "2026-07-09T22:06:35+00:00"
      },
      {
        "blocked_artifacts": [
          "artifact.stage7.verification_result"
        ],
        "id": "retry_request.0006",
        "reason": "Stage7 verification result did not pass all selected real-tool/checker gates",
        "required_inputs": [
          "artifact.stage6.verification_artifact_contract",
          "artifact.stage6.llm_action_audit"
    ...
    "recent_failure_lessons": [
      ...
      },
      {
        ...
        "failure_class": "verification_real_tool_or_gate",
        "id": "failure_lesson.0006",
        "recommended_action": "Use contract-guided debug closure first: localize the failing transaction to a boundary/root-candidate slice, then let Stage8 repair only that causal slice or backtrack to Stage6 if gate/tool contracts are incomplete.",
        "retry_scope": "stage7_or_stage6_backtrack",
        "stage": "stage7.verification",
        "summary": "verification_plan_static_check: artifact.stage6.verification_plan producer transition is rejected, expected promoted; artifact.stage6.verification_plan is marked rejected_producer and cannot be used as validated downstream input; artifact.stage6.verification_artifact_contract producer transition is rejected, expected promoted; artifact.stage6.verification_artifact_contract is marked rejected_producer and cannot be used as validated downstream input; artifact.stage6.llm_action_audit producer transition is rejected, expected promoted; artifact.stage6.llm_action_audit is marked rejected_producer and cannot be used as validated downstream input; verification_agent_decision_check: verification.evidence_classifier: blocked_by_stage6_retry_and_trust_barriers: Selected Stage7 operator-leaf real-tool evidence passed for the current scope, but the verification result is not promotable. The authoritative blocker set is sacg_memory_truth: 25 active contamination barriers and 5 open retry requests, with the earliest blocker at Stage6 verification-plan/contract provenance. Next bounded checks must repair/promote the Stage6 verification contract, reconcile SACG trust state, rerun operator-leaf closure under the clean contract, then execute the single-transformer-layer closure before any board/AXI/DDR/Vivado/runtime work.",
        "timestamp": "2026-07-09T23:10:59+00:00",
        "violated_constraints": [
          "constraint.verification.plan",
          "constraint.verification.hierarchy",
  ...
  "sacg_memory_truth": {
    "active_contamination_barrier_count": 29,
    "active_contamination_barriers": [
      {
