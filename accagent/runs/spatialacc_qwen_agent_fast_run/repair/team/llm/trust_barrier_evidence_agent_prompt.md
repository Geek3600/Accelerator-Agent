<agent>
trust_barrier_evidence_agent
</agent>

<task>
Audit the rejected Stage7 real-tool and debug evidence under active SACG contamination barriers, distinguishing planning/debug evidence from validated evidence and deciding which results must be rebound or rerun after a clean Stage6 contract.
</task>
...
<subtask>
{
  ...
  "action_type": "evidence_trust_and_replay_classification",
  "agent": "trust_barrier_evidence_agent",
  "artifact_focus": [
    ...
    "state_summary.sacg_memory_truth.active_contamination_barriers",
    "state_summary.sacg_memory_truth.open_retry_requests"
  ],
  "constraints": [
  ...
  "expected_artifacts": [
    "artifact.repair.stage7_evidence_trust_matrix",
    "artifact.repair.rebind_or_rerun_requirements",
    "artifact.repair.blocked_downstream_execution_scope"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "handoff_to": [
    "repair.verification_contract_root_cause_engineer",
    "repair.human_boundary_engineer",
    "repair.repair_closure_gate"
  ],
  "id": "repair.trust_barrier_evidence_engineer",
  "objective": "Audit the rejected Stage7 real-tool and debug evidence under active SACG contamination barriers, distinguishing planning/debug evidence from validated evidence and deciding which results must be rebound or rerun after a ...<len=242>",
  "role": "SACG trust-barrier evidence engineer",
  "role_assignment": {
    "collaboration_interfaces": {
      ...
      "downstream_consumers": [
        "repair.repair_closure_gate",
        "stage7.verification retry planner"
      ],
      "produces": [
        "artifact.repair.stage7_evidence_trust_matrix",
        "artifact.repair.rebind_or_rerun_requirements",
    ...
    "decision_authority": [
      "May downgrade rejected Stage7 evidence to planning/debug evidence.",
      "May require rebinding or rerunning operator-leaf evidence after clean Stage6 contract promotion.",
      "May not decide the technical content of Stage6 contract repairs or approve human-boundary exceptions."
    ],
    "mission": "Protect design closure from contaminated verification evidence by producing a trust-aware replay and rebind disposition.",
    "out_of_scope": [
      "Running or rerunning real tools during repair classification.",
      "Treating rejected Stage7 evidence as promotion evidence.",
      "Changing model semantics, numeric policy, templates, generated code, or runtime layout."
    ],
    "primary_responsibilities": [
      "Read SACG memory truth rather than historical memory text to identify active barriers and retry blockers.",
      "Classify Stage7 evidence as debug-only, rerun-required, or blocked by missing clean Stage6 contract.",
      "Identify required reruns such as targeted_failed_checker_rerun only after Stage6 verification artifacts are promoted.",
      "Block unsupported pass claims for single-transformer-layer, board, AXI, Vivado, and runtime scopes until prerequisite gates are clean."
    ]
  },
  "role_profile": {
    "capabilities": [
  ...
  "title": "Classify contaminated Stage7 evidence and replay eligibility"
}
</subtask>
