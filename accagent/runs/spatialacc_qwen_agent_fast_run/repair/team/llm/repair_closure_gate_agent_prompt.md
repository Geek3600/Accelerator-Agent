<agent>
repair_closure_gate_agent
</agent>

<task>
Merge the parallel repair classifications into a single SACG-consistent repair decision: prioritize Stage6 verification-contract retry, preserve contamination barriers, define Stage7 rebind/rerun prerequisites, and emit only checker-grounded bounded repair actions.
</task>
...
<subtask>
{
  ...
  "action_type": "repair_plan_aggregation_and_gate",
  "agent": "repair_closure_gate_agent",
  "artifact_focus": [
    "artifact.repair.stage6_contract_failure_classification",
    "artifact.repair.stage6_retry_action_candidates",
    "artifact.repair.stage7_evidence_trust_matrix",
    "artifact.repair.rebind_or_rerun_requirements",
    "artifact.repair.human_boundary_decision_table",
  ...
  "expected_artifacts": [
    "artifact.repair.bounded_repair_plan",
    "artifact.repair.retry_backtrack_routing_decision",
    "artifact.repair.checker_rerun_manifest",
    "artifact.repair.sacg_memory_update_request"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "handoff_to": [
    "stage6.verification_artifacts.retry",
    "stage7.verification.retry",
    "sacg_memory_update"
  ],
  "id": "repair.repair_closure_gate",
  "objective": "Merge the parallel repair classifications into a single SACG-consistent repair decision: prioritize Stage6 verification-contract retry, preserve contamination barriers, define Stage7 rebind/rerun prerequisites, and emit ...<len=265>",
  "role": "repair closure auditor",
  "role_assignment": {
    ...
    "decision_authority": [
      "May accept or reject the aggregated repair plan for handoff to retry stages.",
      "May require planned_tool or planned_checker implementation if a required capability is absent.",
      "May not execute repairs, close SACG barriers, or claim verification success."
    ],
    "mission": "Serve as the evidence gate that turns specialist classifications into one cross-layer-consistent repair route.",
    "out_of_scope": [
      "Direct RTL/code/template modification.",
      "Real-tool execution.",
      "Human approval substitution or barrier closure without validated downstream evidence."
    ],
    "primary_responsibilities": [
      "Check that all repair actions cite failed evidence, violated constraints, active SACG blockers, and acceptance checkers.",
      "Enforce ordering: Stage6 contract retry before Stage7 rerun, and Stage7 clean closure before backend or deployment work.",
      "Reject plans that consume contaminated artifacts as validated inputs.",
      "Create a checker-rerun manifest using canonical checker/tool names from the grounding registry."
    ]
  },
  "role_profile": {
    "capabilities": [
  ...
  "title": "Aggregate bounded repair classifications into a checker-gated repair plan"
}
</subtask>
