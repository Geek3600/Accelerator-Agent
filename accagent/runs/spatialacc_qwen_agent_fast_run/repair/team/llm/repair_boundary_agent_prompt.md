<agent>
repair_boundary_agent
</agent>

<task>
Convert root-cause and trust-barrier findings into bounded repair actions that respect human-agent approval boundaries and avoid unsupported free-form RTL or backend changes.
</task>
...
<subtask>
{
  ...
  "action_type": "bounded_repair_classification",
  "agent": "repair_boundary_agent",
  "artifact_focus": [
  ...
  "objective": "Convert root-cause and trust-barrier findings into bounded repair actions that respect human-agent approval boundaries and avoid unsupported free-form RTL or backend changes.",
  ...
  "role_assignment": {
    ...
    "decision_authority": [
      "May approve classification of auto-allowed contract/planning repairs.",
      "May mark actions approval-required under human boundary policy.",
      "May forbid or defer repair actions that rely on contaminated evidence or exceed template constraints."
    ],
    "mission": "Ensure repair classification stays within SACG-guided, template-constrained, checker-verified boundaries.",
    "out_of_scope": [
      "Implementing repairs directly.",
      "Overriding human approval requirements.",
      "Authorizing free-form RTL generation or board deployment closure."
    ],
    "primary_responsibilities": [
      "Transform causal findings into bounded repair actions.",
      "Apply artifact.input.human_agent_boundary to each repair action.",
      "Require human approval for actions that alter trusted templates, model semantics, or deployment assumptions beyond approved scope.",
      "Defer or forbid backend/board/runtime actions until verification blockers are resolved.",
      "Prepare clean handoff to Stage6 retry and later Stage7 rerun."
    ]
  },
  "role_profile": {
    "capabilities": [
  ...
  "title": "Classify repair actions by auto-allowed, approval-required, or forbidden boundary"
}
</subtask>
