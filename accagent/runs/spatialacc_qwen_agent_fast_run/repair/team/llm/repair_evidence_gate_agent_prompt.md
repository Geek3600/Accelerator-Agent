<agent>
repair_evidence_gate_agent
</agent>

<task>
Audit the combined repair classifications and decide whether the stage should hand off to Stage6 retry, Stage7 rerun, or human approval, while maintaining contamination barriers until checker evidence is clean.
</task>
...
<subtask>
{
  ...
  "action_type": "repair_evidence_gate",
  "agent": "repair_evidence_gate_agent",
  "artifact_focus": [
    "bounded_repair_action_table",
    "stage6_retry_handoff_card",
    "active_blocker_inventory",
  ...
  "expected_artifacts": [
    "repair_closure_gate_decision",
    "accepted_repair_plan_manifest",
    "blocked_promotion_rationale",
    "next_stage_handoff_directive"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "id": "repair.final_evidence_gate",
  "objective": "Audit the combined repair classifications and decide whether the stage should hand off to Stage6 retry, Stage7 rerun, or human approval, while maintaining contamination barriers until checker evidence is clean.",
  "role": "repair closure evidence gate auditor",
  "role_assignment": {
    ...
    "decision_authority": [
      "May accept the repair plan manifest for handoff if all required checkers pass.",
      "May block promotion when active retry requests or contamination barriers remain unresolved.",
      "May route approval-required actions to human_approval_queue."
    ],
    "mission": "Serve as the checker-evidence gate for repair closure and prevent unsafe cross-layer handoff.",
    "out_of_scope": [
      "Running Stage7 real tools.",
      "Clearing SACG barriers without rerun/checker evidence.",
      "Approving backend, AXI, DDR, Vivado, or runtime work before verification hierarchy closure."
    ],
    "primary_responsibilities": [
      "Aggregate outputs from all repair specialists.",
      "Verify that every repair action has a causal evidence link, violated constraint, trust status, and boundary classification.",
      "Decide the legal next handoff: Stage6 retry first, Stage7 rerun only after clean contract promotion, or human approval queue.",
      "Record why contaminated Stage6/Stage7/Stage8 artifacts remain planning/debug evidence until rerun passes."
    ]
  },
  "role_profile": {
    "capabilities": [
  ...
  "title": "Gate the bounded repair plan for cross-layer consistency and legal handoff"
}
</subtask>
