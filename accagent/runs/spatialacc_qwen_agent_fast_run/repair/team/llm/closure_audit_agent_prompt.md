...
<task>
Aggregate specialist outputs and verify that the final repair handoff is SACG-consistent, checker-grounded, contamination-aware, and limited to the bounded repair/backtrack path required by current blockers.
</task>
...
<subtask>
{
  ...
  "expected_artifacts": [
    "repair_closure_audit_report",
    "accepted_bounded_repair_plan",
    "blocked_claims_register",
    "next_stage_handoff_decision"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "handoff_to": [
    ...
    "stage8.repair_execution",
    "stage7.verification"
  ],
  "id": "repair.repair_closure_auditor",
  "objective": "Aggregate specialist outputs and verify that the final repair handoff is SACG-consistent, checker-grounded, contamination-aware, and limited to the bounded repair/backtrack path required by current blockers.",
  "role": "SACG repair closure auditor",
  "role_assignment": {
    ...
    "decision_authority": [
      "May accept the bounded repair handoff for Stage6 retry or Stage8 execution.",
      "May block Stage7/board promotion claims lacking clean checker evidence.",
      "May not perform design modifications or override human approval requirements."
    ],
    "mission": "Serve as the evidence gate for repair closure and prevent unsupported promotion or deployment claims.",
    "out_of_scope": [
      "Executing Vivado, board runtime, or simulator tools.",
      "Clearing contamination barriers directly.",
      "Expanding repair beyond the approved causal slice."
    ],
    "primary_responsibilities": [
      "Consume all specialist repair artifacts from parallel_group=0.",
      "Audit cross-layer consistency from Stage5 design package through Stage6 contract, Stage7 replay, and Stage8 repair boundaries.",
      "Confirm that checker evidence and SACG memory blockers determine the next handoff.",
      "Produce the accepted bounded repair plan or a blocked-claims register."
    ]
  },
  "role_profile": {
    "capabilities": [
  ...
  "title": "Audit cross-layer repair plan consistency before execution handoff"
}
</subtask>
