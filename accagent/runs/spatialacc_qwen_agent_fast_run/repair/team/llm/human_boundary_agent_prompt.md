<agent>
human_boundary_agent
</agent>

<task>
Classify each proposed repair action as auto-allowed, approval-required, forbidden, or requiring Stage6 backtrack, according to the human-agent boundary and current SACG trust barriers.
</task>
...
<subtask>
{
  ...
  "action_type": "repair_boundary_review",
  "agent": "human_boundary_agent",
  "artifact_focus": [
  ...
  "expected_artifacts": [
    ...
    "human_approval_request_list",
    "forbidden_action_blocklist",
  ...
  "id": "repair.boundary_authority_gate",
  "objective": "Classify each proposed repair action as auto-allowed, approval-required, forbidden, or requiring Stage6 backtrack, according to the human-agent boundary and current SACG trust barriers.",
  "role": "repair boundary authority",
  "role_assignment": {
    ...
    "decision_authority": [
      "May block downstream repair execution when boundary evidence is insufficient.",
      "May require human approval or Stage6 retry/backtrack.",
      "May not approve its own approval-required actions on behalf of the human."
    ],
    "mission": "Guard the human-agent boundary so bounded repair remains template-constrained and checker-verifiable.",
    "out_of_scope": [
      "Deriving root cause without checker evidence.",
      "Executing repairs or clearing retry requests.",
      "Adding unsupported tools or bypassing case adapter constraints."
    ],
    "primary_responsibilities": [
      "Consume proposed repair scopes from evidence, contract, and replay specialists.",
      "Apply artifact.input.human_agent_boundary to classify permissions.",
      "Prepare explicit approval requests for any action that exceeds automatic repair authority.",
      "Generate a blocklist for forbidden, premature, or backend-escalating actions."
    ]
  },
  "role_profile": {
    "capabilities": [
  ...
  "title": "Enforce human approval and bounded repair limits"
}
</subtask>
