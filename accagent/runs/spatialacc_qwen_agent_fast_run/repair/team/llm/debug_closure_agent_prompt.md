...
<task>
Define the bounded Stage7 rerun sequence that must occur after clean Stage6 verification artifacts are promoted, preserving operator-leaf evidence as debug-only until rerun under the clean contract.
</task>
...
<subtask>
{
  ...
  "action_type": "targeted_replay_planning",
  "agent": "debug_closure_agent",
  "artifact_focus": [
  ...
  "expected_artifacts": [
    ...
    "failure_localization_replay_scope",
    "operator_leaf_then_single_layer_gate_sequence",
    "real_tool_evidence_requirements"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "id": "repair.targeted_replay_planner",
  "objective": "Define the bounded Stage7 rerun sequence that must occur after clean Stage6 verification artifacts are promoted, preserving operator-leaf evidence as debug-only until rerun under the clean contract.",
  "role": "targeted verification replay planner",
  "role_assignment": {
    ...
    "decision_authority": [
      "May order Stage7 checker/tool replay gates.",
      "May identify evidence gaps requiring rerun.",
      "May not modify repair actions or waive human approvals."
    ],
    "mission": "Translate repaired verification contracts into a minimal clean rerun path that localizes failures and prevents premature backend claims.",
    "out_of_scope": [
      "Running replay tools during decomposition.",
      "Claiming numerical correctness without numeric_compare or case golden compare evidence.",
      "Starting board/runtime/Vivado closure."
    ],
    "primary_responsibilities": [
      "Consume evidence classification and Stage6 contract repair scope.",
      "Define boundary, failure-localization, targeted replay, and real-tool evidence gates for Stage7 rerun.",
      "Ensure data-order, transfer-count, and liveness risks are included only when implicated by the selected verification scope.",
      "Keep backend/board evidence blocked until hierarchy gates pass."
    ]
  },
  "role_profile": {
    "capabilities": [
  ...
  "title": "Plan clean Stage7 replay after contract repair"
}
</subtask>
