...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "The real VCS run compiled successfully but terminated at the board output-lifecycle frontier; its termination provenance explicitly marks source_semantic_repair_eligible=false, so no board-adapter behavioral change is authorized.",
        "The current CCTG slice records a direct contradiction to the certified connected-kernel boundary: complete core ingress was observed with ready core egress and zero accepted egress beats. The supplied board adapter and testbench already materialize the required direct-core and MLP-tail observations; repeating or weakening those probes would not produce a causally distinct repair.",
        "The dynamic-report schema failures are downstream artifacts of the nonterminal simulation and have no uniquely identified writable producer record in the supplied generated sources. The testbench\u2019s emitted board-progress, boundary-trace, AXI, runtime-loader, and pipeline reports already carry their declared schema_version and evidence_kind fields."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "7822da0e24abe9a482a1a506f93557b5ee0929e0445ca53710a0a75a9a3871fb",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "b2d4fb3401b9cbab205c23d1f681ddd69949ad7a3ad9cd696a4374feb3e75b27",
          ...
          "required_capabilities": [
            {
              ...
              "rationale": "The current executed trace is the required explicit lower-layer contradiction. Ownership is the certified connected kernel, not the board adapter, exact user wrapper, AXI monitor, target-model artifacts, or numeric policy; therefore only the contradicted connected-kernel scope may be reopened.",
              "required_evidence": [
                "A real-tool targeted replay using the immutable checkpoint, stimulus, complete weight/runtime image bindings, and current certified-kernel source hashes.",
                "A schema-valid CCTG boundary trace covering boundary.edge_data_stage_06_activation_mul_to_stage_07_mlp_down_proj_main and boundary.edge_data_stage_07_mlp_down_proj_to_stage_08_residual_add_2_main through terminal accepted-handshake behavior.",
                "A causal-repair context that reconciles the observed full core-ingress count, MLP-down ingress/output counts, ready core egress, and zero core-egress accepted count with the single-layer certificate."
              ],
              "target_modules": [
          ...
          "sha256": "4c521eb5a3992842b7195e7332809183c2f75445e5366a8261073ec6df44e9e8",
      ...
      "report": {
        ...
        "sha256": "3cbe7d3a828d1aba2411a276e3d4dcbcd297fbcfb9080e9e6ddade6a6de05b28"
      },
      "required_capabilities": [
        {
          "capability_id": "connected_kernel_cctg_contradiction_targeted_replay",
  ...
  "repair_actions": [
    {
      ...
      "reason": "The current executed trace is the required explicit lower-layer contradiction. Ownership is the certified connected kernel, not the board adapter, exact user wrapper, AXI monitor, target-model artifacts, or numeric policy; therefore only the contradicted connected-kernel scope may be reopened.",
      ...
      "requested_capability_id": "connected_kernel_cctg_contradiction_targeted_replay",
      "requested_producer_scope": "certified_connected_kernel_current_layer_replay",
      "required_evidence": [
        "A real-tool targeted replay using the immutable checkpoint, stimulus, complete weight/runtime image bindings, and current certified-kernel source hashes.",
        "A schema-valid CCTG boundary trace covering boundary.edge_data_stage_06_activation_mul_to_stage_07_mlp_down_proj_main and boundary.edge_data_stage_07_mlp_down_proj_to_stage_08_residual_add_2_main through terminal accepted-handshake behavior.",
        "A causal-repair context that reconciles the observed full core-ingress count, MLP-down ingress/output counts, ready core egress, and zero core-egress accepted count with the single-layer certificate."
      ...
      "source_feedback_fingerprint_sha256": "7822da0e24abe9a482a1a506f93557b5ee0929e0445ca53710a0a75a9a3871fb",
      "target_modules": [
        "SingleLayerSemanticHarness",
        "ConnectedObservableLlamaStyleBlock",
        "GatedMLP"
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-06T15:08:23+00:00",
