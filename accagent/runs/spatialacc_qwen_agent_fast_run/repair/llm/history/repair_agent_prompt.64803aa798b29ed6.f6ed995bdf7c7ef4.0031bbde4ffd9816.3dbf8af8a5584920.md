...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "The completed VCS compile passed, but the runtime process returned remote_tool_failure/exit code 1 without raw terminal-log, signal, timeout/kill, wall-time, or simulation-cycle termination provenance. Therefore the missing pipeline_overlap_report.json, runtime_loader_report.json, and axi_protocol_report.json are a terminal-output cascade, not evidence of a source-level pipeline-overlap, loader, AXI, DDR, or DUT failure.",
        "The current boundary trace confirms the required ordering of accepted input before the single lifecycle start and records subsequent kernel ingress/stage-0 activity without an explicit contradiction of a named certified connected-kernel invariant. It does not localize a repairable board-adapter defect.",
        "The reported dynamic-evidence schema errors are associated with absent completion reports after the unclassified runtime termination. The compact evidence does not uniquely identify a malformed agent-owned event/report producer, so changing the testbench schema or analyzer would be speculative and is not authorized."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "ce5a4e3afc091704b305fc429fcc4711940f1806eb035f0128e35ed9fd3f7858",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "44f1c71fa376f4f58762e82e34990055f88f09394f8e5778327904706086e85d",
          ...
          "required_capabilities": [
            {
              ...
              "debug_layer": "board_axi_ddr_wrapped_system",
              "producer_scope": "framework remote VCS runner and VCS evidence analyzer",
              "rationale": "The current run cannot distinguish an external termination or resource timeout from a simulator/DUT failure. This capability must be added before modifying board RTL or testbench behavior, because missing completion reports and the analyzer's invalid pipeline-overlap result are presently non-causal terminal-output cascades. The replay must preserve the exact wrapper, certified kernel, checkpoint, stimulus, target-model expected output, and frozen numeric policy.",
              "required_evidence": [
                "Raw terminal simulator log tail from the executed run",
                "Process exit code plus signal, timeout, external-kill, and normal-completion classification",
                "Configured wall-time and simulation-cycle budgets",
                "Classification linking any missing dynamic reports to normal completion, simulator fatal, external termination, or timeout",
                "A fresh exact-source hash-bound replay after provenance capture is enabled"
              ],
              "target_modules": [
                "framework remote VCS execution runner",
                "case_vcs_evidence_analyzer",
                "termination-provenance completeness checker"
              ]
            }
          ],
          "scope": "verification_capability_repair",
          "sha256": "549c2ada361564fdbbac96794a4dfc723c20052f674cb938ccc48be0aaed5605",
      ...
      "report": {
        ...
        "sha256": "723709eae503d00632cab3f6bbc18acc6edfc46b14066dd12a8c7aadd070eb99"
      },
      "required_capabilities": [
        {
          "capability_id": "remote_vcs_termination_disambiguation_and_replay_authorization",
  ...
  "failures": [
    {
      ...
      "execution_fingerprint_sha256": "7d219ad80a87e219bdc133a6f106d1580fe29824be9de38646a030953fcd794e",
    ...
    },
    {
      ...
      "repair_hint": "inspect violated constraint and rerun the related checker",
      "status": "fail",
      "summary": "verification.evidence_classifier: needs_repair: Fail-closed Stage7 decision: board_axi_ddr_closure is not promotable to Vivado synthesis, implementation, bitstream generation, runtime-ABI release, or board runtime. The direct executed failure is case_axi_ddr_interface: the board-simulation manifest does not hash-bind the current exact sample-project identity, its compile authority and ordered-command authority references do not bind the exact Vivado-export facts, and its simulator executables are not authorized by the current tool profile or cited export evidence. VCS functional simulation was dependency-skipped, so the aggregate functional_sim failure is not board-level RTL value, numeric, liveness, order, AXI, DDR, weight-consumption, or output-frontier evidence. Repair the board verification/integration contract, rerun the failed interface gate, and then execute the remaining Stage7 DAG. Reuse the hash-validated operator-leaf and connected single-layer certificates because no current trace contradicts a named lower-layer invariant. Conditional design-team review was no_split and cannot replace deterministic tool evidence."
    }
  ],
  ...
  "repair_actions": [
    {
      ...
      "failure_signature": {
        ...
        "summaries": [
          ...
          "verification.evidence_classifier: needs_repair: Fail-closed Stage7 decision: board_axi_ddr_closure is not promotable to Vivado synthesis, implementation, bitstream generation, runtime-ABI release, or board runtime. The direct executed failure is case_axi_ddr_interface: the board-simulation manifest does not hash-bind the current exact sample-project identity, its compile authority and ordered-command authority references do not bind the exact Vivado-export facts, and its simulator executables are not authorized by the current tool profile or cited export evidence. VCS functional simulation was dependency-skipped, so the aggregate functional_sim failure is not board-level RTL value, numeric, liveness, order, AXI, DDR, weight-consumption, or output-frontier evidence. Repair the board verification/integration contract, rerun the failed interface gate, and then execute the remaining Stage7 DAG. Reuse the hash-validated operator-leaf and connected single-layer certificates because no current trace contradicts a named lower-layer invariant. Conditional design-team review was no_split and cannot replace deterministic tool evidence."
        ]
      },
      "minimal_repair_context": {
        "failed_current_layer_gates": [
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-28T17:58:47+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-28T15:39:52+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-28T17:54:26+00:00",
  ...
  "recent_failure_lessons": [
    ...
    },
    {
      ...
      "failure_class": "bounded_repair_required",
      "id": "failure_lesson.0181",
      "recommended_action": "Execute or approve the bounded repair workflow, then rerun Stage7. Do not continue to backend/board closure with unresolved verification failures.",
      "retry_scope": "repair_then_stage7_rerun",
      "stage": "stage8.repair",
      "summary": "real_tool.case_axi_ddr_interface: returncode=1 report_status=fail blockers=simulation.source_identity_sha256 does not bind the current identity document; simulation.vcs_compile_plan.compile_authority does not bind the identity's exact Vivado export facts; simulation.vcs_compile_plan.ordered_commands[0].authority_refs do not bind exact Vivado export contexts; simulation.vcs_compile_plan.ordered_commands[0].executable is not authorized by current tool_profile or referenced Vivado export; case_functional_sim_precondition_check: real functional simulation preconditions failed: board_testbench_artifact_loading missing required tokens: ['exact_sample_top_module']; dependency_blocked=['case_multilayer_pipeline will be produced and judged by the current Stage7 tool scope', 'case_multilayer_functional will be produced and judged by the current Stage7 tool scope', 'case_axi_ddr_interface will be produced and judged by the current Stage7 tool scope', 'case_axi_protocol_check will be produced and judged by the current Stage7 tool scope', 'case_ddr_image_roundtrip will be produced and judged by the current Stage7 tool scope']; required_real_tool_evidence_check: required real-tool evidence missing or failed: case_axi_ddr_interface=fail; dependency_blocked=['case_vcs_functional_sim=not_run', 'case_vcs_evidence_analyzer=not_run', 'case_deadlock_axi_check=not_run', 'case_multilayer_functional=not_run', 'case_pipeline_deadlock_check=not_run', 'case_axi_protocol_check=not_run', 'case_ddr_image_roundtrip=not_run', 'case_board_semantic_evidence=not_run', 'functional_sim: blocked by prerequisite gate [case_vcs_functional_sim=not_run]']; real_weight_semantic_evidence_check: real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; hierarchical_verification_maturity_check: multilayer_pipeline_functional: functional_sim=fail, case_multilayer_functional=not_run, case_pipeline_deadlock_check=not_run; axi_ddr_functional: case_axi_ddr_interface=fail, functional_sim=fail, case_axi_protocol_check=not_run, case_ddr_image_roundtrip=not_run, case_board_semantic_evidence=not_run; real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; verification_agent_decision_check: verification.evidence_classifier: needs_repair: Fail-closed Stage7 decision: board_axi_ddr_closure has not passed and cannot promote to Vivado synthesis, implementation, bitstream generation, runtime-ABI release, or board runtime. The executed case_axi_ddr_interface gate failed because the board-simulation identity hash, Vivado-export compile authority, ordered-command authority references, and simulator executable authorization do not bind the current exact sample-project identity. The functional-simulation precondition also lacks the required exact_sample_top_module loading token. VCS was dependency-skipped, so there is no executed board-level value, numeric, liveness, order, AXI, DDR, weight-consumption, or output-frontier evidence and no justified RTL root candidate. Certified operator-leaf and connected single-layer evidence remains reusable because no current trace contradicts a named lower-layer invariant. The conditional design-team review was no_split and cannot replace deterministic tool evidence.",
      "timestamp": "2026-07-28T15:29:46+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.plan",
        "constraint.tool.protocols",
    ...
    },
    {
      ...
      "timestamp": "2026-07-28T15:35:39+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.functional_scope"
      ]
    ...
    },
    {
      ...
      "timestamp": "2026-07-28T17:58:47+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.functional_scope"
      ]
