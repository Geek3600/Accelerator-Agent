...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    "case_vcs_functional": {
      "applicability": {
        ...
        "validation_errors": [
          ...
          "source_artifacts[1] live sha256 changed",
          "source_artifacts[2] live sha256 changed",
          "source_artifacts[4] live sha256 changed",
    ...
    "prior_repair_execution_feedback": {
      ...
      "execution_errors": [],
      "input_fingerprint_sha256": "3b81a9cb5c55bfde3e2c7009afc8677af1d79c9c192461846ad0e8df15db9779",
      "llm_records": [
        {
          "agent": "exact_board_integration_generation_agent",
          "blockers": [],
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "5301f6543f705d14cb10d3ae9cbf7caf85cf27c057d748a396ab9ab6bde80503",
          ...
          "sha256": "ae62b7aced37205bb02b796f422ffe3cf64e9cb23f32c92009d3fb328f0b4d70",
  ...
  "failures": [
    {
      ...
      "execution_fingerprint_sha256": "9c851afcb704dc62a2c4ac95e2d29958049a95f61fe39ced38d38df8f4f86573",
    ...
    },
    {
      ...
      "repair_hint": "inspect violated constraint and rerun the related checker",
      "status": "fail",
      "summary": "verification.evidence_classifier: needs_repair: Stage7 board_axi_ddr_closure is fail-closed. The earliest directly executed current-scope failure is real_tool.case_axi_ddr_interface (returncode=1), which rejects the board simulation source-identity binding and canonical VCS compile authority; case_functional_sim_precondition_check also reports missing verification/board_simulation/board_tb.sv. functional_sim is therefore an unsatisfied aggregate gate, not executed VCS/RTL/AXI/DDR/numeric/liveness evidence. No backend synthesis, implementation, bitstream, runtime ABI release, or board-runtime promotion is authorized. Certified operator-leaf and elastic connected-single-layer evidence remains reusable because no current hash-bound board trace contradicts a named lower-layer invariant."
    }
  ],
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "observation_count": 1,
      "observed_source_fingerprint_sha256s": [
        "048d12e104830d87a219a134af6eb5bf82937ab789699c33131f747f48754b7a"
      ],
      "observed_transition_ids": [
        "transition.2122"
      ],
      "policy": "Downstream stages must treat artifacts from rejected transitions as planning/debug evidence only, not validated design inputs.",
      "reason": "one or more framework static checks failed",
      "source_fingerprint_sha256": "048d12e104830d87a219a134af6eb5bf82937ab789699c33131f747f48754b7a",
      "status": "active",
      "timestamp": "2026-07-27T14:33:33+00:00",
