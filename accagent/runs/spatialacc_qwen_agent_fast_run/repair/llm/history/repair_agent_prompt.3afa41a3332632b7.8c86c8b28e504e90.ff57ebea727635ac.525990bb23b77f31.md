  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        ...
        "The reported hierarchy error has no source path, line number, declaration context, or compile-order attribution; source_semantic_repair_eligible=false.",
        "Current patch feedback prohibits an unchanged-source replay. Remote VCS stage-pruning environment recovery is required before the unchanged hash-bound exact-board VCS/AXI/DDR chain can be launched.",
        "No board RTL, manifest, monitor, testbench, or observability edit is causally authorized by the supplied evidence."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "b65a29dbaa2320e400a7424832e8814c16523ccd2bade1ccf18209d93225e628",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "0936b459550c5512d11edbe02b1e2ffe85d706be1d5a52638de89e41edd32246",
          ...
          "required_capabilities": [
            {
              ...
              "rationale": "Read the preserved real-board VCS artifacts and recover the remote prelaunch environment or provide source-attributed compile provenance. This capability must not authorize an unchanged-source replay while the current patch prohibition remains active.",
              "required_evidence": [
                ...
                "/current_board_vcs_feedback/diagnosis/value/failure_evidence/termination_provenance/status",
                "/current_board_vcs_feedback/diagnosis/value/failure_evidence/termination_provenance/remote_state",
          ...
          "sha256": "4057e17ff11f431d736884074eee32cd7aab9f73b8d9d0bb856b3ef12aacad5b",
      ...
      "report": {
        ...
        "sha256": "23e05406866e1130d1592ee4e49c1c3418b4a0648a7ae509a0b5489958cee65d"
      },
      "required_capabilities": [
        {
          "capability_id": "vcs_compile_diagnostic_source_provenance",
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-04T12:10:08+00:00",
      "observation_count": 238,
      "observed_transition_ids": [
        "transition.2410",
        "transition.2411",
        "transition.2412",
