  ...
  "failures": [
    {
      ...
      "execution_fingerprint_sha256": "be6edab0e8d80e18274e709cce08f20455a9dc7409799e6e60d2042334fd5434",
    ...
    },
    {
      ...
      "repair_hint": "inspect violated constraint and rerun the related checker",
      "status": "fail",
      "summary": "verification.evidence_classifier: needs_repair: Fail-closed Stage7 decision: board_axi_ddr_closure is not promotable. The directly executed failing gate is case_axi_ddr_interface, whose board-simulation identity hash, Vivado-export compile authority, ordered-command authority references, and simulator executable authorization do not bind the current exact sample-project identity. The underlying VCS functional simulator was dependency-skipped, so the aggregate functional_sim failure is not evidence of an RTL value, numeric, ordering, liveness, AXI, DDR, weight-consumption, or output-frontier defect. Repair the board verification/compile-authority contract, rerun the failed interface gate, and only then continue the ordered board-level DAG. Certified operator-leaf and connected single-layer evidence remains reusable because no current trace contradicts a named lower-layer invariant. Conditional design-team routing returned no_split and cannot replace deterministic tool evidence."
    }
  ],
  ...
  "repair_actions": [
    {
      ...
      "failure_signature": {
        ...
        "summaries": [
          ...
          "verification.evidence_classifier: needs_repair: Fail-closed Stage7 decision: board_axi_ddr_closure is not promotable. The directly executed failing gate is case_axi_ddr_interface, whose board-simulation identity hash, Vivado-export compile authority, ordered-command authority references, and simulator executable authorization do not bind the current exact sample-project identity. The underlying VCS functional simulator was dependency-skipped, so the aggregate functional_sim failure is not evidence of an RTL value, numeric, ordering, liveness, AXI, DDR, weight-consumption, or output-frontier defect. Repair the board verification/compile-authority contract, rerun the failed interface gate, and only then continue the ordered board-level DAG. Certified operator-leaf and connected single-layer evidence remains reusable because no current trace contradicts a named lower-layer invariant. Conditional design-team routing returned no_split and cannot replace deterministic tool evidence."
        ]
      },
      "minimal_repair_context": {
        "failed_current_layer_gates": [
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-28T18:34:05+00:00",
  ...
  "recent_failure_lessons": [
    ...
    },
    {
      ...
      "timestamp": "2026-07-28T18:34:05+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.functional_scope"
      ]
