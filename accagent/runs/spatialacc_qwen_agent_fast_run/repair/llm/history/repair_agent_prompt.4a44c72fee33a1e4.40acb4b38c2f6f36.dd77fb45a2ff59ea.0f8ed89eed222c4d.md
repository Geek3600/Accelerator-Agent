...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "The earliest authoritative failure is VCS Error-[ITSFM] Illegal `timescale for module, but current_board_vcs_feedback does not identify the offending pathname, source line, module declaration context, compile order, or language-mode/timescale provenance.",
        "None of the three complete editable board-integration sources contains a `timescale directive, so no causal editable-source repair is determined. The diagnosis also references read-only certified-kernel source IDs, which cannot be edited in this repair scope.",
        "An unchanged-source replay is not authorized: the required compiler source/path/line provenance distinction is absent, and the current termination evidence is indeterminate downstream of compilation."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "b38c865ba10ab1e105003e0bb90dce6074d053df73a0b3b908d1c02576c8009c",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "f0c713d4d923d8bb987c1d83090464dc9dbc95a5f0c1db91669a2db4f0eb3c8c",
          ...
          "required_capabilities": [
            {
              ...
              "rationale": "Read preserved real-board VCS artifacts to attribute the illegal `timescale error to an exact source and compile context. Only after that provenance identifies an editable generated board source may a bounded atomic replacement be considered; do not modify certified kernel sources, the exact sample wrapper, or the compile authority speculatively.",
              "required_evidence": [
                "Authoritative VCS compile diagnostic naming the offending absolute or manifest-resolved source pathname and line number.",
                "The offending module declaration and surrounding source context containing or inheriting the `timescale directive.",
                "Canonical ordered VCS compile-plan entry for the offending source, including compile order and language mode/directive handling.",
                "Source-ID-to-path/module mapping for every related certified_kernel.* source ID and generated board-integration source implicated by the diagnostic.",
                "Current compile.log or equivalent preserved runner artifact with the complete first-error context, without substituting a simplified wrapper or changing compile authority."
              ],
              "target_modules": [
          ...
          "sha256": "abc484b197dabf86cc0926fd4ef519a1908b881f4a73302296a04bd62e67593c",
      ...
      "report": {
        ...
        "sha256": "079b92f65925bb864ddda9f670000877cceed4ee6781255300952b39ca25943d"
      },
      "required_capabilities": [
        {
          "capability_id": "vcs_compile_diagnostic_source_provenance",
  ...
  "repair_actions": [
    {
      ...
      "debug_layer": "board_axi_ddr_wrapped_system",
      "reason": "Read preserved real-board VCS artifacts to attribute the illegal `timescale error to an exact source and compile context. Only after that provenance identifies an editable generated board source may a bounded atomic replacement be considered; do not modify certified kernel sources, the exact sample wrapper, or the compile authority speculatively.",
      ...
      "source_feedback_fingerprint_sha256": "b38c865ba10ab1e105003e0bb90dce6074d053df73a0b3b908d1c02576c8009c",
      "target_modules": [
        "app_shell_9p_cnn_core_0_1",
        "spatialacc_axi4_protocol_monitor",
        "spatialacc_exact_board_multilayer_tb",
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-02T13:14:20+00:00",
      "observation_count": 21,
      "observed_transition_ids": [
        "transition.2123",
        "transition.2129",
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-02T13:15:18+00:00",
