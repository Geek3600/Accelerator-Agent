  ...
  "diagnostics": {
    ...
    "contract_guided_debug_closure": {
      ...
      "failing_transaction": {
        ...
        "summary": "returncode=1 report_status=fail blockers=board-interface LLM agent did not return real structured interpretation: board-interface selector LLM failed: selector map worker is not bound to its semantic checkpoint chunk: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_interface/llm/history/exact_board_interface_selector_map_000_agent_result.4f7ead5805075276.6d54be4df4d8f8b0.24830dacb43b19a4.4f7ead5805075276.json; board-interface selector status is not ready/pass: blocked; board-interface selector blocker: selector map worker is not bound to its semantic checkpoint chunk: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_interface/llm/history/exact_board_interface_selector_map_000_agent_result.4f7ead5805075276.6d54be4df4d8f8b0.24830dacb43b19a4.4f7ead5805075276.json; board-interface selector did not choose a Vivado cell object ID; selector wrapper_source_id is not in the sample simulation closure; selector relevant_sample_source_ids are empty, unknown, or omit the wrapper; selector proposed replacement sources are empty or outside its sample evidence set; board-interface LLM status is not ready/pass: blocked; board-interface LLM blocker: board-interface selector LLM failed: selector map worker is not bound to its semantic checkpoint chunk: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_interface/llm/history/exact_board_interface_selector_map_000_agent_result.4f7ead5805075276.6d54be4df4d8f8b0.24830dacb43b19a4.4f7ead5805075276.json; board-interface LLM blocker: board-interface selector status is not ready/pass: blocked"
      },
    ...
    "hierarchical_repair_loop": {
      "agent_runtime_llm_blocker": true,
      "current_layer": {
        "id": "board_axi_ddr_wrapped_system",
        "missing_or_failed": [
          "case_board_interface_discovery=fail",
          "case_multilayer_pipeline=not_run",
    ...
    "prior_repair_execution_feedback": {
      ...
      "execution_errors": [],
      "input_fingerprint_sha256": "02123f229ad5516bb2045e415864046755edd4e70dea1d7e6349fc3b79c861d6",
      "llm_records": [],
      ...
      "report": {
        ...
        "sha256": "37456ffa75c632a6b22bd454ea6180998dd442801a71b697dfeea31442f07e26"
      },
      "required_capabilities": [],
      "schema_version": "spatialaccagent.prior_repair_execution_feedback.v1",
      "scope_selection": {
        "excluded_unbound_or_other_layer_record_count": 1,
  ...
  "failures": [
    {
      ...
      "checker": "real_tool.case_board_interface_discovery",
      "command": "python3 scripts/verification/sample_project_board_interface_discovery.py --run-dir /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run",
      "execution_fingerprint_sha256": "680f9c56d1418080e43ae4897167f255dcbbb808d695c7355b4c85f4e98f8fe1",
      "failure_class": "runtime_harness",
      "kind": "case_board_interface_discovery",
      "log_path": "/home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/real_tools/case_board_interface_discovery.json",
      "produced_reports": [
        {
          "blockers": [
            "board-interface LLM agent did not return real structured interpretation: board-interface selector LLM failed: selector map worker is not bound to its semantic checkpoint chunk: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_interface/llm/history/exact_board_interface_selector_map_000_agent_result.4f7ead5805075276.6d54be4df4d8f8b0.24830dacb43b19a4.4f7ead5805075276.json; board-interface selector status is not ready/pass: blocked; board-interface selector blocker: selector map worker is not bound to its semantic checkpoint chunk: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_interface/llm/history/exact_board_interface_selector_map_000_agent_result.4f7ead5805075276.6d54be4df4d8f8b0.24830dacb43b19a4.4f7ead5805075276.json; board-interface selector did not choose a Vivado cell object ID; selector wrapper_source_id is not in the sample simulation closure; selector relevant_sample_source_ids are empty, unknown, or omit the wrapper; selector proposed replacement sources are empty or outside its sample evidence set",
            "board-interface LLM status is not ready/pass: blocked",
            "board-interface LLM blocker: board-interface selector LLM failed: selector map worker is not bound to its semantic checkpoint chunk: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_interface/llm/history/exact_board_interface_selector_map_000_agent_result.4f7ead5805075276.6d54be4df4d8f8b0.24830dacb43b19a4.4f7ead5805075276.json",
            "board-interface LLM blocker: board-interface selector status is not ready/pass: blocked",
            "board-interface LLM blocker: board-interface selector blocker: selector map worker is not bound to its semantic checkpoint chunk: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_interface/llm/history/exact_board_interface_selector_map_000_agent_result.4f7ead5805075276.6d54be4df4d8f8b0.24830dacb43b19a4.4f7ead5805075276.json",
            "board-interface LLM blocker: board-interface selector did not choose a Vivado cell object ID",
            "board-interface LLM blocker: selector wrapper_source_id is not in the sample simulation closure",
            "board-interface LLM blocker: selector relevant_sample_source_ids are empty, unknown, or omit the wrapper",
            "board-interface LLM blocker: selector proposed replacement sources are empty or outside its sample evidence set",
            "LLM wrapper_source_id is not in the Vivado simulation closure",
            "LLM wrapper_top_module is missing",
            "compute_slot_abi.selected_cell_id is not a Vivado cell fact",
            "timing and AXI contracts cannot be validated without a selected Vivado cell",
            "selected compute slot does not expose profile-required 512-bit AXI data"
          ],
      ...
      "tool_report_path": "/home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_interface/board_source_identity.json",
    ...
    },
    {
      ...
      "repair_hint": "inspect violated constraint and rerun the related checker",
      "status": "fail",
      "summary": "required real-tool evidence missing or failed: case_board_interface_discovery=fail; dependency_blocked=['case_multilayer_pipeline=not_run', 'case_axi_ddr_interface=not_run', 'case_vcs_functional_sim=not_run', 'case_vcs_evidence_analyzer=not_run', 'case_deadlock_axi_check=not_run', 'case_multilayer_functional=not_run', 'case_pipeline_deadlock_check=not_run', 'case_axi_protocol_check=not_run', 'case_ddr_image_roundtrip=not_run', 'case_board_semantic_evidence=not_run', 'functional_sim: blocked by prerequisite gate [case_vcs_functional_sim=not_run]']"
    },
    {
    ...
    },
    {
      ...
      "repair_hint": "inspect violated constraint and rerun the related checker",
      "status": "fail",
      "summary": "verification.design_team: immutable LLM artifact history manifest collision: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/llm/history/verification_targeted_specialist_agent_result.d88ba8339389aee8.6fdc723eb2db36a0.bf04fc34c94ce8c7.snapshot.json; verification.design_team: status is unavailable"
    },
    {
      ...
      "repair_hint": "inspect violated constraint and rerun the related checker",
      "status": "fail",
      "summary": "verification.evidence_classifier: needs_repair: Fail-closed: Stage7 board_axi_ddr_closure is not approved and cannot promote to backend synthesis, implementation, bitstream, runtime ABI release, or board runtime. The only currently executed third-layer real-tool failure in this result is case_board_interface_discovery (return code 1): its selector worker was not bound to its semantic checkpoint chunk, so no cited Vivado cell, valid wrapper source in the recursive simulation closure, or profile-compatible 512-bit AXI compute slot was established. The aggregate functional_sim failure is dependency-unsatisfied, not board RTL evidence: VCS, its evidence analyzer, and AXI/deadlock tools are not_run. board_tb.sv is additionally absent. Five scoped contamination barriers and two scoped retry requests remain active; no current content-addressed passing board candidate exists. Certified operator-leaf and connected single-layer evidence remains reusable because there is no current hash-bound trace contradicting a named lower-layer invariant."
    }
  ],
  ...
  "pending_evidence": [
    {
      ...
      "reused_existing_result": false,
      "status": "not_run",
      "summary": "skipped because dependency gate(s) are not pass: ['case_board_interface_discovery'] report_status=fail blockers=DUT binding does not cover every transformer-block weight in every target layer; hash-verified multi-layer pipeline harness is missing; failed checks: multilayer_real_weight_binding, multilayer_harness_sources",
      "tool_report_blockers": [
        "DUT binding does not cover every transformer-block weight in every target layer",
        "hash-verified multi-layer pipeline harness is missing",
        "failed checks: multilayer_real_weight_binding, multilayer_harness_sources"
    ...
    },
    {
      ...
      "reused_existing_result": false,
      "status": "not_run",
      "summary": "skipped because dependency gate(s) are not pass: ['case_multilayer_pipeline', 'case_board_interface_discovery', 'case_axi_ddr_interface']",
      "tool_report_blockers": [],
    ...
    },
    {
      ...
      "reused_existing_result": false,
      "status": "not_run",
      "summary": "skipped because dependency gate(s) are not pass: ['case_multilayer_pipeline', 'case_board_interface_discovery', 'case_axi_ddr_interface'] report_status=needs_repair blockers=intra_layer_spatial_pipeline_violation: all 16 input tokens completed by cycle 20805737 while the ready kernel output accepted zero beats",
      "tool_report_blockers": [
        "intra_layer_spatial_pipeline_violation: all 16 input tokens completed by cycle 20805737 while the ready kernel output accepted zero beats"
      ],
    ...
    },
    {
      ...
      "reused_existing_result": false,
      "status": "not_run",
      "summary": "skipped because dependency gate(s) are not pass: ['functional_sim', 'case_axi_ddr_interface', 'case_board_interface_discovery']",
      "tool_report_blockers": [],
      "tool_report_path": null,
      "tool_report_status": null,
      "tool_report_summary": null
    ...
    },
    {
      ...
      "reused_existing_result": false,
      "status": "not_run",
      "summary": "skipped because dependency gate(s) are not pass: ['functional_sim', 'case_multilayer_functional', 'case_pipeline_deadlock_check', 'case_axi_protocol_check', 'case_ddr_image_roundtrip', 'case_board_interface_discovery']",
      "tool_report_blockers": [],
      "tool_report_path": null,
      "tool_report_status": null,
      "tool_report_summary": null
  ...
  "repair_actions": [
    {
      ...
      "failure_signature": {
        ...
        "summaries": [
          "returncode=1 report_status=fail blockers=board-interface LLM agent did not return real structured interpretation: board-interface selector LLM failed: selector map worker is not bound to its semantic checkpoint chunk: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_interface/llm/history/exact_board_interface_selector_map_000_agent_result.4f7ead5805075276.6d54be4df4d8f8b0.24830dacb43b19a4.4f7ead5805075276.json; board-interface selector status is not ready/pass: blocked; board-interface selector blocker: selector map worker is not bound to its semantic checkpoint chunk: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_interface/llm/history/exact_board_interface_selector_map_000_agent_result.4f7ead5805075276.6d54be4df4d8f8b0.24830dacb43b19a4.4f7ead5805075276.json; board-interface selector did not choose a Vivado cell object ID; selector wrapper_source_id is not in the sample simulation closure; selector relevant_sample_source_ids are empty, unknown, or omit the wrapper; selector proposed replacement sources are empty or outside its sample evidence set; board-interface LLM status is not ready/pass: blocked; board-interface LLM blocker: board-interface selector LLM failed: selector map worker is not bound to its semantic checkpoint chunk: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_interface/llm/history/exact_board_interface_selector_map_000_agent_result.4f7ead5805075276.6d54be4df4d8f8b0.24830dacb43b19a4.4f7ead5805075276.json; board-interface LLM blocker: board-interface selector status is not ready/pass: blocked",
          "real functional simulation preconditions failed: board_testbench_artifact_loading files missing: ['/home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_simulation/board_tb.sv']; dependency_blocked=['case_multilayer_pipeline will be produced and judged by the current Stage7 tool scope', 'case_multilayer_functional will be produced and judged by the current Stage7 tool scope', 'case_axi_ddr_interface will be produced and judged by the current Stage7 tool scope', 'case_axi_protocol_check will be produced and judged by the current Stage7 tool scope', 'case_ddr_image_roundtrip will be produced and judged by the current Stage7 tool scope']",
          "required real-tool evidence missing or failed: case_board_interface_discovery=fail; dependency_blocked=['case_multilayer_pipeline=not_run', 'case_axi_ddr_interface=not_run', 'case_vcs_functional_sim=not_run', 'case_vcs_evidence_analyzer=not_run', 'case_deadlock_axi_check=not_run', 'case_multilayer_functional=not_run', 'case_pipeline_deadlock_check=not_run', 'case_axi_protocol_check=not_run', 'case_ddr_image_roundtrip=not_run', 'case_board_semantic_evidence=not_run', 'functional_sim: blocked by prerequisite gate [case_vcs_functional_sim=not_run]']",
          "real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json",
          "multilayer_pipeline_functional: case_multilayer_pipeline=not_run, functional_sim=fail, case_multilayer_functional=not_run, case_pipeline_deadlock_check=not_run; axi_ddr_functional: case_board_interface_discovery=fail, case_axi_ddr_interface=not_run, functional_sim=fail, case_axi_protocol_check=not_run, case_ddr_image_roundtrip=not_run, case_board_semantic_evidence=not_run; real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json",
          "verification.design_team: immutable LLM artifact history manifest collision: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/llm/history/verification_targeted_specialist_agent_result.d88ba8339389aee8.6fdc723eb2db36a0.bf04fc34c94ce8c7.snapshot.json; verification.design_team: status is unavailable",
          "verification.evidence_classifier: needs_repair: Fail-closed: Stage7 board_axi_ddr_closure is not approved and cannot promote to backend synthesis, implementation, bitstream, runtime ABI release, or board runtime. The only currently executed third-layer real-tool failure in this result is case_board_interface_discovery (return code 1): its selector worker was not bound to its semantic checkpoint chunk, so no cited Vivado cell, valid wrapper source in the recursive simulation closure, or profile-compatible 512-bit AXI compute slot was established. The aggregate functional_sim failure is dependency-unsatisfied, not board RTL evidence: VCS, its evidence analyzer, and AXI/deadlock tools are not_run. board_tb.sv is additionally absent. Five scoped contamination barriers and two scoped retry requests remain active; no current content-addressed passing board candidate exists. Certified operator-leaf and connected single-layer evidence remains reusable because there is no current hash-bound trace contradicting a named lower-layer invariant."
        ]
      },
      "minimal_repair_context": {
        "failed_current_layer_gates": [
...
<sacg_memory>
{
  "active_contamination_barriers": [
    {
      ...
      "last_observed_at": "2026-07-24T08:46:03+00:00",
      "observation_count": 5,
    ...
    },
    {
      ...
      "observation_count": 1,
      "observed_source_fingerprint_sha256s": [
        "0aed650e6ea793b8743e91e892861b0bc0acdfe6f7fc571764fac1f6dd7d7fad"
      ],
      "observed_transition_ids": [
        "transition.0233"
      ],
      "policy": "Downstream stages must treat artifacts from rejected transitions as planning/debug evidence only, not validated design inputs.",
      "reason": "one or more framework static checks failed",
      "source_fingerprint_sha256": "0aed650e6ea793b8743e91e892861b0bc0acdfe6f7fc571764fac1f6dd7d7fad",
      "status": "active",
      "timestamp": "2026-07-24T16:57:12+00:00",
  ...
  "recent_failure_lessons": [
    ...
    },
    {
      ...
      "failure_class": "verification_real_tool_or_gate",
      "id": "failure_lesson.0137",
      "recommended_action": "Use contract-guided debug closure first: localize the failing transaction to a boundary/root-candidate slice, then let Stage8 repair only that causal slice or backtrack to Stage6 if gate/tool contracts are incomplete.",
      "retry_scope": "stage7_or_stage6_backtrack",
      "stage": "stage7.verification",
      "summary": "real_tool.case_multilayer_pipeline: returncode=1 report_status=fail blockers=DUT binding does not cover every transformer-block weight in every target layer; hash-verified multi-layer pipeline harness is missing; failed checks: multilayer_real_weight_binding, multilayer_harness_sources; case_functional_sim_precondition_check: real functional simulation preconditions failed: board_testbench_artifact_loading files missing: ['/home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_simulation/board_tb.sv']; dependency_blocked=['case_multilayer_pipeline will be produced and judged by the current Stage7 tool scope', 'case_multilayer_functional will be produced and judged by the current Stage7 tool scope', 'case_axi_ddr_interface will be produced and judged by the current Stage7 tool scope', 'case_axi_protocol_check will be produced and judged by the current Stage7 tool scope', 'case_ddr_image_roundtrip will be produced and judged by the current Stage7 tool scope']; required_real_tool_evidence_check: required real-tool evidence missing or failed: case_multilayer_pipeline=fail; dependency_blocked=['case_axi_ddr_interface=not_run', 'case_vcs_functional_sim=not_run', 'case_vcs_evidence_analyzer=not_run', 'case_deadlock_axi_check=not_run', 'case_multilayer_functional=not_run', 'case_pipeline_deadlock_check=not_run', 'case_axi_protocol_check=not_run', 'case_ddr_image_roundtrip=not_run', 'case_board_semantic_evidence=not_run', 'functional_sim: blocked by prerequisite gate [case_vcs_functional_sim=not_run]']; real_weight_semantic_evidence_check: real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; hierarchical_verification_maturity_check: multilayer_pipeline_functional: case_multilayer_pipeline=fail, functional_sim=fail, case_multilayer_functional=not_run, case_pipeline_deadlock_check=not_run; axi_ddr_functional: case_axi_ddr_interface=not_run, functional_sim=fail, case_axi_protocol_check=not_run, case_ddr_image_roundtrip=not_run, case_board_semantic_evidence=not_run; real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; verification_agent_decision_check: verification.evidence_classifier: needs_repair: Stage7 board_axi_ddr_closure is not approved and cannot promote to synthesis, implementation, bitstream, runtime ABI release, or board runtime. The authoritative earliest executed current-scope failure is case_multilayer_pipeline: its real tool returned 1 because complete all-target-Transformer-block tensor-to-loader-to-DUT binding coverage and a hash-verified multilayer harness source closure are absent. The aggregate functional_sim failure is an unsatisfied composite gate, not executed VCS hardware evidence: case_vcs_functional_sim, its analyzer, and the deadlock/AXI analysis tool are all dependency-skipped behind case_multilayer_pipeline and case_axi_ddr_interface. board_tb.sv is additionally missing as a downstream functional-simulation precondition. The conditional specialist correctly classifies the capability/integration failure and rejects lower-layer backtrack; however, SACG truth supersedes its statement that no active memory blockers exist: contamination_barrier.0329-.0331 and retry_request.0136 remain active scoped downstream-consumption blockers until a complete current-scope passing, content-addressed promotion candidate exists. No current trace contradicts certified leaf or connected-kernel evidence.",
      "timestamp": "2026-07-24T07:49:28+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.functional_scope"
      ]
    },
    {
      ...
      "failure_class": "verification_real_tool_or_gate",
      "id": "failure_lesson.0138",
      "recommended_action": "Use contract-guided debug closure first: localize the failing transaction to a boundary/root-candidate slice, then let Stage8 repair only that causal slice or backtrack to Stage6 if gate/tool contracts are incomplete.",
      "retry_scope": "stage7_or_stage6_backtrack",
      "stage": "stage7.verification",
      "summary": "real_tool.case_multilayer_pipeline: returncode=1 report_status=fail blockers=DUT binding does not cover every transformer-block weight in every target layer; hash-verified multi-layer pipeline harness is missing; failed checks: multilayer_real_weight_binding, multilayer_harness_sources; case_functional_sim_precondition_check: real functional simulation preconditions failed: board_testbench_artifact_loading files missing: ['/home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_simulation/board_tb.sv']; dependency_blocked=['case_multilayer_pipeline will be produced and judged by the current Stage7 tool scope', 'case_multilayer_functional will be produced and judged by the current Stage7 tool scope', 'case_axi_ddr_interface will be produced and judged by the current Stage7 tool scope', 'case_axi_protocol_check will be produced and judged by the current Stage7 tool scope', 'case_ddr_image_roundtrip will be produced and judged by the current Stage7 tool scope']; required_real_tool_evidence_check: required real-tool evidence missing or failed: case_multilayer_pipeline=fail; dependency_blocked=['case_axi_ddr_interface=not_run', 'case_vcs_functional_sim=not_run', 'case_vcs_evidence_analyzer=not_run', 'case_deadlock_axi_check=not_run', 'case_multilayer_functional=not_run', 'case_pipeline_deadlock_check=not_run', 'case_axi_protocol_check=not_run', 'case_ddr_image_roundtrip=not_run', 'case_board_semantic_evidence=not_run', 'functional_sim: blocked by prerequisite gate [case_vcs_functional_sim=not_run]']; real_weight_semantic_evidence_check: real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; hierarchical_verification_maturity_check: multilayer_pipeline_functional: case_multilayer_pipeline=fail, functional_sim=fail, case_multilayer_functional=not_run, case_pipeline_deadlock_check=not_run; axi_ddr_functional: case_axi_ddr_interface=not_run, functional_sim=fail, case_axi_protocol_check=not_run, case_ddr_image_roundtrip=not_run, case_board_semantic_evidence=not_run; real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; verification_agent_decision_check: verification.evidence_classifier: needs_repair: Stage7 board_axi_ddr_closure is not approved and cannot promote to backend synthesis, implementation, bitstream, runtime ABI release, or board runtime. The authoritative earliest executed current-scope failure is real_tool.case_multilayer_pipeline (return code 1): complete all-target-Transformer-block tensor-to-loader-to-DUT binding coverage and a hash-verified multi-layer harness source closure are absent. board_tb.sv is also absent as a downstream functional-simulation precondition. The aggregate functional_sim failure is dependency-blocked, not executed VCS hardware evidence: VCS, its evidence analyzer, and AXI/deadlock diagnostics are not_run behind case_multilayer_pipeline and case_axi_ddr_interface. The conditional specialist review is consistent with this evidence-based, fail-closed classification, but does not replace the failed real-tool result. Certified operator-leaf and connected single-layer evidence remains reusable because no current board-layer trace contradicts a named lower-layer invariant. Six active scoped contamination barriers and two open scoped retry requests remain downstream-consumption blockers until a complete content-addressed passing board-scope candidate is produced and reconciled.",
      "timestamp": "2026-07-24T08:10:48+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.functional_scope"
      ]
    },
    {
      ...
      "failure_class": "verification_real_tool_or_gate",
      "id": "failure_lesson.0139",
      "recommended_action": "Use contract-guided debug closure first: localize the failing transaction to a boundary/root-candidate slice, then let Stage8 repair only that causal slice or backtrack to Stage6 if gate/tool contracts are incomplete.",
      "retry_scope": "stage7_or_stage6_backtrack",
      "stage": "stage7.verification",
      "summary": "real_tool.case_multilayer_pipeline: returncode=1 report_status=fail blockers=DUT binding does not cover every transformer-block weight in every target layer; hash-verified multi-layer pipeline harness is missing; failed checks: multilayer_real_weight_binding, multilayer_harness_sources; case_functional_sim_precondition_check: real functional simulation preconditions failed: board_testbench_artifact_loading files missing: ['/home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_simulation/board_tb.sv']; dependency_blocked=['case_multilayer_pipeline will be produced and judged by the current Stage7 tool scope', 'case_multilayer_functional will be produced and judged by the current Stage7 tool scope', 'case_axi_ddr_interface will be produced and judged by the current Stage7 tool scope', 'case_axi_protocol_check will be produced and judged by the current Stage7 tool scope', 'case_ddr_image_roundtrip will be produced and judged by the current Stage7 tool scope']; required_real_tool_evidence_check: required real-tool evidence missing or failed: case_multilayer_pipeline=fail; dependency_blocked=['case_axi_ddr_interface=not_run', 'case_vcs_functional_sim=not_run', 'case_vcs_evidence_analyzer=not_run', 'case_deadlock_axi_check=not_run', 'case_multilayer_functional=not_run', 'case_pipeline_deadlock_check=not_run', 'case_axi_protocol_check=not_run', 'case_ddr_image_roundtrip=not_run', 'case_board_semantic_evidence=not_run', 'functional_sim: blocked by prerequisite gate [case_vcs_functional_sim=not_run]']; real_weight_semantic_evidence_check: real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; hierarchical_verification_maturity_check: multilayer_pipeline_functional: case_multilayer_pipeline=fail, functional_sim=fail, case_multilayer_functional=not_run, case_pipeline_deadlock_check=not_run; axi_ddr_functional: case_axi_ddr_interface=not_run, functional_sim=fail, case_axi_protocol_check=not_run, case_ddr_image_roundtrip=not_run, case_board_semantic_evidence=not_run; real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; verification_agent_decision_check: verification.evidence_classifier: needs_repair: Stage7 board_axi_ddr_closure is not approved and cannot promote to backend synthesis, implementation, bitstream, runtime-ABI release, or board runtime. The authoritative earliest executed current-scope failure is real_tool.case_multilayer_pipeline (return code 1): it reports absent complete all-target-Transformer-block tensor-to-loader-to-DUT binding coverage and a missing hash-verified multilayer harness source closure. board_tb.sv is additionally absent as a downstream board-simulation precondition. functional_sim is an unsatisfied aggregate gate, not executed VCS hardware evidence: case_vcs_functional_sim, its evidence analyzer, and AXI/deadlock analysis were dependency-skipped behind case_multilayer_pipeline and case_axi_ddr_interface. The conditional specialist review is consistent with, but cannot replace, this fail-closed tool-evidence decision. Certified leaf and connected single-layer evidence remains reusable because no current trace directly contradicts a named lower-layer invariant. The nine active same-scope contamination barriers and three open same-scope retry requests remain downstream-consumption blockers; retry reconciliation is not ready without a complete content-addressed passing board-scope candidate.",
      "timestamp": "2026-07-24T08:27:17+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.functional_scope"
      ]
    },
    {
      ...
      "failure_class": "verification_real_tool_or_gate",
      "id": "failure_lesson.0140",
      "recommended_action": "Use contract-guided debug closure first: localize the failing transaction to a boundary/root-candidate slice, then let Stage8 repair only that causal slice or backtrack to Stage6 if gate/tool contracts are incomplete.",
      "retry_scope": "stage7_or_stage6_backtrack",
      "source_fingerprint_sha256": "ce9d39b08da7ed063e6fe2fda9ee1ec968b4b52961dc64270046e1753b0064b1",
      "stage": "stage7.verification",
      "summary": "real_tool.case_multilayer_pipeline: returncode=1 report_status=fail blockers=DUT binding does not cover every transformer-block weight in every target layer; hash-verified multi-layer pipeline harness is missing; failed checks: multilayer_real_weight_binding, multilayer_harness_sources; case_functional_sim_precondition_check: real functional simulation preconditions failed: board_testbench_artifact_loading files missing: ['/home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_simulation/board_tb.sv']; dependency_blocked=['case_multilayer_pipeline will be produced and judged by the current Stage7 tool scope', 'case_multilayer_functional will be produced and judged by the current Stage7 tool scope', 'case_axi_ddr_interface will be produced and judged by the current Stage7 tool scope', 'case_axi_protocol_check will be produced and judged by the current Stage7 tool scope', 'case_ddr_image_roundtrip will be produced and judged by the current Stage7 tool scope']; required_real_tool_evidence_check: required real-tool evidence missing or failed: case_multilayer_pipeline=fail; dependency_blocked=['case_axi_ddr_interface=not_run', 'case_vcs_functional_sim=not_run', 'case_vcs_evidence_analyzer=not_run', 'case_deadlock_axi_check=not_run', 'case_multilayer_functional=not_run', 'case_pipeline_deadlock_check=not_run', 'case_axi_protocol_check=not_run', 'case_ddr_image_roundtrip=not_run', 'case_board_semantic_evidence=not_run', 'functional_sim: blocked by prerequisite gate [case_vcs_functional_sim=not_run]']; real_weight_semantic_evidence_check: real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; hierarchical_verification_maturity_check: multilayer_pipeline_functional: case_multilayer_pipeline=fail, functional_sim=fail, case_multilayer_functional=not_run, case_pipeline_deadlock_check=not_run; axi_ddr_functional: case_axi_ddr_interface=not_run, functional_sim=fail, case_axi_protocol_check=not_run, case_ddr_image_roundtrip=not_run, case_board_semantic_evidence=not_run; real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; verification_agent_decision_check: verification.evidence_classifier: needs_repair: Stage7 board_axi_ddr_closure is fail-closed and cannot promote to backend synthesis, implementation, bitstream, runtime-ABI release, or board runtime. The authoritative earliest executed current-scope failure is real_tool.case_multilayer_pipeline (return code 1), which reports missing complete all-target-layer Transformer-block tensor-to-loader-to-DUT binding coverage and a missing hash-verified multilayer harness source closure. board_tb.sv is also absent as a functional-simulation precondition. functional_sim is a dependency-unsatisfied aggregate status, not executed board RTL evidence: VCS, its evidence analyzer, and deadlock/AXI diagnostics are all not_run behind case_multilayer_pipeline and case_axi_ddr_interface. The conditional specialist review is consistent with, but cannot replace, the failed real-tool evidence. Certified operator-leaf and elastic connected single-layer evidence remains reusable because no current hash-bound board trace contradicts a named lower-layer invariant. Active contamination_barrier.0329-.0331 and retry_request.0136 remain scoped downstream-consumption blockers until a complete passing content-addressed board-scope candidate is produced and reconciled.",
      "timestamp": "2026-07-24T08:46:03+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.functional_scope"
      ]
    ...
    },
    {
      ...
      "failure_class": "verification_real_tool_or_gate",
      "id": "failure_lesson.0142",
      "recommended_action": "Use contract-guided debug closure first: localize the failing transaction to a boundary/root-candidate slice, then let Stage8 repair only that causal slice or backtrack to Stage6 if gate/tool contracts are incomplete.",
      "retry_scope": "stage7_or_stage6_backtrack",
      "source_fingerprint_sha256": "0aed650e6ea793b8743e91e892861b0bc0acdfe6f7fc571764fac1f6dd7d7fad",
      "stage": "stage7.verification",
      "summary": "real_tool.case_board_interface_discovery: returncode=1 report_status=fail blockers=board-interface LLM agent did not return real structured interpretation: board-interface selector LLM failed: selector map worker is not bound to its semantic checkpoint chunk: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_interface/llm/history/exact_board_interface_selector_map_000_agent_result.4f7ead5805075276.6d54be4df4d8f8b0.24830dacb43b19a4.4f7ead5805075276.json; board-interface selector status is not ready/pass: blocked; board-interface selector blocker: selector map worker is not bound to its semantic checkpoint chunk: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_interface/llm/history/exact_board_interface_selector_map_000_agent_result.4f7ead5805075276.6d54be4df4d8f8b0.24830dacb43b19a4.4f7ead5805075276.json; board-interface selector did not choose a Vivado cell object ID; selector wrapper_source_id is not in the sample simulation closure; selector relevant_sample_source_ids are empty, unknown, or omit the wrapper; selector proposed replacement sources are empty or outside its sample evidence set; board-interface LLM status is not ready/pass: blocked; board-interface LLM blocker: board-interface selector LLM failed: selector map worker is not bound to its semantic checkpoint chunk: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_interface/llm/history/exact_board_interface_selector_map_000_agent_result.4f7ead5805075276.6d54be4df4d8f8b0.24830dacb43b19a4.4f7ead5805075276.json; board-interface LLM blocker: board-interface selector status is not ready/pass: blocked; case_functional_sim_precondition_check: real functional simulation preconditions failed: board_testbench_artifact_loading files missing: ['/home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_simulation/board_tb.sv']; dependency_blocked=['case_multilayer_pipeline will be produced and judged by the current Stage7 tool scope', 'case_multilayer_functional will be produced and judged by the current Stage7 tool scope', 'case_axi_ddr_interface will be produced and judged by the current Stage7 tool scope', 'case_axi_protocol_check will be produced and judged by the current Stage7 tool scope', 'case_ddr_image_roundtrip will be produced and judged by the current Stage7 tool scope']; required_real_tool_evidence_check: required real-tool evidence missing or failed: case_board_interface_discovery=fail; dependency_blocked=['case_multilayer_pipeline=not_run', 'case_axi_ddr_interface=not_run', 'case_vcs_functional_sim=not_run', 'case_vcs_evidence_analyzer=not_run', 'case_deadlock_axi_check=not_run', 'case_multilayer_functional=not_run', 'case_pipeline_deadlock_check=not_run', 'case_axi_protocol_check=not_run', 'case_ddr_image_roundtrip=not_run', 'case_board_semantic_evidence=not_run', 'functional_sim: blocked by prerequisite gate [case_vcs_functional_sim=not_run]']; real_weight_semantic_evidence_check: real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; hierarchical_verification_maturity_check: multilayer_pipeline_functional: case_multilayer_pipeline=not_run, functional_sim=fail, case_multilayer_functional=not_run, case_pipeline_deadlock_check=not_run; axi_ddr_functional: case_board_interface_discovery=fail, case_axi_ddr_interface=not_run, functional_sim=fail, case_axi_protocol_check=not_run, case_ddr_image_roundtrip=not_run, case_board_semantic_evidence=not_run; real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; verification_team_llm_check: verification.design_team: immutable LLM artifact history manifest collision: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/llm/history/verification_targeted_specialist_agent_result.d88ba8339389aee8.6fdc723eb2db36a0.bf04fc34c94ce8c7.snapshot.json; verification.design_team: status is unavailable; verification_agent_decision_check: verification.evidence_classifier: needs_repair: Fail-closed: Stage7 board_axi_ddr_closure is not approved and cannot promote to backend synthesis, implementation, bitstream, runtime ABI release, or board runtime. The only currently executed third-layer real-tool failure in this result is case_board_interface_discovery (return code 1): its selector worker was not bound to its semantic checkpoint chunk, so no cited Vivado cell, valid wrapper source in the recursive simulation closure, or profile-compatible 512-bit AXI compute slot was established. The aggregate functional_sim failure is dependency-unsatisfied, not board RTL evidence: VCS, its evidence analyzer, and AXI/deadlock tools are not_run. board_tb.sv is additionally absent. Five scoped contamination barriers and two scoped retry requests remain active; no current content-addressed passing board candidate exists. Certified operator-leaf and connected single-layer evidence remains reusable because there is no current hash-bound trace contradicting a named lower-layer invariant.",
      "timestamp": "2026-07-24T16:57:12+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.functional_scope"
  ...
  "recent_stage_outcomes": [
    ...
    },
    {
      ...
      "errors": [
        ...
        "real_weight_semantic_evidence_check: real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json",
        "hierarchical_verification_maturity_check: multilayer_pipeline_functional: case_multilayer_pipeline=not_run, functional_sim=fail, case_multilayer_functional=not_run, case_pipeline_deadlock_check=not_run; axi_ddr_functional: case_board_interface_discovery=fail, case_axi_ddr_interface=not_run, functional_sim=fail, case_axi_protocol_check=not_run, case_ddr_image_roundtrip=not_run, case_board_semantic_evidence=not_run; real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json",
        "verification_team_llm_check: verification.design_team: immutable LLM artifact history manifest collision: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/llm/history/verification_targeted_specialist_agent_result.d88ba8339389aee8.6fdc723eb2db36a0.bf04fc34c94ce8c7.snapshot.json; verification.design_team: status is unavailable",
        "verification_agent_decision_check: verification.evidence_classifier: needs_repair: Fail-closed: Stage7 board_axi_ddr_closure is not approved and cannot promote to backend synthesis, implementation, bitstream, runtime ABI release, or board runtime. The only currently executed third-layer real-tool failure in this result is case_board_interface_discovery (return code 1): its selector worker was not bound to its semantic checkpoint chunk, so no cited Vivado cell, valid wrapper source in the recursive simulation closure, or profile-compatible 512-bit AXI compute slot was established. The aggregate functional_sim failure is dependency-unsatisfied, not board RTL evidence: VCS, its evidence analyzer, and AXI/deadlock tools are not_run. board_tb.sv is additionally absent. Five scoped contamination barriers and two scoped retry requests remain active; no current content-addressed passing board candidate exists. Certified operator-leaf and connected single-layer evidence remains reusable because there is no current hash-bound trace contradicting a named lower-layer invariant."
      ],
      "failed_gates": [
        "case_board_interface_discovery",
...
<sacg_memory_truth>
{
  "active_contamination_barrier_count": 8,
  "active_contamination_barriers": [
    {
      "artifact_id": "artifact.stage7.verification_result",
      "debug_layer": "board_axi_ddr_wrapped_system",
  ...
  "global_persisted_blocker_counts": {
    "active_contamination_barriers": 11,
    "open_backtrack_requests": 1,
    "open_retry_requests": 3
  },
...
<agent_status_bar>
{
  ...
  "source_sacg_state": {
    ...
    "sha256": "afd97fa1cfe5a0181dcc9a839a0e735fa6a50f5a166fda0c7735699d4c16a733"
  },
