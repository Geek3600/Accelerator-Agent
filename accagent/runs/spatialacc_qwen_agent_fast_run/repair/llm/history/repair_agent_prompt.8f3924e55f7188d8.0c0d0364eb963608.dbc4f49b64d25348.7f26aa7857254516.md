...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "The earliest real-tool failure is an execution-environment failure: remote stage pruning timed out before VCS launch, producing compile return code 125, remote_state=not_run, and simulation status=not_run.",
        "The analyzer marks source_semantic_repair_eligible=false and provides no simulator terminal log, source path, line, declaration context, validated hierarchy-report provenance, or source-attributed compile/elaboration diagnostic. No board RTL, protocol monitor, or testbench edit is causally authorized.",
        "The reported \"elaborated hierarchy report is invalid\" cannot be distinguished from stale or absent hierarchy metadata, compile-authority/report-schema failure, exact-wrapper identity binding failure, or remote cleanup failure using the supplied evidence. An unchanged-source VCS replay is not authorized by the current patch feedback."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "44e644982a3ff2e6ed316f16942cc009e12b86d14137e00c173f7d11e706a044",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "4ee9d621036ac6dd40286ba607c18b1d68e0a66b50d760f7eefb5ab3b7a7b4d8",
          ...
          "required_capabilities": [
            {
              ...
              "rationale": "This capability is read-only and must establish whether the hierarchy-report error originated before VCS launch or is attributable to a source/compile binding. The supplied run proves only remote cleanup/pruning failure before compilation; it cannot justify any semantic source replacement or an unchanged-source replay.",
              "required_evidence": [
                "A read-only provenance record for the remote-stage-prune timeout, including the remote stage path, prune candidate classification, active/unacknowledged counts, and the reason the prune operation exceeded its wall-clock limit.",
                "The actual VCS compile and elaboration launch receipt or a definitive record that launch did not occur, with ordered source list, compile authority references, tool executable identity, working directory, and exact command status.",
                "If VCS launched, the first source-attributed diagnostic with source path, line, declaration context, and the corresponding compile/elaboration log excerpt.",
                "A schema-valid hierarchy-report provenance result that identifies whether reports/hierarchy_report.json was absent, stale, malformed, identity-mismatched, or generated by the current elaborated source closure."
              ],
              "target_modules": [
          ...
          "sha256": "a2f63785feb2ecc7771ebfa51e4c8aecd4ce8957bced031b5f382192d2873737",
      ...
      "report": {
        ...
        "sha256": "659cd6094518a04405e1d4545164707a5ef7b657fb4e248bd118eb3ef2fd2148"
      },
      "required_capabilities": [
        {
          "capability_id": "vcs_compile_diagnostic_source_provenance",
  ...
  "repair_actions": [
    {
      ...
      "debug_layer": "board_axi_ddr_wrapped_system",
      "reason": "This capability is read-only and must establish whether the hierarchy-report error originated before VCS launch or is attributable to a source/compile binding. The supplied run proves only remote cleanup/pruning failure before compilation; it cannot justify any semantic source replacement or an unchanged-source replay.",
      ...
      "source_feedback_fingerprint_sha256": "44e644982a3ff2e6ed316f16942cc009e12b86d14137e00c173f7d11e706a044",
      "target_modules": [
        "spatialacc_exact_board_multilayer_tb",
        "app_shell_9p_cnn_core_0_1",
        "spatialacc_axi4_protocol_monitor"
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-04T11:07:48+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-04T11:10:12+00:00",
