...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "The current failure is classified as vcs_execution_environment_failure with remote VCS state not_run, remote cleanup return code 125, no simulator terminal log, and source_semantic_repair_eligible=false; no causal board RTL or testbench replacement is authorized.",
        "The elaborated hierarchy report invalid error has no source path, line, declaration context, compile-order context, or validated report-schema diagnostic. The supplied source bundle cannot determine whether the failure is stale hierarchy metadata, compile-plan authority, exact-wrapper identity binding, or remote cleanup without guessing.",
        "The current patch feedback states that an unchanged-source real-tool replay is not required. Do not repeat the prior blocked intervention or alter the certified wrapper, kernel, monitor, DUT, golden artifacts, or numeric policy."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "d3039f6aa2082629a0fd724e0f41e6906ea318541a4e7f9cdff9f4b9d19c808a",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "564987f1b01d728b999fa2c853598e5b01ca62cb58e7f98bfc92e2042f263711",
          ...
          "required_capabilities": [
            {
              ...
              "rationale": "Provide preserved real-board VCS provenance and authority-binding diagnostics before any source repair. The current evidence proves an external or unattributed pre-runtime failure, not a semantic violation in the supplied board sources; a source edit would be speculative and could bypass the exact wrapper and compile-authority barriers.",
              "required_evidence": [
                "/current_board_vcs_feedback/diagnosis/value/failure_evidence/first_real_error",
                "/current_board_vcs_feedback/diagnosis/value/failure_evidence/compile/status",
                "/current_board_vcs_feedback/diagnosis/value/failure_evidence/compile/returncode",
                "/current_board_vcs_feedback/diagnosis/value/failure_evidence/compile/failure_class",
                "/current_board_vcs_feedback/diagnosis/value/failure_evidence/compile/remote_state",
                "/current_board_vcs_feedback/diagnosis/value/failure_evidence/termination_provenance/simulator_terminal_log/status",
                "/current_board_vcs_feedback/diagnosis/value/failure_evidence/termination_provenance/raw_terminal_log_tail",
                "Exact elaborated-hierarchy report validator error with report path and schema/context",
                "Canonical VCS compile source set and ordered compile-plan authority bindings",
                "Exact sample-project wrapper identity and current source-hash binding",
                "Current Vivado export context and authorized simulator executable/tool-profile facts",
                "Remote runner cleanup log identifying why the VCS stage was not launched"
              ],
              "target_modules": [
                "spatialacc_exact_board_multilayer_tb",
                "app_shell_9p_cnn_core_0_1",
                "spatialacc_axi_protocol_monitor"
              ]
            }
          ],
          "scope": "verification_capability_repair",
          "sha256": "3fe8360914a7187e40d9b586c21f60e3abc312d4ec881da27f2725887e3d0959",
      ...
      "report": {
        ...
        "sha256": "642cf3d20c643336516453779510e34efd15adcb2f774433494f76a38ff1e36e"
      },
      "required_capabilities": [
        {
          "capability_id": "vcs_compile_diagnostic_source_provenance",
  ...
  "pending_evidence": [
    ...
    },
    {
      ...
      "produced_reports": [
        {
          "blockers": [
            "vcs_execution_environment_failure: elaborated hierarchy report is invalid"
          ],
          ...
          "status": "needs_repair",
          "summary": "vcs_execution_environment_failure: elaborated hierarchy report is invalid"
        },
        {
          "blockers": [],
          "path": "/home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/debug_closure/boundary_trace.json",
      ...
      "reused_existing_result": false,
      "status": "not_run",
      "summary": "skipped because dependency gate(s) are not pass: ['case_axi_ddr_interface'] report_status=needs_repair blockers=vcs_execution_environment_failure: elaborated hierarchy report is invalid",
      "tool_report_blockers": [
        "vcs_execution_environment_failure: elaborated hierarchy report is invalid"
      ],
      ...
      "tool_report_summary": "vcs_execution_environment_failure: elaborated hierarchy report is invalid"
    },
    {
      "acceptance_role": "diagnostic_or_static_tool",
  ...
  "repair_actions": [
    {
      ...
      "debug_layer": "board_axi_ddr_wrapped_system",
      "reason": "Provide preserved real-board VCS provenance and authority-binding diagnostics before any source repair. The current evidence proves an external or unattributed pre-runtime failure, not a semantic violation in the supplied board sources; a source edit would be speculative and could bypass the exact wrapper and compile-authority barriers.",
      ...
      "source_feedback_fingerprint_sha256": "d3039f6aa2082629a0fd724e0f41e6906ea318541a4e7f9cdff9f4b9d19c808a",
      "target_modules": [
        "spatialacc_exact_board_multilayer_tb",
        "app_shell_9p_cnn_core_0_1",
        "spatialacc_axi_protocol_monitor"
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-02T13:51:17+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-04T07:14:13+00:00",
