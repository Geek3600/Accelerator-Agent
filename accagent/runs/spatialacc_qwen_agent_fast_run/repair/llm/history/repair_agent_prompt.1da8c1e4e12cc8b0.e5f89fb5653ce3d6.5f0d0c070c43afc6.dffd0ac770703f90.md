...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "The exact hash-bound board VCS run compiled successfully and then terminated with a VCS SIGSEGV before a terminal event or any checker-facing dynamic report was produced. The missing pipeline-overlap, runtime-loader, and AXI reports are consequential missing artifacts, not independently repairable report-schema failures.",
        "The available VCS terminal stack identifies neither an HDL source location nor the active simulation process/event at termination. The supplied progress trace shows ingress and stage-0 activity with no core egress, but does not establish a completed current-layer causal boundary or a named contradiction of the certified connected-kernel invariant. Therefore no DUT, adapter, or testbench semantic edit is justified.",
        "Changing the testbench's read-only VCD, JSONL, or report logic based only on a possible association with the VCS crash would be speculative and could conceal the unclassified termination rather than localize it."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "21e2cfd2a02430a3cd8c33a07ec34b68ba780bbf64ac8341afdce49b9da740d5",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "3140c093cff1cbd9e552e166950e8b6015df8e109479f6c4bb494678afc0a35a",
          ...
          "required_capabilities": [
            {
              "capability_id": "remote_vcs_termination_provenance",
              "debug_layer": "board_axi_ddr_wrapped_system",
              "producer_scope": "remote VCS runner and evidence analyzer",
              "rationale": "The current real VCS run is an unclassified pre-terminal SIGSEGV. Its raw stack and missing reports cannot distinguish a VCS/runtime failure from a deterministic source event, so the earliest causal repair cannot be selected safely. This capability supplies the required distinction before any bounded source replacement or lower-layer backtrack decision.",
              "required_evidence": [
                "A fresh exact-source replay record bound to replay fingerprint ccf9e66bd4292780fe5c2e5ab3e6e51f0d8ff9bd92c7f901babc214085bd46f0 or its successor closure.",
                "Untruncated simulator causal context identifying either runner/simulator ownership or the last executing HDL source location, process, and event before SIGSEGV.",
                "The final committed progress-event record and any active testbench observation process at termination, including whether VCD dumping or file-I/O callbacks were active.",
                "A classification that distinguishes simulator infrastructure termination from deterministic HDL/testbench termination without altering immutable artifacts, numeric policy, source identity, or checker schemas."
              ],
              "target_modules": [
                "remote_vcs_runner",
                "case_vcs_evidence_analyzer",
          ...
          "sha256": "cda1177648b4ea58b57151a207c9f2a95e5ff85bf62830684a6b74f77ec5cf62",
      ...
      "report": {
        ...
        "sha256": "30da4a6e05a9760db1b8ed9658ce4fa38a7e2e2f96fade61ab62b8118a67fd2d"
      },
      "required_capabilities": [
        {
          "capability_id": "remote_vcs_termination_provenance",
  ...
  "failures": [
    {
      ...
      "execution_fingerprint_sha256": "5e5f308d11469b57cf498d0e0efe3173d724e1b28bee51802cdf38e96acc916a",
    ...
    },
    {
      ...
      "repair_hint": "inspect violated constraint and rerun the related checker",
      "status": "fail",
      "summary": "verification.evidence_classifier: needs_repair: Fail-closed Stage7 decision: board_axi_ddr_closure is not promotable to Vivado synthesis or implementation, bitstream generation, runtime-ABI release, or board runtime. The direct current failure is real_tool.case_axi_ddr_interface: board-simulation source identity, Vivado-export compile authority, ordered-command authority references, and simulator executable authorization do not bind the discovered exact sample-project identity. functional_sim is failed only by dependency closure because VCS was not run; therefore there is no board-level value, numeric, ordering, AXI, DDR, liveness, weight-consumption, or output-frontier evidence and no justified RTL root candidate. Certified operator-leaf and connected single-layer evidence remains reusable because no current hash-bound trace contradicts a named lower-layer invariant. The conditional design-team route was no_split and cannot replace deterministic tool evidence."
    }
  ],
  ...
  "pending_evidence": [
    ...
    },
    {
      ...
      "produced_reports": [
        {
          "blockers": [
            "vcs_runtime_unclassified_exit: pipeline overlap report is invalid"
          ],
          ...
          "status": "needs_repair",
          "summary": "vcs_runtime_unclassified_exit: pipeline overlap report is invalid"
        },
        {
          "blockers": [],
          "path": "/home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/debug_closure/boundary_trace.json",
      ...
      "reused_existing_result": false,
      "status": "not_run",
      "summary": "skipped because dependency gate(s) are not pass: ['case_axi_ddr_interface'] report_status=needs_repair blockers=vcs_runtime_unclassified_exit: pipeline overlap report is invalid",
      "tool_report_blockers": [
        "vcs_runtime_unclassified_exit: pipeline overlap report is invalid"
      ],
      ...
      "tool_report_summary": "vcs_runtime_unclassified_exit: pipeline overlap report is invalid"
    },
    {
      "acceptance_role": "diagnostic_or_static_tool",
  ...
  "repair_actions": [
    {
      ...
      "failure_signature": {
        ...
        "summaries": [
          ...
          "verification.evidence_classifier: needs_repair: Fail-closed Stage7 decision: board_axi_ddr_closure is not promotable to Vivado synthesis or implementation, bitstream generation, runtime-ABI release, or board runtime. The direct current failure is real_tool.case_axi_ddr_interface: board-simulation source identity, Vivado-export compile authority, ordered-command authority references, and simulator executable authorization do not bind the discovered exact sample-project identity. functional_sim is failed only by dependency closure because VCS was not run; therefore there is no board-level value, numeric, ordering, AXI, DDR, liveness, weight-consumption, or output-frontier evidence and no justified RTL root candidate. Certified operator-leaf and connected single-layer evidence remains reusable because no current hash-bound trace contradicts a named lower-layer invariant. The conditional design-team route was no_split and cannot replace deterministic tool evidence."
        ]
      },
      "minimal_repair_context": {
        "failed_current_layer_gates": [
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-29T05:05:44+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-29T05:00:04+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-29T05:01:18+00:00",
  ...
  "recent_failure_lessons": [
    ...
    },
    {
      ...
      "stage": "stage7.verification",
      "summary": "real_tool.case_axi_ddr_interface: returncode=1 report_status=fail blockers=simulation.source_identity_sha256 does not bind the current identity document; simulation.vcs_compile_plan.compile_authority does not bind the identity's exact Vivado export facts; simulation.vcs_compile_plan.ordered_commands[0].authority_refs do not bind exact Vivado export contexts; simulation.vcs_compile_plan.ordered_commands[0].executable is not authorized by current tool_profile or referenced Vivado export; required_real_tool_evidence_check: required real-tool evidence missing or failed: case_axi_ddr_interface=fail; dependency_blocked=['case_vcs_functional_sim=not_run', 'case_vcs_evidence_analyzer=not_run', 'case_deadlock_axi_check=not_run', 'case_multilayer_functional=not_run', 'case_pipeline_deadlock_check=not_run', 'case_axi_protocol_check=not_run', 'case_ddr_image_roundtrip=not_run', 'case_board_semantic_evidence=not_run', 'functional_sim: blocked by prerequisite gate [case_vcs_functional_sim=not_run]']; real_weight_semantic_evidence_check: real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; hierarchical_verification_maturity_check: multilayer_pipeline_functional: functional_sim=fail, case_multilayer_functional=not_run, case_pipeline_deadlock_check=not_run; axi_ddr_functional: case_axi_ddr_interface=fail, functional_sim=fail, case_axi_protocol_check=not_run, case_ddr_image_roundtrip=not_run, case_board_semantic_evidence=not_run; real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; verification_agent_decision_check: verification.evidence_classifier: needs_repair: Fail-closed Stage7 decision: board_axi_ddr_closure is not promotable to Vivado synthesis or implementation, bitstream generation, runtime-ABI release, or board runtime. The direct current failure is real_tool.case_axi_ddr_interface: board-simulation source identity, Vivado-export compile authority, ordered-command authority references, and simulator executable authorization do not bind the discovered exact sample-project identity. functional_sim is failed only by dependency closure because VCS was not run; therefore there is no board-level value, numeric, ordering, AXI, DDR, liveness, weight-consumption, or output-frontier evidence and no justified RTL root candidate. Certified operator-leaf and connected single-layer evidence remains reusable because no current hash-bound trace contradicts a named lower-layer invariant. The conditional design-team route was no_split and cannot replace deterministic tool evidence.",
      "timestamp": "2026-07-29T05:05:44+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.functional_scope"
      ]
