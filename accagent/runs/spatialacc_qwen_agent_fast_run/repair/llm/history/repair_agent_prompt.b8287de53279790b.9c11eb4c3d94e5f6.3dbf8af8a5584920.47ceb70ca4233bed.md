...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "The VCS compile passed, but the runtime ended with return code 1 before a terminal event and before write_execution_reports could create pipeline_overlap_report.json, runtime_loader_report.json, or axi_protocol_report.json. The analyzer's \"pipeline overlap report is invalid\" is therefore a missing-artifact cascade, not evidence of a report-schema or pipeline semantic defect.",
        "The live trace proves the adapter accepted input before the single lifecycle start, completed the runtime load, and reached certified-kernel stage-0 activity. It does not identify a violated board-adapter contract or contradict a named certified connected-kernel invariant; no RTL or scheduler replacement is evidence-supported.",
        "The supplied runner result classifies the stop only as remote_tool_failure and omits the simulator terminal/fatal message, remote process signal, and runner timeout/kill record. Without that distinction, changing board sources would risk treating an external execution truncation as a DUT liveness failure."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "16c9492b43de5ccb0c2604ec4161a55ba9d3652ebbd154699265405dfcf79a82",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "2aed37a509cc9260af98e37397dd542e92481ec74ef3289ccaf24b0e33a0dccd",
          ...
          "required_capabilities": [
            {
              ...
              "debug_layer": "board_axi_ddr_wrapped_system",
              "producer_scope": "framework.remote_vcs_runner",
              "rationale": "The current trace was still making semantic input-token progress 331 cycles before the recorded tail, while the testbench contains no fixed completion timeout. Capture termination provenance first, then replay the unchanged hash-bound board source closure and localize any actual terminal VCS failure from that run.",
              "required_evidence": [
                "Raw current VCS simulation log tail containing the terminal simulator message when present.",
                "Remote process exit code together with termination signal or runner timeout/kill classification.",
                "Configured wall-time and simulation-cycle budget for the current immutable source closure.",
                "A replay record proving normal terminal completion, simulator fatal, external kill, and runner timeout are distinguished without changing checkpoint, stimulus, weight image, golden output, layer count, or numeric policy."
              ],
              "target_modules": [
                "remote_vcs_runner",
                "case_vcs_evidence_analyzer"
          ...
          "sha256": "52722e54b355c028d92e5988ee370217321ba44770476a807250377fcf0c0cb3",
      ...
      "report": {
        ...
        "sha256": "00cf4113cca74f6137594a45ddfde00da4d26646026fce14f45f8466ac6ad3e7"
      },
      "required_capabilities": [
        {
          "capability_id": "remote_vcs_termination_disambiguation_and_replay_authorization",
  ...
  "failures": [
    {
      ...
      "execution_fingerprint_sha256": "cc8638fff3aafc440ef96d5e09443d60a46c17b2aa94e47fbb178c455992bda4",
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-28T15:35:39+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-28T15:29:46+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-28T15:31:17+00:00",
