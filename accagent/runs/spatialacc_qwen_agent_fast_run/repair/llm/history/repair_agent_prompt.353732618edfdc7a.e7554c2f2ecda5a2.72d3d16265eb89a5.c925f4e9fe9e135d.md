  ...
  "failures": [
    {
      ...
      "execution_fingerprint_sha256": "0831a8d887250d049bb0a778de222f98e996bf00a17be7eeb7acdff43710c921",
    ...
    },
    {
      ...
      "repair_hint": "inspect violated constraint and rerun the related checker",
      "status": "fail",
      "summary": "verification.evidence_classifier: needs_repair: Fail-closed authoritative Stage7 decision: board_axi_ddr_closure is not promotable. case_axi_ddr_interface failed because the exact board-simulation identity, Vivado-export compile authority, ordered command authority references, and simulator executable authorization are not bound; functional_sim and downstream board gates therefore lack real evidence. Repair and rebind the current exact board contract, rerun the current layer in DAG order, and do not reopen certified lower layers or proceed to backend without deterministic passing evidence."
    }
  ],
