...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "The current real VCS run proves a semantic stall at the connected_kernel_input_to_output frontier, with 1792 core-ingress beats accepted and zero core-egress beats accepted, but the termination provenance classifies the process exit as external_or_unattributed_termination, does not prove a deterministic HDL or testbench failure, and marks source semantic repair as ineligible.",
        "The supplied core-boundary observations establish the contradiction but do not hash-bind the earliest causal owner among adapter lifecycle ordering, certified-kernel internal progress, AXI/DDR interaction, or runner termination. The analyzer explicitly requires a direct causal core-boundary distinction before reopening or repairing the connected-kernel path.",
        "The current patch feedback rejects the prior adaptive observation transaction and states that an unchanged-source replay is not required or awaiting. Repeating that replay or returning the same observation plan would violate the repair-loop evidence policy.",
        "The dynamic evidence schema failures for records 4 and 5 are downstream of the nonterminal simulation and do not identify a uniquely owning generated emission in the supplied feedback; no safe schema edit can be selected without guessing or weakening the analyzer.",
        "The current repair disposition requires a diagnostically distinct remote VCS termination-provenance capture before authorizing adapter, monitor, loader, manifest, testbench, certified-kernel, or lower-layer changes."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "2d5983cf7a93db43ff554bfd838ac177fe64e3b608820ba431a3b23e7046633c",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "861244f099e2ddadb583786f389f8899e7ff3d3f11d60a5bddf99ec508f3e9bb",
          ...
          "required_capabilities": [
            {
              "capability_id": "repair.board_distinct_vcs_termination_provenance_capture",
              "debug_layer": "board_axi_ddr_wrapped_system",
              "producer_scope": "framework remote VCS runner, simulator-process observer, and evidence analyzer",
              "rationale": "Capture untruncated native termination, runner-process, final committed progress, and any valid boundary trace while preserving the immutable source closure, checkpoint, stimulus, target-model expected output, weight bindings, and frozen numeric policy. The result must distinguish a deterministic adapter/kernel boundary failure from framework termination before any generated board source is edited.",
              "required_evidence": [
                "/verification_capability_repair_package/current_board_vcs_feedback/value/runner_report/value/run/termination_provenance",
                ...
                "exact_sample_source_closure_sha256=6665a9df4e0b86fdbd47c48e76b63137069f4c2505d914d6ceee233447a1c5c5"
              ],
              "target_modules": [
                "vcs_simulate",
          ...
          "sha256": "874b9b199cec14c052cfce96dcbe07ed654dfdc5a28800df7cc0c18e256841e1",
      ...
      "report": {
        ...
        "sha256": "8ad8e78632b43f2f6cf1d8d33685e427acc0d9b9359655b958aeb153b124178a"
      },
      "required_capabilities": [
        {
          "capability_id": "repair.board_distinct_vcs_termination_provenance_capture",
  ...
  "failures": [
    {
      ...
      "execution_fingerprint_sha256": "9c8b7568b494e443929aaf09940f130b8af8ab8890bf3a8e1480ebe62fb19bae",
    ...
    },
    {
      ...
      "repair_hint": "inspect violated constraint and rerun the related checker",
      "status": "fail",
      "summary": "verification.evidence_classifier: needs_repair: Fail-closed authoritative Stage7 decision: board_axi_ddr_closure is not promotable. The executed case_axi_ddr_interface checker failed because the simulation source identity, exact Vivado-export compile authority, ordered-command authority references, and simulator executable authorization are not bound to the current sample-project identity. functional_sim was dependency-skipped, so it provides no board-level functional, numeric, order, AXI, DDR, liveness, weight-consumption, or output-frontier evidence. Lower operator-leaf and connected single-layer certificates remain reusable because no current hash-bound trace contradicts them. The conditional design-team review returned no_split and cannot replace deterministic evidence."
    }
  ],
  ...
  "repair_actions": [
    {
      ...
      "failure_signature": {
        ...
        "summaries": [
          ...
          "verification.evidence_classifier: needs_repair: Fail-closed authoritative Stage7 decision: board_axi_ddr_closure is not promotable. The executed case_axi_ddr_interface checker failed because the simulation source identity, exact Vivado-export compile authority, ordered-command authority references, and simulator executable authorization are not bound to the current sample-project identity. functional_sim was dependency-skipped, so it provides no board-level functional, numeric, order, AXI, DDR, liveness, weight-consumption, or output-frontier evidence. Lower operator-leaf and connected single-layer certificates remain reusable because no current hash-bound trace contradicts them. The conditional design-team review returned no_split and cannot replace deterministic evidence."
        ]
      },
      "minimal_repair_context": {
        "failed_current_layer_gates": [
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-08-02T16:24:16+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-31T11:19:10+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-08-02T16:12:41+00:00",
  ...
  "recent_failure_lessons": [
    ...
    },
    {
      ...
      "stage": "stage7.verification",
      "summary": "real_tool.case_axi_ddr_interface: returncode=1 report_status=fail blockers=simulation.source_identity_sha256 does not bind the current identity document; simulation.vcs_compile_plan.compile_authority does not bind the identity's exact Vivado export facts; simulation.vcs_compile_plan.ordered_commands[0].authority_refs do not bind exact Vivado export contexts; simulation.vcs_compile_plan.ordered_commands[0].executable is not authorized by current tool_profile or referenced Vivado export; required_real_tool_evidence_check: required real-tool evidence missing or failed: case_axi_ddr_interface=fail; dependency_blocked=['case_vcs_functional_sim=not_run', 'case_vcs_evidence_analyzer=not_run', 'case_deadlock_axi_check=not_run', 'case_multilayer_functional=not_run', 'case_pipeline_deadlock_check=not_run', 'case_axi_protocol_check=not_run', 'case_ddr_image_roundtrip=not_run', 'case_board_semantic_evidence=not_run', 'functional_sim: blocked by prerequisite gate [case_vcs_functional_sim=not_run]']; real_weight_semantic_evidence_check: real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; hierarchical_verification_maturity_check: multilayer_pipeline_functional: functional_sim=fail, case_multilayer_functional=not_run, case_pipeline_deadlock_check=not_run; axi_ddr_functional: case_axi_ddr_interface=fail, functional_sim=fail, case_axi_protocol_check=not_run, case_ddr_image_roundtrip=not_run, case_board_semantic_evidence=not_run; real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; verification_agent_decision_check: verification.evidence_classifier: needs_repair: Fail-closed authoritative Stage7 decision: board_axi_ddr_closure is not promotable. The executed case_axi_ddr_interface checker failed because the simulation source identity, exact Vivado-export compile authority, ordered-command authority references, and simulator executable authorization are not bound to the current sample-project identity. functional_sim was dependency-skipped, so it provides no board-level functional, numeric, order, AXI, DDR, liveness, weight-consumption, or output-frontier evidence. Lower operator-leaf and connected single-layer certificates remain reusable because no current hash-bound trace contradicts them. The conditional design-team review returned no_split and cannot replace deterministic evidence.",
      "timestamp": "2026-08-02T16:24:16+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.functional_scope"
      ]
