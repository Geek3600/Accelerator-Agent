  ...
  "failures": [
    {
      ...
      "execution_fingerprint_sha256": "ec123fa5d103bf6bfe50273b28c28e3b1734f1b5d28c7ba54c96fae248850098",
      ...
      "produced_reports": [
        {
          "blockers": [
            ...
            "board-interface LLM blocker: board-interface selector LLM failed: selector map checkpoint current prompt reconstruction mismatch: exact_board_interface_selector_map_000_agent",
            "board-interface LLM blocker: board-interface selector status is not ready/pass: blocked",
            "board-interface LLM blocker: board-interface selector blocker: selector map checkpoint current prompt reconstruction mismatch: exact_board_interface_selector_map_000_agent",
    ...
    },
    {
      ...
      "repair_hint": "inspect violated constraint and rerun the related checker",
      "status": "fail",
      "summary": "verification.evidence_classifier: needs_repair: Stage7 board_axi_ddr_closure is fail-closed and is not approved for backend synthesis, implementation, bitstream, runtime-ABI release, or board runtime. The authoritative earliest executed current-candidate failure is real_tool.case_board_interface_discovery: selector checkpoint/prompt reconstruction failed, so no fact-bound Vivado compute-slot cell, exact wrapper identity, recursive source-hash closure, timing contract, or required 512-bit AXI contract was established. The real VCS simulator, evidence analyzer, and AXI/deadlock tools were dependency-skipped; therefore the aggregate functional_sim failure is not evidence of an RTL value, order, protocol, liveness, or numeric defect. The conditional specialist review supports this classification but cannot replace real-tool pass evidence. Certified operator-leaf and connected single-layer evidence remains reusable because no current hash-bound trace contradicts a named lower-layer invariant."
    }
  ],
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "observation_count": 1,
      "observed_source_fingerprint_sha256s": [
        "4d791bea5c20c8240ecbb069c8a019872469d8375b95ae3fb183fa8ebfe51415"
      ],
      "observed_transition_ids": [
        "transition.0233"
      ],
      "policy": "Downstream stages must treat artifacts from rejected transitions as planning/debug evidence only, not validated design inputs.",
      "reason": "one or more framework static checks failed",
      "source_fingerprint_sha256": "4d791bea5c20c8240ecbb069c8a019872469d8375b95ae3fb183fa8ebfe51415",
      "status": "active",
      "timestamp": "2026-07-24T15:38:57+00:00",
...
<agent_status_bar>
{
  ...
  "source_sacg_state": {
    ...
    "sha256": "d7b8557be7e822014cec6965b4220a5ec9d2704ef6a984f2bedb0887286123ba"
  },
