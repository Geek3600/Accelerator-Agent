...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    "case_vcs_functional": {
      "applicability_binding": {
        ...
        "input_fingerprint_sha256": "5fc2376fd8a1e07b7755e58ac97cadbee0d18784b3927b0af5ccf742dd14e792",
        "origin_gates": [
          "case_vcs_functional_sim"
        ],
        ...
        "preflight_manifest_projection_sha256": "49f185755d5447c7876522604ccf046b62d8831bfbe58685eddb930840c7579e",
        ...
        "source_artifacts": [
          {
            ...
            "sha256": "26e7785613485b68deed454c426defbcb7dfcd71e18e678d3a0440dbc82f9c87"
          },
          {
            ...
            "sha256": "7033203e35fee79e0238defb2c10d0fed1669853b5756aa1f80b8601fca91852"
          },
          {
          ...
          },
          {
            ...
            "sha256": "42f742062f48a74d5347ba92876bbf652f925b12c92a68a9b7d986705411168b"
          },
          {
            ...
            "sha256": "cb48f0e9a29a15c1d2b1858e5f2fb6faaeb351c0f46af1730e9e35d302189255"
          },
          {
            ...
            "sha256": "de16c5a144137f3cad85b42237636f3956c7158fa1fbf015000d8a9087e4e571"
          }
        ],
      ...
      "debug_closure": {
        ...
        "boundary_trace_record_count": 58,
        "live_progress": {
      ...
      "failure_evidence": {
        ...
        "compile": {
          "duration_sec": 43.18291013799899,
        ...
        "sacg_cctg_causal_slice": {
          ...
          "value": {
            ...
            "remote_workdir": "/home/hyyuan/workspace/spatialaccagent_artifacts/board_vcs/spatialacc_qwen_agent_fast_run/5fc2376fd8a1_360729131526240662458183420544879049632984254330304096720185234",
        ...
        "termination_provenance": {
          ...
          "exact_source_replay_fingerprint_sha256": "5fc2376fd8a1e07b7755e58ac97cadbee0d18784b3927b0af5ccf742dd14e792",
          "exit_code": null,
      ...
      "repair_handoff": {
        ...
        "sacg_cctg_causal_frontier": {
          ...
          "artifact_sha256": "de16c5a144137f3cad85b42237636f3956c7158fa1fbf015000d8a9087e4e571",
      ...
      "semantic_comparison": {
        ...
        "status": "not_run",
        "testbench_sha256": "e0a4f08c7476e457cef1d2a831791da1540542d8408728c10c701e383e8cc484"
      },
      "sim_pass": false,
      "sources": [
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "The real VCS compile failed with Error-[XMRE], but the supplied runner report contains no compile-log source path, line number, lexical/hierarchical reference chain, declaration context, or ordered compile command/source list. The only supplied source candidates already each declare ACTIVATION_AXI_BEATS_PER_TOKEN locally, so a source edit would be speculative and could not be bounded to the causal unresolved reference.",
        "The reported simulation termination classification explicitly sets source_semantic_repair_eligible=false; no runtime SACG/CCTG trace exists because elaboration/compilation did not complete."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "db3c41714052cf4744a16848b1728eaa1a143e88559da0f726d2e858f8b47534",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "0e48179392919db27c680fa1137051742171df33bd9fa695736a53e420ff4294",
          ...
          "required_capabilities": [
            {
              ...
              "rationale": "The compile feedback proves only an XMRE class failure. Its terminal log is absent and its stderr contains locale warnings only. Although the repair disposition narrates an undeclared activation-beat symbol, the complete editable testbench and adapter both visibly contain local declarations with that name; without raw compiler provenance, neither a duplicate declaration nor a replacement binding is causally justified. This capability is read-only provenance collection and does not authorize an unchanged-source VCS replay or any DUT/sample-wrapper modification.",
              "required_evidence": [
                "The complete first VCS Error-[XMRE] diagnostic including absolute or repository-relative source path, line/column, and unresolved token.",
                "The diagnostic's hierarchical reference chain and originating module/instance context for ACTIVATION_AXI_BEATS_PER_TOKEN.",
                "The exact ordered VCS compile source list/command, including filelist expansion and macro/include options, sufficient to establish which declaration scopes were compiled before the failing reference."
              ],
              "target_modules": [
                "spatialacc_exact_board_multilayer_tb",
          ...
          "sha256": "35719369a1bd03acec356d680347fb36e13a7927730faec0823c9114085f469e",
      ...
      "report": {
        ...
        "sha256": "f11b941e1b243a3d829e8307dfe0f66b69177a5ba11d6797121781f87d28ce8a"
      },
      "required_capabilities": [
        {
          "capability_id": "vcs_compile_diagnostic_source_provenance",
  ...
  "pending_evidence": [
    ...
    },
    {
      ...
      "reused_existing_result": false,
      "status": "not_run",
      "summary": "skipped because dependency gate(s) are not pass: ['case_axi_ddr_interface'] report_status=needs_repair blockers=vcs_compile_failure: Error-[XMRE] Cross-module reference resolution error",
      "tool_report_blockers": [
        "vcs_compile_failure: Error-[XMRE] Cross-module reference resolution error"
      ],
      ...
      "tool_report_summary": "vcs_compile_failure: Error-[XMRE] Cross-module reference resolution error"
    },
    {
      "acceptance_role": "diagnostic_or_static_tool",
  ...
  "repair_actions": [
    {
      ...
      "debug_layer": "board_axi_ddr_wrapped_system",
      "reason": "The compile feedback proves only an XMRE class failure. Its terminal log is absent and its stderr contains locale warnings only. Although the repair disposition narrates an undeclared activation-beat symbol, the complete editable testbench and adapter both visibly contain local declarations with that name; without raw compiler provenance, neither a duplicate declaration nor a replacement binding is causally justified. This capability is read-only provenance collection and does not authorize an unchanged-source VCS replay or any DUT/sample-wrapper modification.",
      ...
      "source_feedback_fingerprint_sha256": "db3c41714052cf4744a16848b1728eaa1a143e88559da0f726d2e858f8b47534",
      "target_modules": [
        "spatialacc_exact_board_multilayer_tb",
        "app_shell_9p_cnn_core_0_1",
        "SingleLayerSemanticHarness"
...
<llm_policy>
{
  ...
  "requested_model_override": "gpt-5.6-sol",
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-05T04:03:55+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-05T11:27:02+00:00",
      "observation_count": 266,
      "observed_transition_ids": [
        "transition.2443",
        "transition.2444",
        "transition.2445",
