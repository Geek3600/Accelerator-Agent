...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "The current real VCS compile passed, but simulation terminated with runner-owned exit code 86 after an adaptive semantic stall; termination_provenance classifies termination as external_or_unattributed, proves no deterministic HDL or testbench failure, and marks source semantic repair ineligible.",
        "The observed frontier is connected_kernel_input_to_output: all 1792 current-layer ingress beats were accepted while zero core-egress beats were accepted, but the supplied evidence does not authorize reopening the certified connected kernel or applying an RTL repair.",
        "A diagnostically distinct termination-provenance capture is required before any semantic source edit or lower-layer reopening. The current exact-source replay fingerprint is efa502e21e5ff2b9e2fea91a8010c791bf1909fc4a117342212306e9623d3e96.",
        "Dynamic evidence records 4 and 5 are reported with invalid or missing event-schema fields, but the supplied editable sources do not contain the observed SPATIALACC_PIPELINE_TRACE emitter. Its owning source is unresolved; changing the supplied testbench schema emitters would be speculative and would not close the proven defect.",
        "The exact sample wrapper, certified kernel sources, checkpoint, stimulus, expected output, numeric policy, weights, manifests, checkers, and analyzer must remain unchanged. No hardware pass is claimed."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "bbb90e1425e1d8978e18574417211b62f4b0c9f616cf9a5dcfc0dfd1591bfa65",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "5e8f165c8e72948e55f0de81066022c5c47ef5c3b9eca76d5918868afb029128",
          ...
          "required_capabilities": [
            {
              "capability_id": "planned_tool.distinct_vcs_termination_provenance",
              "debug_layer": "board_axi_ddr_wrapped_system",
              "producer_scope": "remote VCS runner and current-board evidence analyzer",
              "rationale": "Implement the already-planned distinct provenance capability before rerunning the unchanged board layer. It must distinguish runner termination from deterministic DUT/testbench or AXI/DDR failure, preserve process and terminal evidence, and emit valid direct core-boundary evidence without weakening the analyzer or changing RTL.",
              "required_evidence": [
                "current exact-source replay fingerprint",
                "runner-owned process attribution and exit status",
                "raw terminal log tail and termination markers",
                "hash-bound direct core-boundary trace with kernel start, ingress, stage0, and egress fields",
                "immutable checkpoint and stimulus fingerprints"
              ],
              "target_modules": [
                "remote VCS runner",
                "simulation termination provenance capture",
                "case_vcs_evidence_analyzer"
              ]
            },
            {
              "capability_id": "dynamic_event_schema_owner_attribution",
              "debug_layer": "board_axi_ddr_wrapped_system",
              "producer_scope": "simulation evidence producer/source index",
              "rationale": "Do not patch the supplied testbench merely because records 4 and 5 lack schema fields. First identify the actual emitter and bind its source hash; only then can an owner-generated simulation-only schema repair be considered.",
              "required_evidence": [
                "source path and hash that emits SPATIALACC_PIPELINE_TRACE",
                "complete event-schema record for the two invalid dynamic records",
                "unchanged analyzer schema contract"
              ],
              "target_modules": [
                "SPATIALACC_PIPELINE_TRACE emitter",
                "generated-board-source ownership index",
                "dynamic_real_tool_evidence analyzer"
              ]
            }
          ],
          "scope": "verification_capability_repair",
          "sha256": "1ce9e83eef0bd4712125fde6a3a1c1c80a41ac072a34b69c712e1d252add7492",
      ...
      "report": {
        ...
        "sha256": "af83d087feaeb6f8fdb243735d0b2a184083a6355ab9de92cbeb197fcbc06501"
      },
      "required_capabilities": [
        {
          "capability_id": "planned_tool.distinct_vcs_termination_provenance",
  ...
  "failures": [
    {
      ...
      "execution_fingerprint_sha256": "481b5d8604ed92a86470086d496475242288c05467a26cb807c6a231f009b0fd",
      ...
      "produced_reports": [
        {
          "blockers": [
            "board-interface LLM agent did not return real structured interpretation: board-interface selector LLM failed: final selector added relevant sources absent from progressive LLM candidate evidence",
            "board-interface LLM status is not ready/pass: blocked",
            "board-interface LLM blocker: board-interface selector LLM failed: final selector added relevant sources absent from progressive LLM candidate evidence",
  ...
  "pending_evidence": [
    ...
    },
    {
      ...
      "reused_existing_result": false,
      "status": "not_run",
      "summary": "skipped because dependency gate(s) are not pass: ['case_multilayer_pipeline', 'case_board_interface_discovery', 'case_axi_ddr_interface'] report_status=needs_repair blockers=board_output_lifecycle_frontier_violation: the board trace completed current-layer ingress while the ready output frontier accepted zero beats; direct core-boundary contradiction evidence is still required before reopening the connected kernel",
      "tool_report_blockers": [
        "board_output_lifecycle_frontier_violation: the board trace completed current-layer ingress while the ready output frontier accepted zero beats; direct core-boundary contradiction evidence is still required before reopening the connected kernel"
      ],
...
<sacg_memory>
{
  "active_contamination_barriers": [
    {
      ...
      "last_observed_at": "2026-08-27T10:45:41+00:00",
      "observation_count": 2,
      ...
      "source_fingerprint_sha256": "efda18fd733bdb42026f8f508143b6cf03763d66ceddd826a75bb87fbd192357",
      "status": "active",
    ...
    },
    {
      ...
      "last_observed_at": "2026-08-20T06:48:17+00:00",
      ...
      "policy": "Downstream stages must treat artifacts from rejected transitions as planning/debug evidence only, not validated design inputs.",
      "reason": "one or more framework static checks failed",
      "source_fingerprint_sha256": "1fe929b448ef2f95a69599bb6dd45ee16d60ec4ba02b894f949c57fccbc62e18",
      "status": "active",
    ...
    },
    {
      ...
      "last_observed_at": "2026-08-20T07:52:54+00:00",
      "observation_count": 20,
      "observed_transition_ids": [
        "transition.2123",
        "transition.2129",
    ...
    },
    {
      ...
      "last_observed_at": "2026-08-27T09:14:13+00:00",
  ...
  "recent_failure_lessons": [
    ...
    },
    {
      ...
      "failure_class": "bounded_repair_required",
      "id": "failure_lesson.0191",
      "recommended_action": "Execute or approve the bounded repair workflow, then rerun Stage7. Do not continue to backend/board closure with unresolved verification failures.",
      "retry_scope": "repair_then_stage7_rerun",
      "stage": "stage8.repair",
      "summary": "real_tool.case_axi_ddr_interface: returncode=1 report_status=fail blockers=simulation.source_identity_sha256 does not bind the current identity document; simulation.vcs_compile_plan.compile_authority does not bind the identity's exact Vivado export facts; simulation.vcs_compile_plan.ordered_commands[0].authority_refs do not bind exact Vivado export contexts; simulation.vcs_compile_plan.ordered_commands[0].executable is not authorized by current tool_profile or referenced Vivado export; required_real_tool_evidence_check: required real-tool evidence missing or failed: case_axi_ddr_interface=fail; dependency_blocked=['case_vcs_functional_sim=not_run', 'case_vcs_evidence_analyzer=not_run', 'case_deadlock_axi_check=not_run', 'case_multilayer_functional=not_run', 'case_pipeline_deadlock_check=not_run', 'case_axi_protocol_check=not_run', 'case_ddr_image_roundtrip=not_run', 'case_board_semantic_evidence=not_run', 'functional_sim: blocked by prerequisite gate [case_vcs_functional_sim=not_run]']; real_weight_semantic_evidence_check: real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; hierarchical_verification_maturity_check: multilayer_pipeline_functional: functional_sim=fail, case_multilayer_functional=not_run, case_pipeline_deadlock_check=not_run; axi_ddr_functional: case_axi_ddr_interface=fail, functional_sim=fail, case_axi_protocol_check=not_run, case_ddr_image_roundtrip=not_run, case_board_semantic_evidence=not_run; real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; verification_agent_decision_check: verification.evidence_classifier: needs_repair: Fail-closed Stage7 decision: board_axi_ddr_closure is not promotable to synthesis, implementation, bitstream generation, runtime-ABI release, or board runtime. The direct executed failure is case_axi_ddr_interface: the board-simulation source-identity hash, exact-Vivado-export compile authority, ordered-command authority references, and simulator executable authorization do not bind the discovered exact sample-project identity. functional_sim is dependency-blocked because VCS was not run; therefore no board-level value, numeric, order, AXI, DDR, liveness, weight-consumption, or output-frontier claim exists. Repair and rerun only the current board-integration verification contract before executing the remaining Stage7 DAG.",
      "timestamp": "2026-07-31T11:19:10+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.plan",
        "constraint.tool.protocols",
    ...
    },
    {
      ...
      "failure_class": "verification_real_tool_or_gate",
      "id": "failure_lesson.0192",
      "recommended_action": "Use contract-guided debug closure first: localize the failing transaction to a boundary/root-candidate slice, then let Stage8 repair only that causal slice or backtrack to Stage6 if gate/tool contracts are incomplete.",
      "retry_scope": "stage7_or_stage6_backtrack",
      "source_fingerprint_sha256": "1fe929b448ef2f95a69599bb6dd45ee16d60ec4ba02b894f949c57fccbc62e18",
      "stage": "stage7.verification",
      "summary": "real_tool.case_axi_ddr_interface: returncode=1 report_status=fail blockers=simulation.source_identity_sha256 does not bind the current identity document; simulation.vcs_compile_plan.compile_authority does not bind the identity's exact Vivado export facts; simulation.vcs_compile_plan.ordered_commands[0].authority_refs do not bind exact Vivado export contexts; simulation.vcs_compile_plan.ordered_commands[0].executable is not authorized by current tool_profile or referenced Vivado export; required_real_tool_evidence_check: required real-tool evidence missing or failed: case_axi_ddr_interface=fail; dependency_blocked=['case_vcs_functional_sim=not_run', 'case_vcs_evidence_analyzer=not_run', 'case_deadlock_axi_check=not_run', 'case_multilayer_functional=not_run', 'case_pipeline_deadlock_check=not_run', 'case_axi_protocol_check=not_run', 'case_ddr_image_roundtrip=not_run', 'case_board_semantic_evidence=not_run', 'functional_sim: blocked by prerequisite gate [case_vcs_functional_sim=not_run]']; real_weight_semantic_evidence_check: real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; hierarchical_verification_maturity_check: multilayer_pipeline_functional: functional_sim=fail, case_multilayer_functional=not_run, case_pipeline_deadlock_check=not_run; axi_ddr_functional: case_axi_ddr_interface=fail, functional_sim=fail, case_axi_protocol_check=not_run, case_ddr_image_roundtrip=not_run, case_board_semantic_evidence=not_run; real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; verification_agent_decision_check: verification.evidence_classifier: needs_repair: Fail-closed authoritative Stage7 decision: board_axi_ddr_closure is not promotable. case_axi_ddr_interface failed because the exact board-simulation identity, Vivado-export compile authority, ordered command authority references, and simulator executable authorization are not bound; functional_sim and downstream board gates therefore lack real evidence. Repair and rebind the current exact board contract, rerun the current layer in DAG order, and do not reopen certified lower layers or proceed to backend without deterministic passing evidence.",
      "timestamp": "2026-08-20T06:48:17+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.functional_scope"
      ]
    },
    {
      ...
      "failure_class": "bounded_repair_required",
      "id": "failure_lesson.0193",
      "recommended_action": "Execute or approve the bounded repair workflow, then rerun Stage7. Do not continue to backend/board closure with unresolved verification failures.",
      "retry_scope": "repair_then_stage7_rerun",
      "stage": "stage8.repair",
      "summary": "real_tool.case_axi_ddr_interface: returncode=1 report_status=fail blockers=simulation.source_identity_sha256 does not bind the current identity document; simulation.vcs_compile_plan.compile_authority does not bind the identity's exact Vivado export facts; simulation.vcs_compile_plan.ordered_commands[0].authority_refs do not bind exact Vivado export contexts; simulation.vcs_compile_plan.ordered_commands[0].executable is not authorized by current tool_profile or referenced Vivado export; required_real_tool_evidence_check: required real-tool evidence missing or failed: case_axi_ddr_interface=fail; dependency_blocked=['case_vcs_functional_sim=not_run', 'case_vcs_evidence_analyzer=not_run', 'case_deadlock_axi_check=not_run', 'case_multilayer_functional=not_run', 'case_pipeline_deadlock_check=not_run', 'case_axi_protocol_check=not_run', 'case_ddr_image_roundtrip=not_run', 'case_board_semantic_evidence=not_run', 'functional_sim: blocked by prerequisite gate [case_vcs_functional_sim=not_run]']; real_weight_semantic_evidence_check: real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; hierarchical_verification_maturity_check: multilayer_pipeline_functional: functional_sim=fail, case_multilayer_functional=not_run, case_pipeline_deadlock_check=not_run; axi_ddr_functional: case_axi_ddr_interface=fail, functional_sim=fail, case_axi_protocol_check=not_run, case_ddr_image_roundtrip=not_run, case_board_semantic_evidence=not_run; real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; verification_agent_decision_check: verification.evidence_classifier: needs_repair: Fail-closed authoritative Stage7 decision: board_axi_ddr_closure is not promotable. case_axi_ddr_interface failed because the exact board-simulation identity, Vivado-export compile authority, ordered command authority references, and simulator executable authorization are not bound; functional_sim and downstream board gates therefore lack real evidence. Repair and rebind the current exact board contract, rerun the current layer in DAG order, and do not reopen certified lower layers or proceed to backend without deterministic passing evidence.",
      "timestamp": "2026-08-20T07:52:54+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.plan",
        "constraint.tool.protocols",
    ...
    },
    {
      ...
      "timestamp": "2026-08-27T10:45:41+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.functional_scope"
      ]
