...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    "case_vcs_functional": {
      "applicability_binding": {
        ...
        "diagnosed_failure_class": "vcs_elaboration_failure",
        "input_fingerprint_sha256": "5d66eeaacf99615a943d29534c5098e4bac8b0d6aa75330afb6926111523d13f",
        "origin_gates": [
          "case_vcs_functional_sim"
        ],
        ...
        "source_artifacts": [
          {
            ...
            "sha256": "6a5e987ba9e3d24efbd9dc3597fd68998e14f1bf01f3ce233bde7ce88191f637"
          },
          {
          ...
          },
          {
            ...
            "sha256": "18cfa5242c05578f8361f6ada375b1e9832362dd0df36b962b48de6ed0e4728e"
          },
          {
            ...
            "sha256": "ac494814cee1e7e33bffc3eecf49d68b441a32c513b98e095978b32b2a5e8fd9"
          }
        ],
      ...
      "blockers": [
        "vcs_elaboration_failure: elaborated hierarchy report is invalid"
      ],
      ...
      "failure_evidence": {
        ...
        "repair_scope": "board_binding_or_generated_rtl",
        ...
        "sacg_cctg_causal_slice": {
          ...
          "value": {
            ...
            "remote_workdir": "/home/hyyuan/workspace/spatialaccagent_artifacts/board_vcs/spatialacc_qwen_agent_fast_run/5d66eeaacf99_156441564256848539474334129647809101084333354940592230387405119",
        ...
        "termination_provenance": {
          ...
          "exact_source_replay_fingerprint_sha256": "5d66eeaacf99615a943d29534c5098e4bac8b0d6aa75330afb6926111523d13f",
          "exit_code": null,
      ...
      "repair_handoff": {
        ...
        "sacg_cctg_causal_frontier": {
          ...
          "artifact_sha256": "ac494814cee1e7e33bffc3eecf49d68b441a32c513b98e095978b32b2a5e8fd9",
      ...
      "root_cause_class": "vcs_elaboration_failure",
      "run_dir": "/home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run",
      "runner_phase": "remote_vcs",
      ...
      "status": "needs_repair",
      "summary": "vcs_elaboration_failure: elaborated hierarchy report is invalid"
    },
    ...
    "contract_guided_debug_closure": {
      ...
      "failing_transaction": {
        ...
        "summary": "returncode=1 report_status=fail blockers=DUT binding does not cover every transformer-block weight in every target layer; failed checks: multilayer_real_weight_binding"
      },
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "Missing real VCS source path and line for the invalid elaborated hierarchy report.",
        "Missing the declaration context associated with the elaboration error.",
        "Missing the authoritative compile-order record needed to determine which source declaration was used.",
        "The current termination record sets source_semantic_repair_eligible=false; do not modify RTL or the exact board testbench without the missing provenance."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "59e69c19ad48d82fd5535ff68f86c37555c19d5e3d2db8b6306cc3ab728d497c",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "374052ba63cbba07e9b62d49a08355fc5d3ce4996effbfb4dcdac7c1aba97263",
          ...
          "required_capabilities": [
            {
              ...
              "rationale": "Provide the missing real-tool provenance before any source edit or VCS replay. This capability reads preserved compile artifacts and does not authorize a simplified wrapper, a DUT replacement, or a semantic repair.",
              "required_evidence": [
                "The first real VCS error with a concrete source path and line.",
                "The surrounding declaration context for that source location.",
                "The authoritative compile order and resolved source list.",
                "The preserved elaboration and compile logs showing whether the report failure is a tool or source failure."
              ],
              "target_modules": [
          ...
          "sha256": "a0ed69895cf70abe37581ed0784090fe3d85c942e2b380f1427f8ccdb40a374e",
          "stage": "repair_execution",
          "status": "blocked",
          "step_id": "repair_step.00",
          "summary": "Exact-board preflight passed, but real VCS stopped before simulation because the elaborated hierarchy report was invalid. The supplied evidence does not identify a source path and line, declaration context, or compile order, and it marks source semantic repair as ineligible. No board source edit is justified."
        }
      ],
      ...
      "report": {
        ...
        "sha256": "ad295ce73029048e75f13685281410ed87b547cb82c1f9f5de2955fdfe377026"
      },
      "required_capabilities": [
        {
          "capability_id": "vcs_compile_diagnostic_source_provenance",
  ...
  "failures": [
    {
      ...
      "execution_fingerprint_sha256": "0a64d89f4ae2572c086869549fe69db37f392acfe6cf4412c056e9a48a028806",
      ...
      "produced_reports": [
        {
          "blockers": [
            ...
            "failed checks: multilayer_real_weight_binding"
          ],
    ...
    },
    {
      ...
      "repair_hint": "inspect violated constraint and rerun the related checker",
      "status": "fail",
      "summary": "verification.evidence_classifier: needs_repair: Fail-closed authoritative Stage7 decision: board_axi_ddr_closure is not promotable to backend synthesis, implementation, bitstream generation, runtime-ABI release, or board runtime. The current decisive executed failure is real_tool.case_multilayer_pipeline (returncode=1): DUT binding does not cover every Transformer-block weight in every target layer. case_axi_ddr_interface and the board VCS/analyzer/deadlock tools were dependency-skipped, so no board-level functional, numeric, ordering, AXI, DDR, liveness, lifecycle-frontier, output, or full-scope DUT-weight-consumption pass exists. The issue is presently a multilayer semantic-coverage/loader-binding verification-capability gap, not evidence of an RTL-core failure. Reuse the hash-validated operator-leaf and connected single-layer certificates; no current trace contradicts their named invariants. The conditional review returned no_split and cannot replace missing deterministic evidence."
    }
  ],
  ...
  "pending_evidence": [
    ...
    },
    {
      ...
      "reused_existing_result": false,
      "status": "not_run",
      "summary": "skipped because dependency gate(s) are not pass: ['case_multilayer_pipeline', 'case_axi_ddr_interface'] report_status=needs_repair blockers=vcs_elaboration_failure: elaborated hierarchy report is invalid",
      "tool_report_blockers": [
        "vcs_elaboration_failure: elaborated hierarchy report is invalid"
      ],
      ...
      "tool_report_summary": "vcs_elaboration_failure: elaborated hierarchy report is invalid"
    },
    {
      "acceptance_role": "diagnostic_or_static_tool",
  ...
  "repair_actions": [
    {
      ...
      "debug_layer": "board_axi_ddr_wrapped_system",
      "reason": "Provide the missing real-tool provenance before any source edit or VCS replay. This capability reads preserved compile artifacts and does not authorize a simplified wrapper, a DUT replacement, or a semantic repair.",
      ...
      "source_feedback_fingerprint_sha256": "59e69c19ad48d82fd5535ff68f86c37555c19d5e3d2db8b6306cc3ab728d497c",
      "target_modules": [
        "app_shell_9p_cnn_core_0_1",
        "spatialacc_exact_board_multilayer_tb",
        "spatialacc_axi4_protocol_monitor",
...
<sacg_memory>
{
  ...
  "open_retry_requests": [
    {
      ...
      "last_observed_at": "2026-09-09T10:46:29+00:00",
      "observation_count": 9,
      "observed_source_fingerprint_sha256s": [
      ...
      "source_fingerprint_sha256": "3013ac2f2886a4bb0e21b0ddcc54c82cffbbdd09e2328421291a438ce8b90e02",
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-09T10:48:27+00:00",
      "observation_count": 9,
  ...
  "recent_failure_lessons": [
    ...
    },
    {
      ...
      "failure_class": "bounded_repair_required",
      "id": "failure_lesson.0223",
      "recommended_action": "Execute or approve the bounded repair workflow, then rerun Stage7. Do not continue to backend/board closure with unresolved verification failures.",
      "retry_scope": "repair_then_stage7_rerun",
      "stage": "stage8.repair",
      "summary": "real_tool.case_axi_ddr_interface: returncode=1 report_status=fail blockers=simulation.source_identity_sha256 does not bind the current identity document; simulation.vcs_compile_plan.compile_authority does not bind the identity's exact Vivado export facts; simulation.vcs_compile_plan.ordered_commands[0].authority_refs do not bind exact Vivado export contexts; simulation.vcs_compile_plan.ordered_commands[0].executable is not authorized by current tool_profile or referenced Vivado export; required_real_tool_evidence_check: required real-tool evidence missing or failed: case_axi_ddr_interface=fail; dependency_blocked=['case_vcs_functional_sim=not_run', 'case_vcs_evidence_analyzer=not_run', 'case_deadlock_axi_check=not_run', 'case_multilayer_functional=not_run', 'case_pipeline_deadlock_check=not_run', 'case_axi_protocol_check=not_run', 'case_ddr_image_roundtrip=not_run', 'case_board_semantic_evidence=not_run', 'functional_sim: blocked by prerequisite gate [case_vcs_functional_sim=not_run]']; real_weight_semantic_evidence_check: real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; hierarchical_verification_maturity_check: multilayer_pipeline_functional: functional_sim=fail, case_multilayer_functional=not_run, case_pipeline_deadlock_check=not_run; axi_ddr_functional: case_axi_ddr_interface=fail, functional_sim=fail, case_axi_protocol_check=not_run, case_ddr_image_roundtrip=not_run, case_board_semantic_evidence=not_run; real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; verification_agent_decision_check: verification.evidence_classifier: needs_repair: Fail-closed authoritative Stage7 decision: board_axi_ddr_closure is not promotable to backend synthesis, implementation, bitstream generation, runtime-ABI release, or board runtime. The earliest executed current-layer failure is real_tool.case_axi_ddr_interface: the board simulation manifest does not bind the current exact board identity, its compile authority and ordered-command authority references do not bind the exact Vivado export facts, and its simulator executables are not authorized by the current tool profile or cited export. The real board-wrapped VCS simulation was dependency-skipped, so there is no board-level functional, numeric, data-order, AXI, DDR, liveness, complete-weight-consumption, lifecycle-frontier, or output evidence. Current operator-leaf and connected single-layer certificates remain reusable because no current hash-bound trace contradicts a named lower-layer invariant. The conditional design-team router returned no_split; role consensus or the absence of a specialist review cannot replace missing deterministic evidence.",
      "timestamp": "2026-09-09T09:55:35+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.plan",
        "constraint.tool.protocols",
    ...
    },
    {
      ...
      "failure_class": "bounded_repair_required",
      "id": "failure_lesson.0224",
      "recommended_action": "Execute or approve the bounded repair workflow, then rerun Stage7. Do not continue to backend/board closure with unresolved verification failures.",
      "retry_scope": "repair_then_stage7_rerun",
      "stage": "stage8.repair",
      "summary": "real_tool.case_axi_ddr_interface: returncode=1 report_status=fail blockers=simulation.source_identity_sha256 does not bind the current identity document; simulation.vcs_compile_plan.compile_authority does not bind the identity's exact Vivado export facts; simulation.vcs_compile_plan.ordered_commands[0].authority_refs do not bind exact Vivado export contexts; simulation.vcs_compile_plan.ordered_commands[0].executable is not authorized by current tool_profile or referenced Vivado export; required_real_tool_evidence_check: required real-tool evidence missing or failed: case_axi_ddr_interface=fail; dependency_blocked=['case_vcs_functional_sim=not_run', 'case_vcs_evidence_analyzer=not_run', 'case_deadlock_axi_check=not_run', 'case_multilayer_functional=not_run', 'case_pipeline_deadlock_check=not_run', 'case_axi_protocol_check=not_run', 'case_ddr_image_roundtrip=not_run', 'case_board_semantic_evidence=not_run', 'functional_sim: blocked by prerequisite gate [case_vcs_functional_sim=not_run]']; real_weight_semantic_evidence_check: real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; hierarchical_verification_maturity_check: multilayer_pipeline_functional: functional_sim=fail, case_multilayer_functional=not_run, case_pipeline_deadlock_check=not_run; axi_ddr_functional: case_axi_ddr_interface=fail, functional_sim=fail, case_axi_protocol_check=not_run, case_ddr_image_roundtrip=not_run, case_board_semantic_evidence=not_run; real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; verification_agent_decision_check: verification.evidence_classifier: needs_repair: Fail-closed authoritative Stage7 decision: board_axi_ddr_closure is not promotable to backend synthesis, implementation, bitstream generation, runtime-ABI release, or board runtime. The earliest executed current-layer failure is real_tool.case_axi_ddr_interface: the board simulation manifest does not bind the current exact board identity, its compile authority and ordered-command authority references do not bind the exact Vivado export facts, and its simulator executables are not authorized by the current tool profile or cited export. The real board-wrapped VCS simulation was dependency-skipped, so there is no board-level functional, numeric, data-order, AXI, DDR, liveness, complete-weight-consumption, lifecycle-frontier, or output evidence. Current operator-leaf and connected single-layer certificates remain reusable because no current hash-bound trace contradicts a named lower-layer invariant. The conditional design-team router returned no_split; role consensus or the absence of a specialist review cannot replace missing deterministic evidence.",
      "timestamp": "2026-09-09T10:04:51+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.plan",
        "constraint.tool.protocols",
    ...
    },
    {
      ...
      "timestamp": "2026-09-09T10:46:29+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
    ...
    },
    {
      ...
      "failure_class": "bounded_repair_required",
      "id": "failure_lesson.0226",
      "recommended_action": "Execute or approve the bounded repair workflow, then rerun Stage7. Do not continue to backend/board closure with unresolved verification failures.",
      "retry_scope": "repair_then_stage7_rerun",
      "stage": "stage8.repair",
      "summary": "real_tool.case_multilayer_pipeline: returncode=1 report_status=fail blockers=DUT binding does not cover every transformer-block weight in every target layer; failed checks: multilayer_real_weight_binding; required_real_tool_evidence_check: required real-tool evidence missing or failed: case_multilayer_pipeline=fail; dependency_blocked=['case_axi_ddr_interface=not_run', 'case_vcs_functional_sim=not_run', 'case_vcs_evidence_analyzer=not_run', 'case_deadlock_axi_check=not_run', 'case_multilayer_functional=not_run', 'case_pipeline_deadlock_check=not_run', 'case_axi_protocol_check=not_run', 'case_ddr_image_roundtrip=not_run', 'case_board_semantic_evidence=not_run', 'functional_sim: blocked by prerequisite gate [case_vcs_functional_sim=not_run]']; real_weight_semantic_evidence_check: real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; hierarchical_verification_maturity_check: multilayer_pipeline_functional: case_multilayer_pipeline=fail, functional_sim=fail, case_multilayer_functional=not_run, case_pipeline_deadlock_check=not_run; axi_ddr_functional: case_axi_ddr_interface=not_run, functional_sim=fail, case_axi_protocol_check=not_run, case_ddr_image_roundtrip=not_run, case_board_semantic_evidence=not_run; real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; verification_agent_decision_check: verification.evidence_classifier: needs_repair: Fail-closed authoritative Stage7 decision: board_axi_ddr_closure is not promotable to backend synthesis, implementation, bitstream generation, runtime-ABI release, or board runtime. The current decisive executed failure is real_tool.case_multilayer_pipeline (returncode=1): DUT binding does not cover every Transformer-block weight in every target layer. case_axi_ddr_interface and the board VCS/analyzer/deadlock tools were dependency-skipped, so no board-level functional, numeric, ordering, AXI, DDR, liveness, lifecycle-frontier, output, or full-scope DUT-weight-consumption pass exists. The issue is presently a multilayer semantic-coverage/loader-binding verification-capability gap, not evidence of an RTL-core failure. Reuse the hash-validated operator-leaf and connected single-layer certificates; no current trace contradicts their named invariants. The conditional review returned no_split and cannot replace missing deterministic evidence.",
      "timestamp": "2026-09-09T10:48:27+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.plan",
        "constraint.tool.protocols",
...
<sacg_memory_truth>
{
  ...
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-09T13:19:14+00:00",
      "observation_count": 1880,
      "observed_transition_ids": [
        "transition.2093",
        "transition.2094",
        "transition.2095",
