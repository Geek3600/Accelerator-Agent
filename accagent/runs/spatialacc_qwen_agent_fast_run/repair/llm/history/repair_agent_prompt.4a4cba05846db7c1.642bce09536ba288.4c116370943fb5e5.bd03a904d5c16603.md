...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      ...
      "execution_errors": [],
      "input_fingerprint_sha256": "a1f95e3dea2973d92aab797367e8c274a02d3a7dcbb3b082fcceafe16558a1e7",
      "llm_records": [
        {
          "agent": "exact_board_integration_generation_agent",
          "blockers": [],
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "5dc58c851c85a1152e0fe5a130b70b516c5358a54739b34a52383b6986b245f6",
          ...
          "sha256": "ae6bf7dd2d6785bc1173aa6df690a4085b9612c2c9148c64d537639500b0c126",
          "stage": "repair_execution",
          "status": "ready_to_apply",
          "step_id": "repair_step.00",
          "summary": "Correct the rejected adaptive-observation transaction with a bounded testbench-only r6 probe at the current connected_kernel_input_to_output frontier. The prior r5 trigger required one completed output token, but the current causal slice records zero output tokens, so it could not produce the requested event. This edit changes only the generated simulation testbench event labels and trigger window; it does not alter the adapter, certified kernel, AXI model behavior, workload images, target-model reference, numeric comparison policy, or sample wrapper."
        }
      ],
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-24T18:49:42+00:00",
      "observation_count": 6,
      "observed_transition_ids": [
        "transition.0231",
        "transition.0237",
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-24T19:22:17+00:00",
      "observation_count": 6,
      "observed_transition_ids": [
        "transition.0232",
        "transition.0238",
...
<agent_status_bar>
{
  ...
  "source_sacg_state": {
    ...
    "sha256": "b2a612b52b1631ae3efc676003db23285259db770f5d94bdbfe246befa8f4aa0"
  },
