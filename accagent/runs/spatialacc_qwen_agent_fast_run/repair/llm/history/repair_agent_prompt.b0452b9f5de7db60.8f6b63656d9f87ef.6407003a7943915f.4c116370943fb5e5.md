...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      ...
      "execution_errors": [],
      "input_fingerprint_sha256": "ec6f2a1bb5e77cc43bdf60186ff9c611fe41aa968236ca0dc9deb5438c82cf35",
      "llm_records": [
        {
          "agent": "exact_board_integration_generation_agent",
          "blockers": [],
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "cfed964e13be0d819b63c628cf98801009686f6a7b35d00467ea5587a68a4a65",
          ...
          "sha256": "b24f7afe798305e49c7889a58cee49ac33baf91272549173944ef28b7add198f",
          "stage": "repair_execution",
          "status": "ready_to_apply",
          "step_id": "repair_step.00",
          "summary": "Corrects the earlier atomic materializer rejection without changing DUT behavior: the r5 observation implementation already exists in the hash-bound testbench, but the rejected transaction did not target a declared editable testbench path. This retry targets the declared generated testbench path with the current SHA and performs only a simulation-only source-identity rebind comment adjacent to the existing r5 emitter. The unchanged preflight, cold VCS, and analyzer chain must establish fresh compiled-source binding and the required r5 JSONL event; no hardware pass is claimed."
        }
      ],
...
<agent_status_bar>
{
  ...
  "source_sacg_state": {
    ...
    "sha256": "d1455dd9b13bd63ed987e55de7e33ea700048fbe7c39548fa24fed2ce93f2a63"
  },
