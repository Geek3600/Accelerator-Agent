...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      ...
      "execution_errors": [],
      "input_fingerprint_sha256": "23ad48422e4184a14b05f477d7a98ad64f5560f16adc9fcb51950d9ea919101c",
      "llm_records": [
        {
          "agent": "exact_board_integration_generation_agent",
          "blockers": [],
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "9cfd0af7d0cea9775279c05883257265b1cb237e0521e8d30cbd9301b3ec4f9c",
          ...
          "sha256": "a9e7c573be3444f7816d5002a9fef087d2eac21122db8b40c874245ffec174d2",
          "stage": "repair_execution",
          "status": "ready_to_apply",
          "step_id": "repair_step.00",
          "summary": "The compiled r5 testbench source did not yield a fresh JSONL event matching the over-constrained r5 selector, so current evidence cannot support another adapter or kernel functional edit. This atomic testbench-only r6 revision preserves every r5 observation field and bounded two-event window, while identifying the event by source-bound probe identity rather than assuming unobserved internal counter values. The exact sample wrapper, compute-slot adapter, certified kernel, AXI model, artifacts, target-model expected output, numeric policy, and analyzer remain unchanged."
        }
      ],
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-24T17:53:33+00:00",
      "observation_count": 3,
      "observed_transition_ids": [
        "transition.0231",
        "transition.0237",
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-24T17:59:07+00:00",
      "observation_count": 3,
      "observed_transition_ids": [
        "transition.0232",
        "transition.0238",
...
<agent_status_bar>
{
  ...
  "source_sacg_state": {
    ...
    "sha256": "98bc96a0bec4d463338227b09ef837ae33f01169851ef27fd03287936ec565ed"
  },
