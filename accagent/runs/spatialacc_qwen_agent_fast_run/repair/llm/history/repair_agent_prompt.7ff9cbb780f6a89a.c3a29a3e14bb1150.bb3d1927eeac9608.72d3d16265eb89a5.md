...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "The current exact-board preflight and VCS compile passed, but simulation terminated with adaptive_semantic_stall at cycle 20811776 and exit code 86. Termination provenance classifies the event as external_or_unattributed, proves neither a deterministic DUT/testbench failure nor simulator infrastructure failure, and marks source_semantic_repair_eligible false.",
        "The trace proves layer-0 ingress completion with 1792 accepted input beats and zero accepted output beats, but the current diagnosis explicitly requires a direct core-boundary contradiction before reopening the connected kernel. Independent AXI and prefetch progress is not output-frontier progress.",
        "The prior adaptive-observation transaction was rejected without applying edits, and current_patch_application_feedback states real_tool_replay_required_before_retry is false. An unchanged-source replay or semantic reversal would repeat the rejected intervention and is not authorized.",
        "The checker reports dynamic_evidence_records[4] and [5] schema/evidence-kind defects, but the compact evidence does not identify a source-owned emitter or the authoritative valid evidence-kind enum; these records are materialized verification artifacts rather than a safely determined board-source repair. No source edit can be justified without risking a schema change or weakening the analyzer."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "1a8f9f54f9f921c3bfe196c6b62238b775eb668c9c919e41688c6c34ca59271b",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "a750662dae1868956fce309e67d3c1a3edb6f10f2a298979fdfa3b931b82ca55",
          ...
          "required_capabilities": [
            {
              "capability_id": "repair_step.01_distinct_vcs_termination_provenance",
              "debug_layer": "board_axi_ddr_wrapped_system",
              "producer_scope": "runner_and_verification_capability",
              "rationale": "Implement and execute a diagnostically distinct capture on the unchanged exact sample-project source closure. It must bind the current source and stimulus hashes, distinguish runner-owned termination from deterministic DUT/testbench or AXI/DDR failure, preserve the exact replay fingerprint, capture runner process provenance and terminal logs, and emit trusted direct core-boundary evidence with valid artifact schemas. Until that capability executes, the supplied evidence authorizes neither RTL repair nor an unchanged replay.",
              "required_evidence": [
                "/verification_capability_repair_package/current_board_vcs_feedback/value/runner_report/value/run/termination_provenance/exact_source_replay_fingerprint_sha256",
                "/verification_capability_repair_package/current_board_vcs_feedback/value/runner_report/value/run/termination_provenance/runner_process_provenance",
                "/verification_capability_repair_package/current_board_vcs_feedback/value/runner_report/value/run/termination_provenance/raw_terminal_log_tail",
                "/verification_capability_repair_package/current_board_vcs_feedback/value/diagnosis/value/failure_evidence/adaptive_semantic_stall_evidence",
                "/verification_capability_repair_package/current_patch_application_feedback"
              ],
              "target_modules": [
                "vcs_simulate",
                "simulation_termination_provenance",
                "dynamic_real_tool_evidence"
              ]
            }
          ],
          "scope": "verification_capability_repair",
          "sha256": "0887ef748f5b4ae8453e739375d6b40fc7eb9c7748643c2f8a837f651a336d1b",
      ...
      "report": {
        ...
        "sha256": "7f83ba8cfef1a0ae0d4e8f275ed8f9e235505d9643388507ccd819bc4560312a"
      },
      "required_capabilities": [
        {
          "capability_id": "repair_step.01_distinct_vcs_termination_provenance",
  ...
  "failures": [
    {
      ...
      "execution_fingerprint_sha256": "ccc76c9f8a1c2167e10ce17728fed5f06bb581b4ca969961a136f1143fc1fb56",
    ...
    },
    {
      ...
      "repair_hint": "inspect violated constraint and rerun the related checker",
      "status": "fail",
      "summary": "verification.evidence_classifier: needs_repair: Fail-closed authoritative Stage7 decision: board_axi_ddr_closure is not promotable. The direct executed failure is case_axi_ddr_interface, where the exact sample-project identity hash, Vivado-export compile authority, ordered command authority references, and simulator executable authorization are not mutually bound. The VCS functional simulator was dependency-skipped, so no board-level functional, numeric, ordering, AXI, DDR, liveness, weight-consumption, or output-frontier evidence exists. Certified operator-leaf and connected single-layer evidence remains reusable because no current hash-bound trace contradicts a named lower-layer invariant. The no_split conditional review cannot replace deterministic checker evidence."
    }
  ],
  ...
  "repair_actions": [
    {
      ...
      "failure_signature": {
        ...
        "summaries": [
          ...
          "verification.evidence_classifier: needs_repair: Fail-closed authoritative Stage7 decision: board_axi_ddr_closure is not promotable. The direct executed failure is case_axi_ddr_interface, where the exact sample-project identity hash, Vivado-export compile authority, ordered command authority references, and simulator executable authorization are not mutually bound. The VCS functional simulator was dependency-skipped, so no board-level functional, numeric, ordering, AXI, DDR, liveness, weight-consumption, or output-frontier evidence exists. Certified operator-leaf and connected single-layer evidence remains reusable because no current hash-bound trace contradicts a named lower-layer invariant. The no_split conditional review cannot replace deterministic checker evidence."
        ]
      },
      "minimal_repair_context": {
        "failed_current_layer_gates": [
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-08-20T08:02:40+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-08-20T07:55:48+00:00",
  ...
  "recent_failure_lessons": [
    ...
    },
    {
      ...
      "stage": "stage7.verification",
      "summary": "real_tool.case_axi_ddr_interface: returncode=1 report_status=fail blockers=simulation.source_identity_sha256 does not bind the current identity document; simulation.vcs_compile_plan.compile_authority does not bind the identity's exact Vivado export facts; simulation.vcs_compile_plan.ordered_commands[0].authority_refs do not bind exact Vivado export contexts; simulation.vcs_compile_plan.ordered_commands[0].executable is not authorized by current tool_profile or referenced Vivado export; required_real_tool_evidence_check: required real-tool evidence missing or failed: case_axi_ddr_interface=fail; dependency_blocked=['case_vcs_functional_sim=not_run', 'case_vcs_evidence_analyzer=not_run', 'case_deadlock_axi_check=not_run', 'case_multilayer_functional=not_run', 'case_pipeline_deadlock_check=not_run', 'case_axi_protocol_check=not_run', 'case_ddr_image_roundtrip=not_run', 'case_board_semantic_evidence=not_run', 'functional_sim: blocked by prerequisite gate [case_vcs_functional_sim=not_run]']; real_weight_semantic_evidence_check: real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; hierarchical_verification_maturity_check: multilayer_pipeline_functional: functional_sim=fail, case_multilayer_functional=not_run, case_pipeline_deadlock_check=not_run; axi_ddr_functional: case_axi_ddr_interface=fail, functional_sim=fail, case_axi_protocol_check=not_run, case_ddr_image_roundtrip=not_run, case_board_semantic_evidence=not_run; real-weight semantic evidence contract failed: axi_ddr_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; multilayer_pipeline_functional: semantic evidence report is missing: /home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/semantic_evidence/board_axi_ddr.json; verification_agent_decision_check: verification.evidence_classifier: needs_repair: Fail-closed authoritative Stage7 decision: board_axi_ddr_closure is not promotable. The direct executed failure is case_axi_ddr_interface, where the exact sample-project identity hash, Vivado-export compile authority, ordered command authority references, and simulator executable authorization are not mutually bound. The VCS functional simulator was dependency-skipped, so no board-level functional, numeric, ordering, AXI, DDR, liveness, weight-consumption, or output-frontier evidence exists. Certified operator-leaf and connected single-layer evidence remains reusable because no current hash-bound trace contradicts a named lower-layer invariant. The no_split conditional review cannot replace deterministic checker evidence.",
      "timestamp": "2026-08-20T08:02:40+00:00",
      "verification_scope": "board_axi_ddr_closure",
      "violated_constraints": [
        "constraint.verification.functional_scope"
      ]
