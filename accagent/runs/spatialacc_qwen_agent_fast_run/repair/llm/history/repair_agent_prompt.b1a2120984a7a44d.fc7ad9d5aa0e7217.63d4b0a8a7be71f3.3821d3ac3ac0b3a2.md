...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "The sole current failure is local_memory_admission_wait: \"wait for memory before starting the heavy job.\" The VCS runner stopped in resource_admission before compilation, elaboration, simulation, or analyzer execution; no board source, manifest, protocol, lifecycle, numeric, or observability defect is evidenced.",
        "Changing generated RTL, the testbench, monitor, manifest, compile authority, artifacts, or verification policy cannot causally resolve host memory admission and is prohibited for an execution-environment failure. The unchanged hash-bound board source closure must be retried only after framework resource admission is available."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "325c0ecb59c14c1d0ad2fd85c6e5af490619186cde2716ea7e523b3e091329fd",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "74ebda687fbc5a715304fd17c3d2281b41a03b08d8d38ddaf531c1bdeeffe990",
          ...
          "required_capabilities": [
            {
              "capability_id": "framework.real_board_vcs_resource_admission_retry",
              "debug_layer": "board_axi_ddr_wrapped_system",
              "producer_scope": "framework_execution_environment",
              "rationale": "The current run never reached a source-executing phase, so the only evidence-supported next action is an unchanged exact-board VCS admission retry.",
              "required_evidence": [
                "A successful resource-admission record for the configured remote VCS tool and unchanged exact-board compile plan.",
                "Subsequent real VCS runner report and analyzer diagnosis, if VCS reaches execution."
              ],
              "target_modules": []
            }
          ],
          "scope": "verification_capability_repair",
          "sha256": "0d7bf00a69d438d99a55b5043a983d3cf047b5ad421001fe36834d1a93f644fb",
      ...
      "report": {
        ...
        "sha256": "48511e20dc0fe1a921e09ac820f0bf2d9a1fd9363b7ddc32c744b87dabf42700"
      },
      "required_capabilities": [
        {
          "capability_id": "framework.real_board_vcs_resource_admission_retry",
  ...
  "failures": [
    {
      ...
      "execution_fingerprint_sha256": "44bf075ddb86a46bb27c018ee5619e99b75e824bec65c904263a8a9b4483c3dc",
    ...
    },
    {
      ...
      "repair_hint": "inspect violated constraint and rerun the related checker",
      "status": "fail",
      "summary": "verification.evidence_classifier: needs_repair: Stage7 board_axi_ddr_closure is fail-closed and cannot promote to synthesis, implementation, bitstream, runtime-ABI release, or board runtime. The current candidate has real-tool passes for case_board_interface_discovery and case_multilayer_pipeline, but case_axi_ddr_interface directly failed because the board simulation source-identity hash, Vivado-export compile authority, ordered-command authority references, and executable authorization are not bound to the current exact-wrapper identity. functional_sim is failed only as an unsatisfied aggregate: VCS, its evidence analyzer, and AXI/deadlock diagnostics were dependency-skipped and provide no board RTL, numeric, liveness, ordering, or protocol result. The missing board_tb.sv is an additional simulation-precondition failure. Certified leaf and elastic connected-single-layer evidence remains reusable; no current hash-bound trace asserts a named contradiction that authorizes reopening either lower layer. The conditional router triggered no specialist split, which does not alter this tool-evidence decision."
    }
  ],
  ...
  "pending_evidence": [
    ...
    },
    {
      ...
      "produced_reports": [
        {
          "blockers": [
            "local_memory_admission_wait: wait for memory before starting the heavy job"
          ],
          ...
          "status": "needs_repair",
          "summary": "local_memory_admission_wait: wait for memory before starting the heavy job"
        },
        {
          "blockers": [],
          "path": "/home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/debug_closure/boundary_trace.json",
      ...
      "reused_existing_result": false,
      "status": "not_run",
      "summary": "skipped because dependency gate(s) are not pass: ['case_axi_ddr_interface'] report_status=needs_repair blockers=local_memory_admission_wait: wait for memory before starting the heavy job",
      "tool_report_blockers": [
        "local_memory_admission_wait: wait for memory before starting the heavy job"
      ],
      ...
      "tool_report_summary": "local_memory_admission_wait: wait for memory before starting the heavy job"
    },
    {
      "acceptance_role": "diagnostic_or_static_tool",
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "policy": "Downstream stages must treat artifacts from rejected transitions as planning/debug evidence only, not validated design inputs.",
      "reason": "one or more framework static checks failed",
      "source_fingerprint_sha256": "6f79d3af2a76861b4372a0fd1a6cd00cb5ecc192bca91dd73cdd629da6708b28",
      "status": "active",
...
<sacg_memory_truth>
{
  "active_contamination_barrier_count": 13,
  "active_contamination_barriers": [
    {
      "artifact_id": "artifact.stage7.verification_result",
      "debug_layer": "board_axi_ddr_wrapped_system",
  ...
  "global_persisted_blocker_counts": {
    "active_contamination_barriers": 16,
    "open_backtrack_requests": 1,
    "open_retry_requests": 5
  },
