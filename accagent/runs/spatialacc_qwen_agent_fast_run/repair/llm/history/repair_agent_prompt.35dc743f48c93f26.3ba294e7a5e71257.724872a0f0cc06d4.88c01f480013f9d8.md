...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "current_patch_application_feedback reports remote stage pruning before VCS launch with compile returncode=125, remote_state=not_run, and simulation status=not_run, and expressly prohibits an unchanged-source replay until prelaunch provenance and environment-recovery authorization are supplied",
        "the reported invalid elaborated-hierarchy failure lacks source path, line, declaration context, ordered compile-command attribution, and a first source-attributed diagnostic; no source-level repair can be localized from it",
        "the supplied executed-board termination provenance classifies the prior adaptive semantic stall as external_or_unattributed_termination and sets source_semantic_repair_eligible=false; it does not authorize RTL, monitor, testbench, manifest, or observability modification",
        "the supplied direct core observations establish zero accepted core egress but do not directly contradict a named certified connected-kernel invariant, so certified lower-layer sources remain closed"
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "1460c13bcf649c8b744355e55a4737c3bb7c403749bfee5981787052b94a43eb",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "f643029af92b5e050d88ee2140c56c98d44e23f209dfffb081bb05733c5d3cd5",
          ...
          "required_capabilities": [
            {
              ...
              "rationale": "The active patch feedback identifies an unproven remote prelaunch failure and forbids replay. The available completed VCS trace cannot authorize a semantic source edit because its termination provenance explicitly excludes source-semantic repair eligibility. Obtain bounded real-board VCS provenance and environment-recovery classification before selecting either an environment retry or a causally localized source repair.",
              "required_evidence": [
                "hash-bound remote stage-pruning/prelaunch log for the compile returncode=125 event",
                "ordered remote VCS compile and elaboration commands with resolved source paths, source hashes, working directory, executable identity, and environment/recovery attribution",
                "first source-attributed compiler or elaboration diagnostic, if one exists, including source path, line, declaration context, and compile-order position",
                "decision contract establishing provenance completeness and whether the failure is a prelaunch environment failure eligible for environment recovery rather than a source repair",
                "post-recovery authorization tied to the exact board source fingerprint before any replay"
              ],
              "target_modules": [
          ...
          "sha256": "129d812b470d7ea0dc54f267256d4930a5014fc4cb87faf4bb1c8354dfdeb827",
      ...
      "report": {
        ...
        "sha256": "3cc538fa990fe1e9628335606493bc90bd93fb119be1c186b4b3717764dbac28"
      },
      "required_capabilities": [
        {
          "capability_id": "vcs_compile_diagnostic_source_provenance",
  ...
  "repair_actions": [
    {
      ...
      "debug_layer": "board_axi_ddr_wrapped_system",
      "reason": "The active patch feedback identifies an unproven remote prelaunch failure and forbids replay. The available completed VCS trace cannot authorize a semantic source edit because its termination provenance explicitly excludes source-semantic repair eligibility. Obtain bounded real-board VCS provenance and environment-recovery classification before selecting either an environment retry or a causally localized source repair.",
      ...
      "source_feedback_fingerprint_sha256": "1460c13bcf649c8b744355e55a4737c3bb7c403749bfee5981787052b94a43eb",
      "target_modules": [
        "spatialacc_exact_board_multilayer_tb",
        "app_shell_9p_cnn_core_0_1",
        "spatialacc_axi4_protocol_monitor",
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-04T16:09:55+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-04T16:10:56+00:00",
