...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    "case_vcs_functional": {
      "applicability": {
        ...
        "validation_errors": [
          "source_artifacts[0] live sha256 changed",
          "source_artifacts[5] live sha256 changed",
          "source_artifacts[6] live sha256 changed"
        ]
      },
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "The current runner explicitly reports source_semantic_repair_eligible=false. The first record has input data sent/received before start, the input data boundary count is 1792, and the output data boundary count is zero; the output is waiting without a first record or last record, but a behavior edit is forbidden until eligibility is supplied."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "03a4254b001550f052b3671fbbee5666027a8d6f7e91e693bb1dcb1fb6ff6012",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "317946080089ed648c0986872355294c3b4cdae3421a31f80a1ed4146c917fd3",
          ...
          "required_capabilities": [
            {
              "capability_id": "board_lifecycle_semantic_repair_eligibility",
              "debug_layer": "board_axi_ddr_wrapped_system",
              "producer_scope": "real_board_vcs_analyzer_lifecycle_eligibility",
              "rationale": "Decide whether the direct first record proves that start must precede the first core input data sent/received handshake in the exact adapter. The decision must preserve the input and output data boundary count, first record, last record, and waiting evidence, and must not replace the certified kernel or alter the target-model output.",
              "required_evidence": [
                "/current_board_vcs_feedback/diagnosis/value/failure_evidence/progress_event_summary/latest_stall_snapshot/connected_kernel_internal_pipeline_observation/first_core_ingress_precedes_start",
                "/current_board_vcs_feedback/diagnosis/value/failure_evidence/progress_event_summary/latest_stall_snapshot/connected_kernel_internal_pipeline_observation/core_ingress_accepted_count",
                "/current_board_vcs_feedback/diagnosis/value/failure_evidence/progress_event_summary/latest_stall_snapshot/connected_kernel_internal_pipeline_observation/core_egress_accepted_count",
                "/current_board_vcs_feedback/runner_report/value/run/termination_provenance/causal_classification/source_semantic_repair_eligible",
                "generated-board-source:compute_slot_adapter@sha256:f768e1e9e42eee7c95080be1766231197f190314ace48963c5a6a54b0d71c4d6",
                "generated-board-source:exact_multilayer_tb@sha256:508f38c4b8fb9c1ac16e8191cccc4ee1a15f3ab862cfbfbb3821f312646df82f"
              ],
              "target_modules": [
          ...
          "sha256": "3503782a6445f87f5788b732bfca064da371384e0e507e903a70cceebca996bd",
          "stage": "repair_execution",
          "status": "blocked",
          "step_id": "repair_step.00",
          "summary": "Blocked before any behavior edit. The first record shows the core received input data before its start, while the input data boundary received count reached 1792 and the output received count stayed zero. The output is waiting, so no first output record or last output record exists. The current tool marks source_semantic_repair_eligible false, so the direct record does not authorize changing adapter behavior."
        }
      ],
      ...
      "report": {
        ...
        "sha256": "1317d73bf75427f117dacb418f3a17f2ff47c94862547694e2f7649c1d7483ec"
      },
      "required_capabilities": [
        {
          "capability_id": "board_lifecycle_semantic_repair_eligibility",
  ...
  "pending_evidence": [
    ...
    },
    {
      ...
      "reused_existing_result": false,
      "status": "not_run",
      "summary": "skipped because dependency gate(s) are not pass: ['case_multilayer_pipeline', 'case_axi_ddr_interface'] report_status=needs_repair blockers=board_output_lifecycle_frontier_violation: the board trace completed current-layer ingress while the ready output frontier accepted zero beats; direct core-boundary contradiction evidence is still required before reopening the connected kernel",
      "tool_report_blockers": [
        "board_output_lifecycle_frontier_violation: the board trace completed current-layer ingress while the ready output frontier accepted zero beats; direct core-boundary contradiction evidence is still required before reopening the connected kernel"
      ],
  ...
  "repair_actions": [
    {
      ...
      "failure_signature": {
        ...
        "summaries": [
          "returncode=1 report_status=fail blockers=DUT binding does not cover every transformer-block weight in every target layer; failed checks: multilayer_real_weight_binding",
