...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      ...
      "execution_errors": [],
      "input_fingerprint_sha256": "39946765e3e8c746e8d5343eb521ca84770a5972b05cedfb8103db7a085cabeb",
      "llm_records": [
        {
          "agent": "exact_board_integration_generation_agent",
          "blockers": [],
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "0a7a2220bd795264248b7917ad3687bed3cacc0c5ba6783b95ee399548492fb0",
          ...
          "sha256": "0941f3f97fdc84d0dded15dc120f74ec5201b7ac24d76772a82e94832b940f37",
          "stage": "repair_execution",
          "status": "ready_to_apply",
          "step_id": "repair_step.00",
          "summary": "Correct the rejected adaptive-observation transaction with a testbench-only r5 trigger that is consistent with the current SACG/CCTG frontier. The current source-bound r5 probe is moved from a first-output-token continuation prerequisite to the current zero-output input-to-output frontier: after all layer-0 input beats are accepted and the certified continuation gap elapses with output VALID low and READY high, it emits one durable internal ingress/stage-0/egress correlation record. No adapter, certified kernel, AXI model behavior, target-model golden, numeric policy, workload, or sample wrapper changes."
        }
      ],
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-24T18:04:56+00:00",
      "observation_count": 4,
      "observed_transition_ids": [
        "transition.0231",
        "transition.0237",
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-24T18:10:32+00:00",
      "observation_count": 4,
      "observed_transition_ids": [
        "transition.0232",
        "transition.0238",
...
<agent_status_bar>
{
  ...
  "source_sacg_state": {
    ...
    "sha256": "b95a5da08e5b6c1d47ce3d71d7a1f22f0deb02f67841e31fc73d11d61df1dede"
  },
