...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "The exact hash-bound VCS compile passed, but simv terminated with an internal SIGSEGV before any terminal event or completion reports. The available terminal provenance explicitly has no source/event context, so it does not distinguish a VCS/runner failure from a deterministic source-triggered simulator failure at a particular HDL event.",
        "The invalid/missing pipeline-overlap, runtime-loader, AXI-protocol, and hierarchy dynamic artifacts are downstream consequences of the pre-terminal SIGSEGV. Their report schemas must not be weakened or synthesized without a normally completed real simulation.",
        "The current ingress/stage-0/egress observations localize lack of board output progress but do not directly contradict a named certified-kernel invariant. Editing the certified kernel or board adapter on this evidence would be speculative."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "f1d1ca35f033d46b88c4eb28a170a810a7fe616a2fbe1588ca740313aced1b65",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "3feb2550350ce4d5fc5990d9d0b8db3e0a1da3d3ff2836a95c480da3af80799f",
          ...
          "required_capabilities": [
            {
              "capability_id": "repair.enable_remote_vcs_termination_provenance",
              "debug_layer": "board_axi_ddr_wrapped_system",
              "producer_scope": "framework.remote_vcs_runner_and_case_vcs_evidence_analyzer",
              "rationale": "The supplied testbench already provides read-only ingress, stage-0, egress, delta-transition, and bounded-core-cone observations. Adding or changing RTL/report logic cannot causally resolve an unclassified VCS SIGSEGV. Termination provenance is required before selecting a bounded source repair.",
              "required_evidence": [
                "A fresh hash-bound replay termination record that identifies whether the SIGSEGV is owned by VCS/remote execution or by a deterministic HDL source event.",
                "Untruncated causal simulator context sufficient to name the last executed source location or event before termination.",
                "The unchanged exact wrapper/source closure, VCS compile authority, checkpoint, stimulus, expected-output artifact, and numeric-policy bindings for that replay."
              ],
              "target_modules": [
                "remote_vcs_runner",
                "case_vcs_evidence_analyzer"
          ...
          "sha256": "cad4095af9657e5d58c4229a2cb452aea14aa597d7a789f2a12b457c23320a95",
      ...
      "report": {
        ...
        "sha256": "dff6c5f5098640e66b9c0e8e276c22ad7ae739857a3ee79309e41fd34422ec63"
      },
      "required_capabilities": [
        {
          "capability_id": "repair.enable_remote_vcs_termination_provenance",
  ...
  "failures": [
    {
      ...
      "execution_fingerprint_sha256": "b332ce0c8a2cb2ad00e2ec84ac02e86419ec46d43db1dc2d4a8be623afc2a0cd",
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-29T04:56:23+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-28T19:02:23+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-07-29T04:51:48+00:00",
