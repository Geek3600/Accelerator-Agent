...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "Remote stage pruning failed before VCS launch: compile returncode=125, remote_state=not_run, and simulation status=not_run.",
        "The reported \"elaborated hierarchy report is invalid\" error has no source path, line, declaration context, ordered compile-command attribution, or first source-attributed compiler diagnostic.",
        "The supplied termination provenance classifies the event as external_or_unattributed_termination and explicitly marks source_semantic_repair_eligible=false; no board RTL, monitor, testbench, manifest, or observability edit is causally authorized.",
        "Current patch feedback prohibits an unchanged-source replay until hash-bound remote-VCS prelaunch provenance and environment-recovery authorization are produced."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "eb8eb4724511bd94faead01a732b719b303486b6bf1942dbe4b709027facf951",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "0cc78aafb980aae98230dd8a12ce07f7c7716b063774d387ccfa3987426ff6f1",
          ...
          "required_capabilities": [
            {
              ...
              "rationale": "The real-board chain did not reach VCS compilation or simulation. The current diagnostic is not source-attributed and its termination evidence excludes semantic source repair. This read-only capability must establish the unique hash-bound compile binding and prelaunch environment-recovery decision; it must not edit sources or launch an unchanged-source replay while the present prohibition remains active.",
              "required_evidence": [
                "Hash-bound exact-board identity and exact user-sample wrapper/source closure used by the remote job.",
                "Ordered remote VCS compile commands, source-file paths, library/include bindings, compile order, and executable/tool-profile authorization.",
                "Remote stage-pruning and cleanup logs establishing why returncode=125 occurred before VCS launch.",
                "A validated elaborated-hierarchy report producer/consumer binding and, if present, the first source-attributed error with path, line, declaration context, and compile-order attribution.",
                "A provenance decision stating whether the current exact source fingerprint a35802483c747d40f2c8f457188fe8f6df9ca344ed2a32e1489c8915ab897af2 may be retried through environment recovery without source edits."
              ],
              "target_modules": [
          ...
          "sha256": "b7304d091756be280c37d57160292c3a3cd37ec5802242e625f888932d9e8443",
      ...
      "report": {
        ...
        "sha256": "424317f41ae9db28767dd19776de9a864dea2114947a6d3ba30d165268eb2dd2"
      },
      "required_capabilities": [
        {
          "capability_id": "vcs_compile_diagnostic_source_provenance",
  ...
  "repair_actions": [
    {
      ...
      "minimal_repair_context": {
        ...
        "vcs_failure_class": "vcs_execution_environment_failure"
      },
      "reason": "the current exact-board VCS/analyzer evidence proves a pre-launch environment failure; retry the same real-tool chain after framework recovery without changing RTL",
      "repair_gate": "case_axi_ddr_interface",
      "repair_kind": "exact_board_environment_retry",
      "root_candidate_module": null,
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-04T11:26:29+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-04T12:42:31+00:00",
