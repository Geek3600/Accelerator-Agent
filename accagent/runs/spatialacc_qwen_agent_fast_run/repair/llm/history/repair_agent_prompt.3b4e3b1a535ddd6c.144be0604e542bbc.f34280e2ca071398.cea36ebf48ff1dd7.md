...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "The real VCS compile passed, but the run terminated at the connected-kernel input-to-output liveness frontier with zero accepted output beats after complete ingress; the runner explicitly marks source_semantic_repair_eligible=false, so no behavioral board-adapter or certified-kernel edit is authorized.",
        "The current SACG/CCTG slice explicitly states that current board evidence contradicts the lower-layer certificate and directs reopening the failed CCTG boundary through an affected lower-layer replay. The certified kernel sources are not editable by this board-integration capability.",
        "The reported dynamic-evidence schema cascade identifies simulation.dynamic_evidence_records[4] but supplies no producer path, source line, or record payload that would permit a non-guessing testbench schema repair; it is not earlier than the proven liveness frontier."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "49be284c9b8cf06010a010589392eb6762e7f71a6db5fc0b0c9fddbe5df0d70b",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "cf462ddb0572784050d0757a66e2fefa139d051d9b535a27f5f166d53e3b51f2",
          ...
          "required_capabilities": [
            {
              ...
              "rationale": "The current CCTG projection reports current_board_evidence_contradicts_lower_certificate=true after the direct connected-kernel frontier contradiction. Reopening this explicitly contradicted lower boundary is required, while the present board-run termination contract forbids behavioral repair in this agent-owned board shell.",
              "required_evidence": [
                "A real VCS targeted replay on the immutable checkpoint, stimulus, runtime image, and complete real-weight bindings used by the failing board run.",
                "Schema-valid CCTG boundary records for block input, RMS1-to-attention, MLP gate/up, activation-mul-to-MLP-down, MLP-down-to-residual2, and core egress, including valid, ready, accepted_count, and terminal-last observations at the first contradictory transaction.",
                "A causal localization result that distinguishes a certified-kernel boundary violation from a board-shell scheduling or observation fault before any lower-layer behavioral source repair is proposed."
              ],
              "target_modules": [
          ...
          "sha256": "db91a214021d01b70f8d5485dd85022c32b48744a09bc66c3c99e00b988b0eb9",
      ...
      "report": {
        ...
        "sha256": "074c40ccab67fa3016936c418d326675cc3146546c349991469ef99d13bfbfbe"
      },
      "required_capabilities": [
        {
          "capability_id": "cctg_connected_kernel_boundary_replay",
  ...
  "repair_actions": [
    {
      ...
      "reason": "The current CCTG projection reports current_board_evidence_contradicts_lower_certificate=true after the direct connected-kernel frontier contradiction. Reopening this explicitly contradicted lower boundary is required, while the present board-run termination contract forbids behavioral repair in this agent-owned board shell.",
      ...
      "requested_capability_id": "cctg_connected_kernel_boundary_replay",
      "requested_producer_scope": "real_vcs_single_layer_boundary_localization",
      "required_evidence": [
        "A real VCS targeted replay on the immutable checkpoint, stimulus, runtime image, and complete real-weight bindings used by the failing board run.",
        "Schema-valid CCTG boundary records for block input, RMS1-to-attention, MLP gate/up, activation-mul-to-MLP-down, MLP-down-to-residual2, and core egress, including valid, ready, accepted_count, and terminal-last observations at the first contradictory transaction.",
        "A causal localization result that distinguishes a certified-kernel boundary violation from a board-shell scheduling or observation fault before any lower-layer behavioral source repair is proposed."
      ...
      "source_feedback_fingerprint_sha256": "49be284c9b8cf06010a010589392eb6762e7f71a6db5fc0b0c9fddbe5df0d70b",
      "target_modules": [
        "SingleLayerSemanticHarness",
        "ConnectedObservableLlamaStyleBlock",
        "GatedMLP"
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-05T11:31:10+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-06T05:40:13+00:00",
