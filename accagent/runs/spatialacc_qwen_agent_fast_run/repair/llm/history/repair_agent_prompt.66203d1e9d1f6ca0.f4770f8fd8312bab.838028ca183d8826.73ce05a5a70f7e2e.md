...
<candidate_repair_plan>
{
  ...
  "diagnostics": {
    ...
    "prior_repair_execution_feedback": {
      "blockers": [
        "Remote stage pruning timed out before VCS launch: compile returncode=125, remote_state=not_run, and simulation status=not_run.",
        "The only reported error, \"elaborated hierarchy report is invalid\", has no source path, line, declaration context, or source-attributed VCS compile/elaboration diagnostic. The diagnosis explicitly marks source_semantic_repair_eligible=false.",
        "The supplied feedback prohibits an unchanged-source replay, and no RTL, monitor, testbench, manifest, or observability edit is causally authorized for the pre-launch remote cleanup failure."
      ],
      "deterministic_feedback": [],
      "execution_errors": [],
      "input_fingerprint_sha256": "d83062033b4430fe02ce3bb2b0e098b20d939f9142fcbb512bfc07ee1764a524",
      "llm_records": [
        {
          ...
          "deterministic_feedback": [],
          "input_fingerprint_sha256": "ece2283b482cdf55ea0b711b6216d6e6e89f50231bf9a3635577688321120cfc",
          ...
          "required_capabilities": [
            {
              ...
              "rationale": "The current run never launched VCS because remote stage pruning timed out. Read-only compile-provenance recovery is required to distinguish infrastructure failure from an attributable generated-board source failure; it authorizes neither a source edit nor another unchanged-source VCS replay.",
              "required_evidence": [
                "A preserved real VCS compile/elaboration diagnostic identifying the failing source path, line number, declaration context, and invoked compile order when source-attributed.",
                "Validated provenance for the hierarchy-report rejection that distinguishes stale or absent hierarchy metadata, identity-binding failure, report-schema failure, and remote transport/cleanup failure.",
                "Remote job launch evidence after stage pruning, including the VCS command execution status and compile.log/elaborate.log content or a source-independent infrastructure failure classification."
              ],
              "target_modules": [
          ...
          "sha256": "42cf684c9db9874460dbe47a7679ea201dd86e19e3eea2160dfdebe514bef3b0",
      ...
      "report": {
        ...
        "sha256": "4d94133c87ffc377693245f2d10f26da99dfea168a399f9178215068bb491f4e"
      },
      "required_capabilities": [
        {
          "capability_id": "vcs_compile_diagnostic_source_provenance",
  ...
  "repair_actions": [
    {
      ...
      "debug_layer": "board_axi_ddr_wrapped_system",
      "reason": "The current run never launched VCS because remote stage pruning timed out. Read-only compile-provenance recovery is required to distinguish infrastructure failure from an attributable generated-board source failure; it authorizes neither a source edit nor another unchanged-source VCS replay.",
      ...
      "source_feedback_fingerprint_sha256": "d83062033b4430fe02ce3bb2b0e098b20d939f9142fcbb512bfc07ee1764a524",
      "target_modules": [
        "spatialacc_exact_board_multilayer_tb",
        "app_shell_9p_cnn_core_0_1",
        "spatialacc_axi4_protocol_monitor"
...
<sacg_memory>
{
  "active_contamination_barriers": [
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-04T11:21:43+00:00",
    ...
    },
    {
      ...
      "last_observed_at": "2026-09-04T11:23:10+00:00",
