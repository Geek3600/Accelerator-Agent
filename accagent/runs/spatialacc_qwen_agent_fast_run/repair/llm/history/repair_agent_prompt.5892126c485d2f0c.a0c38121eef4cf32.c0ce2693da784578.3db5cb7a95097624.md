  ...
  "diagnostics": {
    ...
    "contract_guided_debug_closure": {
      ...
      "failing_transaction": {
        ...
        "summary": "returncode=1 report_status=fail blockers=exact identity contract: progressive selector coverage ledger worker_records[0].path differs from its map checkpoint record_file"
      },
  ...
  "failures": [
    {
      ...
      "produced_reports": [
        {
          "blockers": [
            "exact identity contract: progressive selector coverage ledger worker_records[0].path differs from its map checkpoint record_file"
          ],
    ...
    },
    {
      ...
      "repair_hint": "inspect violated constraint and rerun the related checker",
      "status": "fail",
      "summary": "verification.evidence_classifier: needs_repair: Stage7 board_axi_ddr_closure is fail-closed and cannot promote to backend synthesis, implementation, bitstream, runtime ABI release, or board runtime. The authoritative current-candidate real-tool failure is case_board_interface_discovery: it executed with fingerprint 680f9c56d1418080e43ae4897167f255dcbbb808d695c7355b4c85f4e98f8fe1 and returned 1 because worker_records[0].path differs from its map-checkpoint record_file in the exact source-identity ledger. case_multilayer_pipeline, AXI/DDR integration, VCS, the analyzer, and AXI/deadlock diagnostics were dependency-skipped; functional_sim=fail is therefore an unsatisfied aggregate gate, not board-wrapped RTL, numeric, AXI, DDR, ordering, or liveness evidence. The missing board_tb.sv is a further board-simulation readiness defect. Certified operator-leaf and elastic connected-single-layer evidence remains reusable because no current hash-bound board trace contradicts a named lower-layer invariant. Five active scoped contamination barriers and two open scoped retries remain downstream-consumption blockers; retry reconciliation is not ready and no board-scope promotion certificate exists."
    }
  ],
  ...
  "repair_actions": [
    {
      ...
      "failure_signature": {
        ...
        "summaries": [
          "returncode=1 report_status=fail blockers=exact identity contract: progressive selector coverage ledger worker_records[0].path differs from its map checkpoint record_file",
          "real functional simulation preconditions failed: board_testbench_artifact_loading files missing: ['/home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_simulation/board_tb.sv']; dependency_blocked=['case_multilayer_pipeline will be produced and judged by the current Stage7 tool scope', 'case_multilayer_functional will be produced and judged by the current Stage7 tool scope', 'case_axi_ddr_interface will be produced and judged by the current Stage7 tool scope', 'case_axi_protocol_check will be produced and judged by the current Stage7 tool scope', 'case_ddr_image_roundtrip will be produced and judged by the current Stage7 tool scope']",
...
<sacg_memory>
{
  ...
  "recent_stage_outcomes": [
    ...
    },
    {
      ...
      "debug_layer": "board_axi_ddr_wrapped_system",
      "errors": [
        "real_tool.case_board_interface_discovery: returncode=1 report_status=fail blockers=exact identity contract: progressive selector coverage ledger worker_records[0].path differs from its map checkpoint record_file",
        "case_functional_sim_precondition_check: real functional simulation preconditions failed: board_testbench_artifact_loading files missing: ['/home/remote/workspace/Qwen2-Accelerator/accagent/runs/spatialacc_qwen_agent_fast_run/verification/board_simulation/board_tb.sv']; dependency_blocked=['case_multilayer_pipeline will be produced and judged by the current Stage7 tool scope', 'case_multilayer_functional will be produced and judged by the current Stage7 tool scope', 'case_axi_ddr_interface will be produced and judged by the current Stage7 tool scope', 'case_axi_protocol_check will be produced and judged by the current Stage7 tool scope', 'case_ddr_image_roundtrip will be produced and judged by the current Stage7 tool scope']",
...
<agent_status_bar>
{
  ...
  "source_sacg_state": {
    ...
    "sha256": "d5dacf3966ffc6f9bd7e3d161a1666ae288bdbf7e54012e460543ca56b8ae356"
  },
