...
<task>
Audit target_board_profile, tool_profile, tool_availability, tool_protocols, field_evidence, and sample/material indices for concrete DDR/AXI, address-map, runtime ABI, deployment, and executable tool evidence while blocking unsupported implementation claims.
</task>
...
<subtask>
{
  ...
  "handoff_to": [
    "input_preparation.cross_layer_evidence_gate"
  ],
  "id": "input_preparation.board_runtime_tool_engineer",
  "objective": "Audit target_board_profile, tool_profile, tool_availability, tool_protocols, field_evidence, and sample/material indices for concrete DDR/AXI, address-map, runtime ABI, deployment, and executable tool evidence while bloc...<len=259>",
  "role": "board runtime and tool evidence engineer",
  "title": "Validate board, memory, runtime, and tool inputs"
}
</subtask>
