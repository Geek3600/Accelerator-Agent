...
<task>
Merge all specialist reports, check cross-layer consistency among model, numeric, template, board/runtime, tool, and human-boundary inputs, classify any blockers, and produce the final SACG-extraction readiness decision with exact repair or backtrack boundaries.
</task>
...
<subtask>
{
  ...
  "id": "input_preparation.cross_layer_evidence_gate",
  "objective": "Merge all specialist reports, check cross-layer consistency among model, numeric, template, board/runtime, tool, and human-boundary inputs, classify any blockers, and produce the final SACG-extraction readiness decision ...<len=262>",
  "role": "cross-layer evidence gate auditor",
  "title": "Aggregate input audits and gate SACG extraction readiness"
}
</subtask>
