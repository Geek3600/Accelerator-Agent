...
<task>
Audit task_card and model_config for sufficient decoder-block, tensor shape, attention/head mapping, sequence length, operator ordering, residual path, and model-goal facts needed for SACG extraction without inventing missing semantics.
</task>
...
<subtask>
{
  ...
  "id": "input_preparation.model_shape_intake_engineer",
  "objective": "Audit task_card and model_config for sufficient decoder-block, tensor shape, attention/head mapping, sequence length, operator ordering, residual path, and model-goal facts needed for SACG extraction without inventing mi...<len=236>",
  "role": "model and shape intake engineer",
  "title": "Validate model-facing SACG inputs"
}
</subtask>
