...
<objective>
Prepare and audit model, numeric, template, board, tool, and human-boundary inputs for SACG extraction.
</objective>
...
<state_summary>
{
  "artifacts": [
    ...
    {
      "id": "artifact.input.field_evidence_candidates",
      "type": "input"
    },
    {
...
[
  {
    ...
    "id": "input_preparation.model_intake_engineer",
    "objective": "Check whether model_config and task_card expose enough decoder-block, shape, attention, and sequence facts for SACG extraction.",
    "parallel_group": 0,
    "role": "model intake engineer",
    "title": "Validate model-facing inputs"
  },
  {
    "acceptance_checkers": [
      "addr_map_check",
    ...
    "id": "input_preparation.platform_numeric_engineer",
    "objective": "Check whether numeric_policy and target_board_profile expose enough numeric, DDR/AXI, runtime, and deployment facts without inventing missing board details.",
    "parallel_group": 0,
    "role": "platform numeric engineer",
    "title": "Validate numeric and board inputs"
  },
  {
    "acceptance_checkers": [
      "sacg_static_check"
    ...
    "id": "input_preparation.input_evidence_engineer",
    "objective": "Check whether material_index, sample_project_index, field_evidence, tool_profile, and tool_availability capture the user-provided board, quantization, sample-project, and EDA-tool ...<len=203>",
    "parallel_group": 0,
    "role": "input evidence engineer",
    "title": "Validate current-run materials and evidence"
  },
  {
    "acceptance_checkers": [
    ...
    "id": "input_preparation.toolchain_boundary_engineer",
    "objective": "Check whether tool_protocols, template_library, design_space, and human_agent_boundary define a checker-verified template-constrained run.",
    "parallel_group": 1,
    "role": "toolchain boundary engineer",
    "title": "Validate tool and human-boundary inputs"
  }
]
</reference_subtask_plan_if_split_is_needed>
