<agent>
verification_gate_agent
</agent>

<task>
Combine specialist reviews into a single stage-gate decision that separates resolved checker-backed constraints from the unresolved memory/runtime failure and records any retry/backtrack or planned tool/checker requirements in SACG memory.
</task>
...
<subtask>
{
  ...
  "expected_artifacts": [
    ...
    "artifact.pipeline_planning.stage_closure_or_retry_request",
    "artifact.pipeline_planning.sacg_memory_update"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "handoff_to": [
    "next_stage_or_repair_controller"
  ],
  "id": "pipeline_planning.evidence_gate",
  "objective": "Combine specialist reviews into a single stage-gate decision that separates resolved checker-backed constraints from the unresolved memory/runtime failure and records any retry/backtrack or planned tool/checker requireme...<len=239>",
  "role": "verification and repair auditor",
  "title": "Aggregate checker evidence and enforce stage closure boundary"
}
</subtask>
