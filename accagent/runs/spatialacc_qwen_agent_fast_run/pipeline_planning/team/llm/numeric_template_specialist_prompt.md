...
<task>
Check that every stage uses trusted templates with explicit numeric contracts, bit widths, accumulator policy, and parameter bindings consistent with the selected template library and current numeric policy.
</task>
...
<subtask>
{
  ...
  "id": "pipeline_planning.numeric_template_engineer",
  "objective": "Check that every stage uses trusted templates with explicit numeric contracts, bit widths, accumulator policy, and parameter bindings consistent with the selected template library and current numeric policy.",
