<agent>
data_memory_runtime_specialist__stream_and_liveness_engineer
</agent>

<task>
Verify that stream_edges mirror data_edges, transfer order and transfer counts are consistent with tensor shapes and AXI beat assumptions, branch/join contracts preserve token/tile/lane/word pairing, and ready/valid buffering avoids current-stage deadlock risks.
</task>
...
<subtask>
{
  ...
  "agent": "data_memory_runtime_specialist__stream_and_liveness_engineer",
  "artifact_focus": [
    "data_edges",
    "stream_edges",
    "flow_control",
  ...
  "objective": "Verify that stream_edges mirror data_edges, transfer order and transfer counts are consistent with tensor shapes and AXI beat assumptions, branch/join contracts preserve token/tile/lane/word pairing, and ready/valid buff...<len=262>",
  "role": "stream and liveness engineer",
  "title": "Audit stream edges, beat counts, branch/join flow control, and liveness"
}
</subtask>
