...
<task>
Verify that the operator-stream pipeline preserves the Qwen2 decoder block order, residual skip boundaries, causal GQA attention semantics, and SACG shape consistency without introducing free-form RTL assumptions.
</task>
...
<subtask>
{
  ...
  "expected_artifacts": [
    "artifact.pipeline_planning.pipeline_architect_review",
    "artifact.pipeline_planning.stage_graph_constraint_notes"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "objective": "Verify that the operator-stream pipeline preserves the Qwen2 decoder block order, residual skip boundaries, causal GQA attention semantics, and SACG shape consistency without introducing free-form RTL assumptions.",
  "role": "pipeline architect",
  "title": "Audit decoder stage graph and attention contract"
}
</subtask>
