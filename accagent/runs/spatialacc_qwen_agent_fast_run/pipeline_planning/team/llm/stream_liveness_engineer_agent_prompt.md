<agent>
stream_liveness_engineer_agent
</agent>

<task>
Check that every data_edge is mirrored by stream_edges, transfer order and AXI beat counts are consistent, ready/valid split and join contracts preserve token/tile/lane/word order, and liveness evidence is limited to the checker-backed planning claim.
</task>
...
<subtask>
{
  ...
  "agent": "stream_liveness_engineer_agent",
  "artifact_focus": [
    "data_edges",
    "stream_edges",
    "flow_control",
    ...
    "buffer_plan",
    "checker_results.stream_data_edge_mirror_check",
    "checker_results.edge_stream_contract_check",
    "checker_results.branch_join_contract_check",
    "checker_results.buffer_contract_check",
    "checker_results.liveness_backpressure_check"
  ],
  "constraints": [
  ...
  "expected_artifacts": [
    ...
    "artifact.pipeline_planning.transfer_count_and_order_audit"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "objective": "Check that every data_edge is mirrored by stream_edges, transfer order and AXI beat counts are consistent, ready/valid split and join contracts preserve token/tile/lane/word order, and liveness evidence is limited to the...<len=251>",
  "role": "data transfer engineer",
  "title": "Audit stream, beat, branch/join, buffer, and liveness constraints"
}
</subtask>
