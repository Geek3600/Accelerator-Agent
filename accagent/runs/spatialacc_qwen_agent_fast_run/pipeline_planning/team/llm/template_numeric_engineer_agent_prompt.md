<agent>
template_numeric_engineer_agent
</agent>

<task>
Verify that stage numeric contracts, element widths, accumulator widths, and trusted template bindings are consistent with the selected template library and numeric policy, especially transitions between 16-bit internal streams and 32-bit residual outputs.
</task>
...
<subtask>
{
  ...
  "agent": "template_numeric_engineer_agent",
  "artifact_focus": [
    "numeric_stream_policy",
    "stages.numeric_contract",
    "stages.template_id",
    "checker_results.shape_numeric_contract_check",
  ...
  "expected_artifacts": [
    "artifact.pipeline_planning.template_numeric_review",
    "artifact.pipeline_planning.numeric_transition_audit"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "id": "pipeline_planning.template_numeric_engineer",
  "objective": "Verify that stage numeric contracts, element widths, accumulator widths, and trusted template bindings are consistent with the selected template library and numeric policy, especially transitions between 16-bit internal ...<len=256>",
  "role": "numeric template engineer",
  "title": "Audit template binding and numeric stream contracts"
}
</subtask>
