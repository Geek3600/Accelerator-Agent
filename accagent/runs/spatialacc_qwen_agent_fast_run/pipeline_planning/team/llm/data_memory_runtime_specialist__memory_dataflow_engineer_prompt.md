<agent>
data_memory_runtime_specialist__memory_dataflow_engineer
</agent>

<task>
Check that DDR regions, AXI widths, alignment, transfer-count formulas, XDMA runtime requirements, and double-buffered weight/activation policy are explicit and consistent with pipeline stream widths while preserving later-stage boundaries for concrete address assignment and hardware evidence.
</task>
...
<subtask>
{
  ...
  "action_type": "memory_runtime_contract_review",
  "agent": "data_memory_runtime_specialist__memory_dataflow_engineer",
  "artifact_focus": [
    "memory_schedule",
    "data_edges.transfer_count_bytes",
  ...
  "expected_artifacts": [
    ...
    "DDR region and runtime command-sequence audit",
    "later-stage implementation/deployment obligations without unsupported hardware pass claims"
  ],
  "handoff_rule": {
    "completion_criteria": [],
  ...
  "objective": "Check that DDR regions, AXI widths, alignment, transfer-count formulas, XDMA runtime requirements, and double-buffered weight/activation policy are explicit and consistent with pipeline stream widths while preserving lat...<len=294>",
  "role": "memory dataflow engineer",
  "title": "Audit memory schedule and runtime handoff contracts"
}
</subtask>
